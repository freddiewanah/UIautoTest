...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lb/v/a/D;->mLinearInterpolator:Landroid/view/animation/LinearInterpolator;
    ...
    iput-object v0, p0, Lb/v/a/D;->mDecelerateInterpolator:Landroid/view/animation/DecelerateInterpolator;

    const/4 v0, 0x0

    .line 4
    iput v0, p0, Lb/v/a/D;->mInterimTargetDx:I
    ...
    invoke-virtual {p0, p1}, Lb/v/a/D;->calculateSpeedPerPixel(Landroid/util/DisplayMetrics;)F

    move-result p1

    iput p1, p0, Lb/v/a/D;->MILLISECONDS_PER_PX:F
...
.method public calculateDyToMakeVisible(Landroid/view/View;I)I
    ...
    .line 4
    invoke-virtual {v0, p1}, Landroidx/recyclerview/widget/RecyclerView$i;->getDecoratedTop(Landroid/view/View;)I
    ...
    .line 5
    invoke-virtual {v0, p1}, Landroidx/recyclerview/widget/RecyclerView$i;->getDecoratedBottom(Landroid/view/View;)I
...
.method public calculateTimeForDeceleration(I)I
    ...
    .line 1
    invoke-virtual {p0, p1}, Lb/v/a/D;->calculateTimeForScrolling(I)I
...
.method public calculateTimeForScrolling(I)I
    ...
    iget v0, p0, Lb/v/a/D;->MILLISECONDS_PER_PX:F
...
.method public getHorizontalSnapPreference()I
    ...
    .line 1
    iget-object v0, p0, Lb/v/a/D;->mTargetVector:Landroid/graphics/PointF;
...
.method public onSeekTargetStep(IILandroidx/recyclerview/widget/RecyclerView$t;Landroidx/recyclerview/widget/RecyclerView$s$a;)V
    .locals 0

    .line 1
    invoke-virtual {p0}, Landroidx/recyclerview/widget/RecyclerView$s;->getChildCount()I
    ...
    .line 3
    :cond_0
    iget p3, p0, Lb/v/a/D;->mInterimTargetDx:I

    invoke-direct {p0, p3, p1}, Lb/v/a/D;->clampApplyScroll(II)I

    move-result p1

    iput p1, p0, Lb/v/a/D;->mInterimTargetDx:I

    .line 4
    iget p1, p0, Lb/v/a/D;->mInterimTargetDy:I

    invoke-direct {p0, p1, p2}, Lb/v/a/D;->clampApplyScroll(II)I

    move-result p1

    iput p1, p0, Lb/v/a/D;->mInterimTargetDy:I

    .line 5
    iget p1, p0, Lb/v/a/D;->mInterimTargetDx:I
    ...
    .line 6
    invoke-virtual {p0, p4}, Lb/v/a/D;->updateActionForInterimTarget(Landroidx/recyclerview/widget/RecyclerView$s$a;)V
...
.method public onTargetFound(Landroid/view/View;Landroidx/recyclerview/widget/RecyclerView$t;Landroidx/recyclerview/widget/RecyclerView$s$a;)V
    .locals 2

    .line 1
    invoke-virtual {p0}, Lb/v/a/D;->getHorizontalSnapPreference()I

    move-result p2

    invoke-virtual {p0, p1, p2}, Lb/v/a/D;->calculateDxToMakeVisible(Landroid/view/View;I)I

    move-result p2

    .line 2
    invoke-virtual {p0}, Lb/v/a/D;->getVerticalSnapPreference()I

    move-result v0

    invoke-virtual {p0, p1, v0}, Lb/v/a/D;->calculateDyToMakeVisible(Landroid/view/View;I)I
    ...
    .line 4
    invoke-virtual {p0, v0}, Lb/v/a/D;->calculateTimeForDeceleration(I)I
    ...
    .line 5
    iget-object v1, p0, Lb/v/a/D;->mDecelerateInterpolator:Landroid/view/animation/DecelerateInterpolator;
...
.method public updateActionForInterimTarget(Landroidx/recyclerview/widget/RecyclerView$s$a;)V
    ...
    iput v1, p0, Lb/v/a/D;->mInterimTargetDx:I
    ...
    .line 7
    invoke-virtual {p0, v0}, Lb/v/a/D;->calculateTimeForScrolling(I)I
