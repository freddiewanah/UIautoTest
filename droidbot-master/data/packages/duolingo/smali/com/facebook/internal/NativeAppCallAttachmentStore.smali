...
.field public static final TAG:Ljava/lang/String; = "com.facebook.internal.NativeAppCallAttachmentStore"

.field public static attachmentsDirectory:Ljava/io/File;
...
.method public static addAttachments(Ljava/util/Collection;)V
    ...
    .line 7
    iget-boolean v2, v1, Lcom/facebook/internal/NativeAppCallAttachmentStore$Attachment;->shouldCreateFile:Z
    ...
    .line 8
    :cond_3
    iget-object v2, v1, Lcom/facebook/internal/NativeAppCallAttachmentStore$Attachment;->callId:Ljava/util/UUID;

    .line 9
    iget-object v3, v1, Lcom/facebook/internal/NativeAppCallAttachmentStore$Attachment;->attachmentName:Ljava/lang/String;
    ...
    .line 12
    iget-object v3, v1, Lcom/facebook/internal/NativeAppCallAttachmentStore$Attachment;->bitmap:Landroid/graphics/Bitmap;

    if-eqz v3, :cond_4

    .line 13
    invoke-static {v3, v2}, Lcom/facebook/internal/NativeAppCallAttachmentStore;->processAttachmentBitmap(Landroid/graphics/Bitmap;Ljava/io/File;)V

    goto :goto_0

    .line 14
    :cond_4
    iget-object v3, v1, Lcom/facebook/internal/NativeAppCallAttachmentStore$Attachment;->originalUri:Landroid/net/Uri;

    if-eqz v3, :cond_2

    .line 15
    iget-boolean v1, v1, Lcom/facebook/internal/NativeAppCallAttachmentStore$Attachment;->isContentUri:Z
...
.method public static ensureAttachmentsDirectoryExists()Ljava/io/File;
    .locals 1
...
.method public static getAttachmentFile(Ljava/util/UUID;Ljava/lang/String;Z)Ljava/io/File;
    .locals 2
...
.method public static declared-synchronized getAttachmentsDirectory()Ljava/io/File;
    .locals 4
...
.method public static getAttachmentsDirectoryForCall(Ljava/util/UUID;Z)Ljava/io/File;
    .locals 2
...
.method public static processAttachmentBitmap(Landroid/graphics/Bitmap;Ljava/io/File;)V
    .locals 2
...
.method public static processAttachmentFile(Landroid/net/Uri;ZLjava/io/File;)V
    .locals 1
