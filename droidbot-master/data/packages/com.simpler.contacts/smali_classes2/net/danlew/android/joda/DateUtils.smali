...
.method public static formatDuration(Landroid/content/Context;Lorg/joda/time/ReadableDuration;)Ljava/lang/CharSequence;
    ...
    .line 4
    sget p1, Lnet/danlew/android/joda/R$plurals;->duration_hours:I
    ...
    .line 6
    sget p1, Lnet/danlew/android/joda/R$plurals;->duration_minutes:I
    ...
    .line 8
    sget v1, Lnet/danlew/android/joda/R$plurals;->duration_seconds:I
...
.method public static getRelativeDateTimeString(Landroid/content/Context;Lorg/joda/time/ReadableInstant;Lorg/joda/time/ReadablePeriod;I)Ljava/lang/CharSequence;
    ...
    .line 19
    sget p1, Lnet/danlew/android/joda/R$string;->relative_time:I
    ...
    .line 21
    sget p1, Lnet/danlew/android/joda/R$string;->date_time:I
...
.method public static getRelativeTimeSpanString(Landroid/content/Context;Lorg/joda/time/ReadableInstant;I)Ljava/lang/CharSequence;
    ...
    .line 10
    sget v0, Lnet/danlew/android/joda/R$plurals;->abbrev_num_seconds_ago:I

    goto/16 :goto_3

    .line 11
    :cond_3
    sget v0, Lnet/danlew/android/joda/R$plurals;->num_seconds_ago:I
    ...
    .line 12
    sget v0, Lnet/danlew/android/joda/R$plurals;->abbrev_in_num_seconds:I

    goto/16 :goto_3

    .line 13
    :cond_5
    sget v0, Lnet/danlew/android/joda/R$plurals;->in_num_seconds:I
    ...
    .line 16
    sget v0, Lnet/danlew/android/joda/R$plurals;->abbrev_num_minutes_ago:I

    goto :goto_3

    .line 17
    :cond_7
    sget v0, Lnet/danlew/android/joda/R$plurals;->num_minutes_ago:I
    ...
    .line 18
    sget v0, Lnet/danlew/android/joda/R$plurals;->abbrev_in_num_minutes:I

    goto :goto_3

    .line 19
    :cond_9
    sget v0, Lnet/danlew/android/joda/R$plurals;->in_num_minutes:I
    ...
    .line 22
    sget v0, Lnet/danlew/android/joda/R$plurals;->abbrev_num_hours_ago:I

    goto :goto_3

    .line 23
    :cond_b
    sget v0, Lnet/danlew/android/joda/R$plurals;->num_hours_ago:I
    ...
    .line 24
    sget v0, Lnet/danlew/android/joda/R$plurals;->abbrev_in_num_hours:I

    goto :goto_3

    .line 25
    :cond_d
    sget v0, Lnet/danlew/android/joda/R$plurals;->in_num_hours:I
    ...
    .line 28
    sget v0, Lnet/danlew/android/joda/R$plurals;->abbrev_num_days_ago:I

    goto :goto_3

    .line 29
    :cond_f
    sget v0, Lnet/danlew/android/joda/R$plurals;->num_days_ago:I
    ...
    .line 30
    sget v0, Lnet/danlew/android/joda/R$plurals;->abbrev_in_num_days:I

    goto :goto_3

    .line 31
    :cond_11
    sget v0, Lnet/danlew/android/joda/R$plurals;->in_num_days:I
...
.method public static getRelativeTimeSpanString(Landroid/content/Context;Lorg/joda/time/ReadableInstant;Z)Ljava/lang/CharSequence;
    ...
    .line 40
    sget v0, Lnet/danlew/android/joda/R$string;->preposition_for_time:I
    ...
    .line 43
    sget v0, Lnet/danlew/android/joda/R$string;->preposition_for_date:I
