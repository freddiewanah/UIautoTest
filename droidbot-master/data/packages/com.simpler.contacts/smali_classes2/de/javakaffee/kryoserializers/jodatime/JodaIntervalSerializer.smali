...
.method public write(Lcom/esotericsoftware/kryo/Kryo;Lcom/esotericsoftware/kryo/io/Output;Lorg/joda/time/Interval;)V
    ...
    .line 2
    invoke-virtual {p3}, Lorg/joda/time/base/BaseInterval;->getStartMillis()J

    move-result-wide v0

    .line 3
    invoke-virtual {p3}, Lorg/joda/time/base/BaseInterval;->getEndMillis()J

    move-result-wide v2

    .line 4
    invoke-virtual {p3}, Lorg/joda/time/base/BaseInterval;->getChronology()Lorg/joda/time/Chronology;
