...
.method public constructor <init>(Ljava/util/concurrent/Future;Ljava/util/Collection;)V
    ...
    iput-object v0, p0, Lio/fabric/sdk/android/h;->g:Lio/fabric/sdk/android/services/network/HttpRequestFactory;

    .line 3
    iput-object p1, p0, Lio/fabric/sdk/android/h;->p:Ljava/util/concurrent/Future;

    .line 4
    iput-object p2, p0, Lio/fabric/sdk/android/h;->q:Ljava/util/Collection;
...
.method private a(Lio/fabric/sdk/android/services/settings/IconRequest;Ljava/util/Collection;)Lio/fabric/sdk/android/services/settings/AppRequestData;
    ...
    .line 22
    iget-object v1, v0, Lio/fabric/sdk/android/h;->m:Ljava/lang/String;
    ...
    iget-object v6, v0, Lio/fabric/sdk/android/h;->l:Ljava/lang/String;

    iget-object v7, v0, Lio/fabric/sdk/android/h;->k:Ljava/lang/String;

    iget-object v9, v0, Lio/fabric/sdk/android/h;->n:Ljava/lang/String;

    iget-object v11, v0, Lio/fabric/sdk/android/h;->o:Ljava/lang/String;
...
.method private a(Lio/fabric/sdk/android/services/settings/AppSettingsData;Lio/fabric/sdk/android/services/settings/IconRequest;Ljava/util/Collection;)Z
    ...
    .line 15
    invoke-direct {p0, p2, p3}, Lio/fabric/sdk/android/h;->a(Lio/fabric/sdk/android/services/settings/IconRequest;Ljava/util/Collection;)Lio/fabric/sdk/android/services/settings/AppRequestData;
    ...
    invoke-virtual {p0}, Lio/fabric/sdk/android/h;->c()Ljava/lang/String;

    move-result-object v0

    iget-object p1, p1, Lio/fabric/sdk/android/services/settings/AppSettingsData;->url:Ljava/lang/String;

    iget-object v1, p0, Lio/fabric/sdk/android/h;->g:Lio/fabric/sdk/android/services/network/HttpRequestFactory;
...
.method private a(Ljava/lang/String;Lio/fabric/sdk/android/services/settings/AppSettingsData;Ljava/util/Collection;)Z
    ...
    .line 7
    invoke-direct {p0, p1, p2, p3}, Lio/fabric/sdk/android/h;->b(Ljava/lang/String;Lio/fabric/sdk/android/services/settings/AppSettingsData;Ljava/util/Collection;)Z
    ...
    .line 14
    invoke-direct {p0, p1, p2, p3}, Lio/fabric/sdk/android/h;->c(Ljava/lang/String;Lio/fabric/sdk/android/services/settings/AppSettingsData;Ljava/util/Collection;)Z
...
.method private b(Ljava/lang/String;Lio/fabric/sdk/android/services/settings/AppSettingsData;Ljava/util/Collection;)Z
    ...
    invoke-direct {p0, p1, p3}, Lio/fabric/sdk/android/h;->a(Lio/fabric/sdk/android/services/settings/IconRequest;Ljava/util/Collection;)Lio/fabric/sdk/android/services/settings/AppRequestData;
...
.method private c(Ljava/lang/String;Lio/fabric/sdk/android/services/settings/AppSettingsData;Ljava/util/Collection;)Z
    ...
    invoke-direct {p0, p2, p1, p3}, Lio/fabric/sdk/android/h;->a(Lio/fabric/sdk/android/services/settings/AppSettingsData;Lio/fabric/sdk/android/services/settings/IconRequest;Ljava/util/Collection;)Z
...
.method private d()Lio/fabric/sdk/android/services/settings/SettingsData;
    .locals 8
    ...
    iget-object v3, p0, Lio/fabric/sdk/android/h;->g:Lio/fabric/sdk/android/services/network/HttpRequestFactory;

    iget-object v4, p0, Lio/fabric/sdk/android/h;->k:Ljava/lang/String;

    iget-object v5, p0, Lio/fabric/sdk/android/h;->l:Ljava/lang/String;
...
.method protected doInBackground()Ljava/lang/Boolean;
    ...
    .line 3
    invoke-direct {p0}, Lio/fabric/sdk/android/h;->d()Lio/fabric/sdk/android/services/settings/SettingsData;
    ...
    .line 4
    :try_start_0
    iget-object v2, p0, Lio/fabric/sdk/android/h;->p:Ljava/util/concurrent/Future;
    ...
    .line 7
    :goto_0
    iget-object v3, p0, Lio/fabric/sdk/android/h;->q:Ljava/util/Collection;

    invoke-virtual {p0, v2, v3}, Lio/fabric/sdk/android/h;->a(Ljava/util/Map;Ljava/util/Collection;)Ljava/util/Map;
    ...
    .line 10
    invoke-direct {p0, v0, v1, v2}, Lio/fabric/sdk/android/h;->a(Ljava/lang/String;Lio/fabric/sdk/android/services/settings/AppSettingsData;Ljava/util/Collection;)Z
...
.method protected bridge synthetic doInBackground()Ljava/lang/Object;
    ...
    .line 1
    invoke-virtual {p0}, Lio/fabric/sdk/android/h;->doInBackground()Ljava/lang/Boolean;
...
.method protected onPreExecute()Z
    ...
    iput-object v1, p0, Lio/fabric/sdk/android/h;->m:Ljava/lang/String;
    ...
    iput-object v1, p0, Lio/fabric/sdk/android/h;->h:Landroid/content/pm/PackageManager;
    ...
    iput-object v1, p0, Lio/fabric/sdk/android/h;->i:Ljava/lang/String;

    .line 4
    iget-object v1, p0, Lio/fabric/sdk/android/h;->h:Landroid/content/pm/PackageManager;

    iget-object v2, p0, Lio/fabric/sdk/android/h;->i:Ljava/lang/String;

    invoke-virtual {v1, v2, v0}, Landroid/content/pm/PackageManager;->getPackageInfo(Ljava/lang/String;I)Landroid/content/pm/PackageInfo;

    move-result-object v1

    iput-object v1, p0, Lio/fabric/sdk/android/h;->j:Landroid/content/pm/PackageInfo;

    .line 5
    iget-object v1, p0, Lio/fabric/sdk/android/h;->j:Landroid/content/pm/PackageInfo;
    ...
    iput-object v1, p0, Lio/fabric/sdk/android/h;->k:Ljava/lang/String;
    ...
    :goto_0
    iput-object v1, p0, Lio/fabric/sdk/android/h;->l:Ljava/lang/String;
    ...
    iput-object v1, p0, Lio/fabric/sdk/android/h;->n:Ljava/lang/String;
    ...
    iput-object v1, p0, Lio/fabric/sdk/android/h;->o:Ljava/lang/String;
    :try_end_0
