.class Lorg/joda/time/format/PeriodFormatterBuilder$a;
...
.method constructor <init>(Ljava/util/List;)V
    ...
    .line 4
    invoke-direct {p0, p1, v0, v1}, Lorg/joda/time/format/PeriodFormatterBuilder$a;->a(Ljava/util/List;Ljava/util/List;Ljava/util/List;)V
...
.method private a(Ljava/util/List;Ljava/util/List;Ljava/util/List;)V
    ...
    .line 4
    instance-of v3, v2, Lorg/joda/time/format/PeriodFormatterBuilder$a;

    if-eqz v3, :cond_0

    .line 5
    check-cast v2, Lorg/joda/time/format/PeriodFormatterBuilder$a;

    iget-object v2, v2, Lorg/joda/time/format/PeriodFormatterBuilder$a;->a:[Lorg/joda/time/format/PeriodPrinter;

    invoke-direct {p0, p2, v2}, Lorg/joda/time/format/PeriodFormatterBuilder$a;->a(Ljava/util/List;[Ljava/lang/Object;)V
    ...
    iget-object v2, v2, Lorg/joda/time/format/PeriodFormatterBuilder$a;->b:[Lorg/joda/time/format/PeriodParser;

    invoke-direct {p0, p3, v2}, Lorg/joda/time/format/PeriodFormatterBuilder$a;->a(Ljava/util/List;[Ljava/lang/Object;)V
