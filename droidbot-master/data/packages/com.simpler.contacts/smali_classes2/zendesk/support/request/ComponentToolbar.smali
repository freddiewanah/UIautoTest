...
.field private final fadeTransition:Landroid/support/transition/Fade;
...
# direct methods
.method constructor <init>(Lcom/sebchlan/picassocompat/PicassoCompat;Landroid/support/v7/widget/Toolbar;Lzendesk/support/request/ViewAlmostRealProgressBar;)V
    .locals 1
    ...
    iput-object v0, p0, Lzendesk/support/request/ComponentToolbar;->fadeTransition:Landroid/support/transition/Fade;

    .line 3
    iput-object p1, p0, Lzendesk/support/request/ComponentToolbar;->picasso:Lcom/sebchlan/picassocompat/PicassoCompat;
    ...
    .line 5
    iput-object p2, p0, Lzendesk/support/request/ComponentToolbar;->toolbar:Landroid/support/v7/widget/Toolbar;
...
.method private updateToolbar(Lzendesk/support/request/ComponentToolbar$ToolbarModel;)V
    ...
    .line 3
    iget-object p1, p0, Lzendesk/support/request/ComponentToolbar;->toolbar:Landroid/support/v7/widget/Toolbar;
    ...
    .line 9
    iget-object v3, p0, Lzendesk/support/request/ComponentToolbar;->toolbar:Landroid/support/v7/widget/Toolbar;
    ...
    iget-object v3, p0, Lzendesk/support/request/ComponentToolbar;->picasso:Lcom/sebchlan/picassocompat/PicassoCompat;

    invoke-virtual {p1}, Lzendesk/support/request/ComponentToolbar$ToolbarModel;->getAvatarUrls()Ljava/util/List;

    move-result-object v4

    invoke-virtual {v2, v3, v4}, Lzendesk/support/request/ViewToolbarAvatar;->setImageUrls(Lcom/sebchlan/picassocompat/PicassoCompat;Ljava/util/List;)V

    .line 11
    iget-object v2, p0, Lzendesk/support/request/ComponentToolbar;->toolbar:Landroid/support/v7/widget/Toolbar;

    iget-object v3, p0, Lzendesk/support/request/ComponentToolbar;->fadeTransition:Landroid/support/transition/Fade;

    invoke-static {v2, v3}, Landroid/support/transition/TransitionManager;->beginDelayedTransition(Landroid/view/ViewGroup;Landroid/support/transition/Transition;)V
...
.method public update(Lzendesk/support/request/ComponentToolbar$ToolbarModel;)V
    .locals 1
    .param p1    # Lzendesk/support/request/ComponentToolbar$ToolbarModel;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
    .end param
