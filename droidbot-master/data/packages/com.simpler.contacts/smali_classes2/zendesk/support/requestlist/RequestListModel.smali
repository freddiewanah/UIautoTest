...
.field private final mapper:Lcom/zendesk/func/ZFunc1;
...
.method constructor <init>(Lzendesk/support/requestlist/RequestInfoDataSource;Lzendesk/core/MemoryCache;Lzendesk/support/SupportBlipsProvider;Lzendesk/support/SupportSettingsProvider;)V
    ...
    iput-object v0, p0, Lzendesk/support/requestlist/RequestListModel;->mapper:Lcom/zendesk/func/ZFunc1;
...
.method static synthetic access$100(Lzendesk/support/requestlist/RequestListModel;)Lcom/zendesk/func/ZFunc1;
    .locals 0

    .line 1
    iget-object p0, p0, Lzendesk/support/requestlist/RequestListModel;->mapper:Lcom/zendesk/func/ZFunc1;
...
.method private filterClosedRequests(Ljava/util/List;Z)Ljava/util/List;
    ...
    invoke-static {p1, p2}, Lcom/zendesk/util/CollectionUtils;->filter(Ljava/util/Collection;Lcom/zendesk/func/ZFunc1;)Ljava/util/List;
...
.method loadItems(ZLzendesk/support/SupportSdkSettings;Lcom/zendesk/service/ZendeskCallback;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Z",
    ...
    invoke-direct {v0, p0, p2, p3}, Lzendesk/support/requestlist/RequestListModel$1;-><init>(Lzendesk/support/requestlist/RequestListModel;Lzendesk/support/SupportSdkSettings;Lcom/zendesk/service/ZendeskCallback;)V

    invoke-interface {p1, v0}, Lzendesk/support/requestlist/RequestInfoDataSource;->load(Lcom/zendesk/service/ZendeskCallback;)V

    :goto_1
    return-void
.end method

.method loadSettings(Lcom/zendesk/service/ZendeskCallback;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
