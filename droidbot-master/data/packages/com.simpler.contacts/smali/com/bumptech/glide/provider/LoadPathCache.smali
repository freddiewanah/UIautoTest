...
# static fields
.field private static final a:Lcom/bumptech/glide/load/engine/LoadPath;
...
.method static constructor <clinit>()V
    ...
    sput-object v6, Lcom/bumptech/glide/provider/LoadPathCache;->a:Lcom/bumptech/glide/load/engine/LoadPath;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/bumptech/glide/provider/LoadPathCache;->b:Landroid/support/v4/util/ArrayMap;
    ...
    iput-object v0, p0, Lcom/bumptech/glide/provider/LoadPathCache;->c:Ljava/util/concurrent/atomic/AtomicReference;
...
.method private a(Ljava/lang/Class;Ljava/lang/Class;Ljava/lang/Class;)Lcom/bumptech/glide/util/MultiClassKey;
    ...
    .line 1
    iget-object v0, p0, Lcom/bumptech/glide/provider/LoadPathCache;->c:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public get(Ljava/lang/Class;Ljava/lang/Class;Ljava/lang/Class;)Lcom/bumptech/glide/load/engine/LoadPath;
    ...
    .line 2
    iget-object p2, p0, Lcom/bumptech/glide/provider/LoadPathCache;->b:Landroid/support/v4/util/ArrayMap;

    monitor-enter p2

    .line 3
    :try_start_0
    iget-object p3, p0, Lcom/bumptech/glide/provider/LoadPathCache;->b:Landroid/support/v4/util/ArrayMap;
    ...
    .line 5
    iget-object p2, p0, Lcom/bumptech/glide/provider/LoadPathCache;->c:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public isEmptyLoadPath(Lcom/bumptech/glide/load/engine/LoadPath;)Z
    ...
    .line 1
    sget-object v0, Lcom/bumptech/glide/provider/LoadPathCache;->a:Lcom/bumptech/glide/load/engine/LoadPath;
...
.method public put(Ljava/lang/Class;Ljava/lang/Class;Ljava/lang/Class;Lcom/bumptech/glide/load/engine/LoadPath;)V
    ...
    .line 1
    iget-object v0, p0, Lcom/bumptech/glide/provider/LoadPathCache;->b:Landroid/support/v4/util/ArrayMap;

    monitor-enter v0

    .line 2
    :try_start_0
    iget-object v1, p0, Lcom/bumptech/glide/provider/LoadPathCache;->b:Landroid/support/v4/util/ArrayMap;
    ...
    .line 3
    :cond_0
    sget-object p4, Lcom/bumptech/glide/provider/LoadPathCache;->a:Lcom/bumptech/glide/load/engine/LoadPath;
