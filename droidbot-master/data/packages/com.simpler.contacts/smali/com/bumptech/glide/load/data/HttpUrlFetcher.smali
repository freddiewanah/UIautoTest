...
# static fields
.field static final a:Lcom/bumptech/glide/load/data/HttpUrlFetcher$b;
...
.field private final d:Lcom/bumptech/glide/load/data/HttpUrlFetcher$b;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/bumptech/glide/load/data/HttpUrlFetcher;->a:Lcom/bumptech/glide/load/data/HttpUrlFetcher$b;
...
.method public constructor <init>(Lcom/bumptech/glide/load/model/GlideUrl;I)V
    ...
    .line 1
    sget-object v0, Lcom/bumptech/glide/load/data/HttpUrlFetcher;->a:Lcom/bumptech/glide/load/data/HttpUrlFetcher$b;
...
.method constructor <init>(Lcom/bumptech/glide/load/model/GlideUrl;ILcom/bumptech/glide/load/data/HttpUrlFetcher$b;)V
    ...
    .line 4
    iput p2, p0, Lcom/bumptech/glide/load/data/HttpUrlFetcher;->c:I

    .line 5
    iput-object p3, p0, Lcom/bumptech/glide/load/data/HttpUrlFetcher;->d:Lcom/bumptech/glide/load/data/HttpUrlFetcher$b;
...
.method private a(Ljava/net/HttpURLConnection;)Ljava/io/InputStream;
    ...
    iput-object p1, p0, Lcom/bumptech/glide/load/data/HttpUrlFetcher;->f:Ljava/io/InputStream;
...
.method private a(Ljava/net/URL;ILjava/net/URL;Ljava/util/Map;)Ljava/io/InputStream;
    ...
    :cond_1
    :goto_0
    iget-object p3, p0, Lcom/bumptech/glide/load/data/HttpUrlFetcher;->d:Lcom/bumptech/glide/load/data/HttpUrlFetcher$b;

    invoke-interface {p3, p1}, Lcom/bumptech/glide/load/data/HttpUrlFetcher$b;->a(Ljava/net/URL;)Ljava/net/HttpURLConnection;

    move-result-object p3

    iput-object p3, p0, Lcom/bumptech/glide/load/data/HttpUrlFetcher;->e:Ljava/net/HttpURLConnection;
    ...
    .line 5
    iget-object v1, p0, Lcom/bumptech/glide/load/data/HttpUrlFetcher;->e:Ljava/net/HttpURLConnection;
    ...
    .line 6
    :cond_2
    iget-object p3, p0, Lcom/bumptech/glide/load/data/HttpUrlFetcher;->e:Ljava/net/HttpURLConnection;

    iget v0, p0, Lcom/bumptech/glide/load/data/HttpUrlFetcher;->c:I
    ...
    .line 15
    invoke-static {p3}, Lcom/bumptech/glide/load/data/HttpUrlFetcher;->a(I)Z
    ...
    .line 16
    iget-object p1, p0, Lcom/bumptech/glide/load/data/HttpUrlFetcher;->e:Ljava/net/HttpURLConnection;
    ...
    .line 17
    :cond_4
    invoke-static {p3}, Lcom/bumptech/glide/load/data/HttpUrlFetcher;->b(I)Z
    ...
    .line 22
    invoke-direct {p0, v0, p2, p1, p4}, Lcom/bumptech/glide/load/data/HttpUrlFetcher;->a(Ljava/net/URL;ILjava/net/URL;Ljava/util/Map;)Ljava/io/InputStream;
    ...
    iget-object p2, p0, Lcom/bumptech/glide/load/data/HttpUrlFetcher;->e:Ljava/net/HttpURLConnection;
...
.method public cleanup()V
    ...
    :cond_0
    :goto_0
    iget-object v0, p0, Lcom/bumptech/glide/load/data/HttpUrlFetcher;->e:Ljava/net/HttpURLConnection;
    ...
    .line 5
    iput-object v0, p0, Lcom/bumptech/glide/load/data/HttpUrlFetcher;->e:Ljava/net/HttpURLConnection;
...
.method public loadData(Lcom/bumptech/glide/Priority;Lcom/bumptech/glide/load/data/DataFetcher$DataCallback;)V
    ...
    .line 2
    :try_start_0
    iget-object v4, p0, Lcom/bumptech/glide/load/data/HttpUrlFetcher;->b:Lcom/bumptech/glide/load/model/GlideUrl;
    ...
    iget-object v7, p0, Lcom/bumptech/glide/load/data/HttpUrlFetcher;->b:Lcom/bumptech/glide/load/model/GlideUrl;

    invoke-virtual {v7}, Lcom/bumptech/glide/load/model/GlideUrl;->getHeaders()Ljava/util/Map;

    move-result-object v7

    invoke-direct {p0, v4, v5, v6, v7}, Lcom/bumptech/glide/load/data/HttpUrlFetcher;->a(Ljava/net/URL;ILjava/net/URL;Ljava/util/Map;)Ljava/io/InputStream;
