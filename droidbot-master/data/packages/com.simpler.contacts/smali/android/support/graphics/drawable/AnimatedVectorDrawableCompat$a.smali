...
.method public constructor <init>(Landroid/content/Context;Landroid/support/graphics/drawable/AnimatedVectorDrawableCompat$a;Landroid/graphics/drawable/Drawable$Callback;Landroid/content/res/Resources;)V
    ...
    .line 2
    iget p1, p2, Landroid/support/graphics/drawable/AnimatedVectorDrawableCompat$a;->a:I

    iput p1, p0, Landroid/support/graphics/drawable/AnimatedVectorDrawableCompat$a;->a:I

    .line 3
    iget-object p1, p2, Landroid/support/graphics/drawable/AnimatedVectorDrawableCompat$a;->b:Landroid/support/graphics/drawable/VectorDrawableCompat;
    ...
    iput-object p1, p0, Landroid/support/graphics/drawable/AnimatedVectorDrawableCompat$a;->b:Landroid/support/graphics/drawable/VectorDrawableCompat;
    ...
    .line 7
    :goto_0
    iget-object p1, p0, Landroid/support/graphics/drawable/AnimatedVectorDrawableCompat$a;->b:Landroid/support/graphics/drawable/VectorDrawableCompat;
    ...
    iget-object p3, p2, Landroid/support/graphics/drawable/AnimatedVectorDrawableCompat$a;->b:Landroid/support/graphics/drawable/VectorDrawableCompat;
    ...
    .line 11
    :cond_1
    iget-object p1, p2, Landroid/support/graphics/drawable/AnimatedVectorDrawableCompat$a;->d:Ljava/util/ArrayList;
    ...
    iput-object p3, p0, Landroid/support/graphics/drawable/AnimatedVectorDrawableCompat$a;->d:Ljava/util/ArrayList;
    ...
    iput-object p3, p0, Landroid/support/graphics/drawable/AnimatedVectorDrawableCompat$a;->e:Landroid/support/v4/util/ArrayMap;

    :goto_1
    if-ge v0, p1, :cond_2

    .line 15
    iget-object p3, p2, Landroid/support/graphics/drawable/AnimatedVectorDrawableCompat$a;->d:Ljava/util/ArrayList;
    ...
    .line 17
    iget-object v1, p2, Landroid/support/graphics/drawable/AnimatedVectorDrawableCompat$a;->e:Landroid/support/v4/util/ArrayMap;
    ...
    .line 18
    iget-object v1, p0, Landroid/support/graphics/drawable/AnimatedVectorDrawableCompat$a;->b:Landroid/support/graphics/drawable/VectorDrawableCompat;
    ...
    .line 20
    iget-object v1, p0, Landroid/support/graphics/drawable/AnimatedVectorDrawableCompat$a;->d:Ljava/util/ArrayList;

    invoke-virtual {v1, p4}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 21
    iget-object v1, p0, Landroid/support/graphics/drawable/AnimatedVectorDrawableCompat$a;->e:Landroid/support/v4/util/ArrayMap;
