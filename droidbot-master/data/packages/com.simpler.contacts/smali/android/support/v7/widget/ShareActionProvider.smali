...
.field private final e:Landroid/support/v7/widget/ShareActionProvider$b;

.field final f:Landroid/content/Context;

.field g:Ljava/lang/String;

.field h:Landroid/support/v7/widget/ShareActionProvider$OnShareTargetSelectedListener;

.field private i:Landroid/support/v7/widget/ActivityChooserModel$OnChooseActivityListener;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 2
    iput v0, p0, Landroid/support/v7/widget/ShareActionProvider;->d:I
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ShareActionProvider;->e:Landroid/support/v7/widget/ShareActionProvider$b;

    const-string v0, "share_history.xml"

    .line 4
    iput-object v0, p0, Landroid/support/v7/widget/ShareActionProvider;->g:Ljava/lang/String;

    .line 5
    iput-object p1, p0, Landroid/support/v7/widget/ShareActionProvider;->f:Landroid/content/Context;
...
.method private a()V
    ...
    .line 1
    iget-object v0, p0, Landroid/support/v7/widget/ShareActionProvider;->h:Landroid/support/v7/widget/ShareActionProvider$OnShareTargetSelectedListener;
    ...
    .line 2
    :cond_0
    iget-object v0, p0, Landroid/support/v7/widget/ShareActionProvider;->i:Landroid/support/v7/widget/ActivityChooserModel$OnChooseActivityListener;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ShareActionProvider;->i:Landroid/support/v7/widget/ActivityChooserModel$OnChooseActivityListener;

    .line 4
    :cond_1
    iget-object v0, p0, Landroid/support/v7/widget/ShareActionProvider;->f:Landroid/content/Context;

    iget-object v1, p0, Landroid/support/v7/widget/ShareActionProvider;->g:Ljava/lang/String;
    ...
    .line 5
    iget-object v1, p0, Landroid/support/v7/widget/ShareActionProvider;->i:Landroid/support/v7/widget/ActivityChooserModel$OnChooseActivityListener;
...
.method public onCreateActionView()Landroid/view/View;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/ShareActionProvider;->f:Landroid/content/Context;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/ShareActionProvider;->g:Ljava/lang/String;
    ...
    .line 6
    iget-object v2, p0, Landroid/support/v7/widget/ShareActionProvider;->f:Landroid/content/Context;
...
.method public onPrepareSubMenu(Landroid/view/SubMenu;)V
    ...
    .line 5
    iget v3, p0, Landroid/support/v7/widget/ShareActionProvider;->d:I
    ...
    .line 6
    invoke-virtual {v0, v5}, Landroid/support/v7/widget/ActivityChooserModel;->b(I)Landroid/content/pm/ResolveInfo;
    ...
    iget-object v7, p0, Landroid/support/v7/widget/ShareActionProvider;->e:Landroid/support/v7/widget/ShareActionProvider$b;
    ...
    .line 10
    iget-object v5, p0, Landroid/support/v7/widget/ShareActionProvider;->f:Landroid/content/Context;
    ...
    .line 13
    invoke-virtual {v0, v3}, Landroid/support/v7/widget/ActivityChooserModel;->b(I)Landroid/content/pm/ResolveInfo;
    ...
    iget-object v6, p0, Landroid/support/v7/widget/ShareActionProvider;->e:Landroid/support/v7/widget/ShareActionProvider$b;
...
.method public setOnShareTargetSelectedListener(Landroid/support/v7/widget/ShareActionProvider$OnShareTargetSelectedListener;)V
    ...
    .line 1
    iput-object p1, p0, Landroid/support/v7/widget/ShareActionProvider;->h:Landroid/support/v7/widget/ShareActionProvider$OnShareTargetSelectedListener;
...
.method public setShareHistoryFileName(Ljava/lang/String;)V
    ...
    .line 1
    iput-object p1, p0, Landroid/support/v7/widget/ShareActionProvider;->g:Ljava/lang/String;
