...
.field private g:Landroid/support/v7/widget/Ua;

.field private final h:Landroid/support/v7/widget/A;
...
.method constructor <init>(Landroid/widget/TextView;)V
    ...
    invoke-direct {p1, v0}, Landroid/support/v7/widget/A;-><init>(Landroid/widget/TextView;)V

    iput-object p1, p0, Landroid/support/v7/widget/z;->h:Landroid/support/v7/widget/A;

    return-void
.end method

.method private static a(Landroid/content/Context;Landroid/support/v7/widget/AppCompatDrawableManager;I)Landroid/support/v7/widget/Ua;
    .locals 0

    .line 139
    invoke-virtual {p1, p0, p2}, Landroid/support/v7/widget/AppCompatDrawableManager;->a(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    .line 140
    new-instance p1, Landroid/support/v7/widget/Ua;

    invoke-direct {p1}, Landroid/support/v7/widget/Ua;-><init>()V

    const/4 p2, 0x1

    .line 141
    iput-boolean p2, p1, Landroid/support/v7/widget/Ua;->d:Z

    .line 142
    iput-object p0, p1, Landroid/support/v7/widget/Ua;->a:Landroid/content/res/ColorStateList;
...
.method private a(Landroid/content/Context;Landroid/support/v7/widget/TintTypedArray;)V
    ...
    invoke-direct {v3, p0, p1}, Landroid/support/v7/widget/y;-><init>(Landroid/support/v7/widget/z;Ljava/lang/ref/WeakReference;)V
...
.method private a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/Ua;)V
    .locals 1
    ...
    invoke-static {p1, p2, v0}, Landroid/support/v7/widget/AppCompatDrawableManager;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/Ua;[I)V
...
.method private b(IF)V
    ...
    .line 2
    iget-object v0, p0, Landroid/support/v7/widget/z;->h:Landroid/support/v7/widget/A;

    invoke-virtual {v0, p1, p2}, Landroid/support/v7/widget/A;->a(IF)V
...
.method a()V
    ...
    .line 127
    iget-object v0, p0, Landroid/support/v7/widget/z;->b:Landroid/support/v7/widget/Ua;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/z;->c:Landroid/support/v7/widget/Ua;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/z;->d:Landroid/support/v7/widget/Ua;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/z;->e:Landroid/support/v7/widget/Ua;
    ...
    iget-object v4, p0, Landroid/support/v7/widget/z;->b:Landroid/support/v7/widget/Ua;

    invoke-direct {p0, v3, v4}, Landroid/support/v7/widget/z;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/Ua;)V
    ...
    iget-object v4, p0, Landroid/support/v7/widget/z;->c:Landroid/support/v7/widget/Ua;
    ...
    iget-object v4, p0, Landroid/support/v7/widget/z;->d:Landroid/support/v7/widget/Ua;
    ...
    iget-object v3, p0, Landroid/support/v7/widget/z;->e:Landroid/support/v7/widget/Ua;

    invoke-direct {p0, v0, v3}, Landroid/support/v7/widget/z;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/Ua;)V
    ...
    .line 134
    iget-object v0, p0, Landroid/support/v7/widget/z;->f:Landroid/support/v7/widget/Ua;

    if-nez v0, :cond_2

    iget-object v0, p0, Landroid/support/v7/widget/z;->g:Landroid/support/v7/widget/Ua;
    ...
    iget-object v3, p0, Landroid/support/v7/widget/z;->f:Landroid/support/v7/widget/Ua;

    invoke-direct {p0, v2, v3}, Landroid/support/v7/widget/z;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/Ua;)V

    .line 137
    aget-object v0, v0, v1

    iget-object v1, p0, Landroid/support/v7/widget/z;->g:Landroid/support/v7/widget/Ua;

    invoke-direct {p0, v0, v1}, Landroid/support/v7/widget/z;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/Ua;)V
...
.method a(I)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/A;->a(I)V
...
.method a(IF)V
    ...
    .line 146
    invoke-virtual {p0}, Landroid/support/v7/widget/z;->h()Z
...
.method a(IIII)V
    ...
    invoke-virtual {v0, p1, p2, p3, p4}, Landroid/support/v7/widget/A;->a(IIII)V
...
.method a(Landroid/content/Context;I)V
    ...
    .line 122
    :cond_2
    invoke-direct {p0, p1, p2}, Landroid/support/v7/widget/z;->a(Landroid/content/Context;Landroid/support/v7/widget/TintTypedArray;)V
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    .line 8
    invoke-static {v3, v4, v9}, Landroid/support/v7/widget/z;->a(Landroid/content/Context;Landroid/support/v7/widget/AppCompatDrawableManager;I)Landroid/support/v7/widget/Ua;

    move-result-object v9

    iput-object v9, v0, Landroid/support/v7/widget/z;->b:Landroid/support/v7/widget/Ua;
    ...
    iput-object v9, v0, Landroid/support/v7/widget/z;->c:Landroid/support/v7/widget/Ua;
    ...
    iput-object v9, v0, Landroid/support/v7/widget/z;->d:Landroid/support/v7/widget/Ua;
    ...
    iput-object v9, v0, Landroid/support/v7/widget/z;->e:Landroid/support/v7/widget/Ua;
    ...
    iput-object v9, v0, Landroid/support/v7/widget/z;->f:Landroid/support/v7/widget/Ua;
    ...
    iput-object v4, v0, Landroid/support/v7/widget/z;->g:Landroid/support/v7/widget/Ua;
    ...
    .line 36
    :goto_0
    invoke-direct {v0, v3, v7}, Landroid/support/v7/widget/z;->a(Landroid/content/Context;Landroid/support/v7/widget/TintTypedArray;)V
    ...
    .line 66
    iget-object v5, v0, Landroid/support/v7/widget/z;->a:Landroid/widget/TextView;
    ...
    .line 67
    :cond_15
    iget-object v4, v0, Landroid/support/v7/widget/z;->h:Landroid/support/v7/widget/A;

    invoke-virtual {v4, v1, v2}, Landroid/support/v7/widget/A;->a(Landroid/util/AttributeSet;I)V
    ...
    .line 69
    iget-object v2, v0, Landroid/support/v7/widget/z;->h:Landroid/support/v7/widget/A;

    invoke-virtual {v2}, Landroid/support/v7/widget/A;->f()I
    ...
    .line 71
    invoke-virtual {v2}, Landroid/support/v7/widget/A;->e()[I
    ...
    .line 75
    invoke-virtual {v4}, Landroid/support/v7/widget/A;->c()I

    move-result v4

    iget-object v5, v0, Landroid/support/v7/widget/z;->h:Landroid/support/v7/widget/A;

    .line 76
    invoke-virtual {v5}, Landroid/support/v7/widget/A;->b()I

    move-result v5

    iget-object v7, v0, Landroid/support/v7/widget/z;->h:Landroid/support/v7/widget/A;

    .line 77
    invoke-virtual {v7}, Landroid/support/v7/widget/A;->d()I
...
.method a([II)V
    ...
    invoke-virtual {v0, p1, p2}, Landroid/support/v7/widget/A;->a([II)V
...
.method c()I
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/A;->b()I
...
.method d()I
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/A;->c()I
...
.method e()I
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/A;->d()I
...
.method f()[I
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/A;->e()[I
...
.method g()I
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/A;->f()I
