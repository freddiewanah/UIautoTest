...
# instance fields
.field private n:Landroid/support/v7/graphics/drawable/d$a;
...
.method constructor <init>(Landroid/support/v7/graphics/drawable/d$a;)V
    ...
    .line 5
    invoke-direct {p0}, Landroid/support/v7/graphics/drawable/c;-><init>()V

    if-eqz p1, :cond_0

    .line 6
    invoke-virtual {p0, p1}, Landroid/support/v7/graphics/drawable/d;->setConstantState(Landroid/support/v7/graphics/drawable/c$b;)V
...
.method constructor <init>(Landroid/support/v7/graphics/drawable/d$a;Landroid/content/res/Resources;)V
    ...
    .line 3
    invoke-virtual {p0, v0}, Landroid/support/v7/graphics/drawable/d;->setConstantState(Landroid/support/v7/graphics/drawable/c$b;)V
...
.method private a(Landroid/content/Context;Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
    ...
    .line 10
    iget-object v0, p0, Landroid/support/v7/graphics/drawable/d;->n:Landroid/support/v7/graphics/drawable/d$a;
...
.method private a(Landroid/content/res/TypedArray;)V
    ...
    iput-boolean v1, v0, Landroid/support/v7/graphics/drawable/c$b;->l:Z
    ...
    iput v1, v0, Landroid/support/v7/graphics/drawable/c$b;->A:I
    ...
    iput v1, v0, Landroid/support/v7/graphics/drawable/c$b;->B:I

    .line 9
    sget v1, Landroid/support/v7/appcompat/R$styleable;->StateListDrawable_android_dither:I

    iget-boolean v2, v0, Landroid/support/v7/graphics/drawable/c$b;->x:Z
...
.method bridge synthetic a()Landroid/support/v7/graphics/drawable/c$b;
    ...
    .line 1
    invoke-virtual {p0}, Landroid/support/v7/graphics/drawable/d;->a()Landroid/support/v7/graphics/drawable/d$a;
...
.method a()Landroid/support/v7/graphics/drawable/d$a;
    .locals 3

    .line 32
    new-instance v0, Landroid/support/v7/graphics/drawable/d$a;

    iget-object v1, p0, Landroid/support/v7/graphics/drawable/d;->n:Landroid/support/v7/graphics/drawable/d$a;
...
.method public applyTheme(Landroid/content/res/Resources$Theme;)V
    ...
    .line 1
    invoke-super {p0, p1}, Landroid/support/v7/graphics/drawable/c;->applyTheme(Landroid/content/res/Resources$Theme;)V
...
.method public inflate(Landroid/content/Context;Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
    ...
    invoke-virtual {p0, v1, v2}, Landroid/support/v7/graphics/drawable/c;->setVisible(ZZ)Z
...
.method public mutate()Landroid/graphics/drawable/Drawable;
    ...
    .line 1
    iget-boolean v0, p0, Landroid/support/v7/graphics/drawable/d;->o:Z

    if-nez v0, :cond_0

    invoke-super {p0}, Landroid/support/v7/graphics/drawable/c;->mutate()Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0}, Landroid/support/v7/graphics/drawable/d$a;->m()V

    const/4 v0, 0x1

    .line 3
    iput-boolean v0, p0, Landroid/support/v7/graphics/drawable/d;->o:Z
...
.method protected onStateChange([I)Z
    ...
    .line 1
    invoke-super {p0, p1}, Landroid/support/v7/graphics/drawable/c;->onStateChange([I)Z
    ...
    invoke-virtual {v1, p1}, Landroid/support/v7/graphics/drawable/d$a;->a([I)I
    ...
    .line 3
    iget-object p1, p0, Landroid/support/v7/graphics/drawable/d;->n:Landroid/support/v7/graphics/drawable/d$a;

    sget-object v1, Landroid/util/StateSet;->WILD_CARD:[I

    invoke-virtual {p1, v1}, Landroid/support/v7/graphics/drawable/d$a;->a([I)I

    move-result p1

    .line 4
    :cond_0
    invoke-virtual {p0, p1}, Landroid/support/v7/graphics/drawable/c;->a(I)Z
...
.method protected setConstantState(Landroid/support/v7/graphics/drawable/c$b;)V
    ...
    .line 1
    invoke-super {p0, p1}, Landroid/support/v7/graphics/drawable/c;->setConstantState(Landroid/support/v7/graphics/drawable/c$b;)V
    ...
    iput-object p1, p0, Landroid/support/v7/graphics/drawable/d;->n:Landroid/support/v7/graphics/drawable/d$a;
