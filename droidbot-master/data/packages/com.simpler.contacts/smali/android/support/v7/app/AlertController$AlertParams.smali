...
.method private a(Landroid/support/v7/app/AlertController;)V
    ...
    invoke-direct/range {v1 .. v7}, Landroid/support/v7/app/h;-><init>(Landroid/support/v7/app/AlertController$AlertParams;Landroid/content/Context;II[Ljava/lang/CharSequence;Landroid/support/v7/app/AlertController$RecycleListView;)V
    ...
    invoke-direct/range {v1 .. v7}, Landroid/support/v7/app/i;-><init>(Landroid/support/v7/app/AlertController$AlertParams;Landroid/content/Context;Landroid/database/Cursor;ZLandroid/support/v7/app/AlertController$RecycleListView;Landroid/support/v7/app/AlertController;)V
    ...
    .line 13
    :cond_4
    new-instance v9, Landroid/support/v7/app/AlertController$b;
    ...
    invoke-direct {v9, v2, v4, v1, v3}, Landroid/support/v7/app/AlertController$b;-><init>(Landroid/content/Context;II[Ljava/lang/CharSequence;)V
    ...
    .line 16
    :cond_5
    iput-object v9, p1, Landroid/support/v7/app/AlertController;->H:Landroid/widget/ListAdapter;

    .line 17
    iget v1, p0, Landroid/support/v7/app/AlertController$AlertParams;->mCheckedItem:I

    iput v1, p1, Landroid/support/v7/app/AlertController;->I:I
    ...
    invoke-direct {v1, p0, p1}, Landroid/support/v7/app/j;-><init>(Landroid/support/v7/app/AlertController$AlertParams;Landroid/support/v7/app/AlertController;)V
    ...
    invoke-direct {v1, p0, v0, p1}, Landroid/support/v7/app/k;-><init>(Landroid/support/v7/app/AlertController$AlertParams;Landroid/support/v7/app/AlertController$RecycleListView;Landroid/support/v7/app/AlertController;)V
...
.method public apply(Landroid/support/v7/app/AlertController;)V
    ...
    .line 10
    invoke-virtual {p1, v0}, Landroid/support/v7/app/AlertController;->b(I)I
    ...
    .line 20
    :cond_c
    invoke-direct {p0, p1}, Landroid/support/v7/app/AlertController$AlertParams;->a(Landroid/support/v7/app/AlertController;)V
    ...
    .line 26
    invoke-virtual {p1, v0}, Landroid/support/v7/app/AlertController;->d(I)V
