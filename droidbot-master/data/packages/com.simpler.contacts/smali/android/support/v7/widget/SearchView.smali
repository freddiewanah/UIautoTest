...
.field private mTouchDelegate:Landroid/support/v7/widget/SearchView$c;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v0, p0}, Landroid/support/v7/widget/Ga;-><init>(Landroid/support/v7/widget/SearchView;)V
    ...
    invoke-direct {v0, p0}, Landroid/support/v7/widget/Ia;-><init>(Landroid/support/v7/widget/SearchView;)V
    ...
    invoke-direct {v0, p0}, Landroid/support/v7/widget/Ja;-><init>(Landroid/support/v7/widget/SearchView;)V
    ...
    new-instance p3, Landroid/support/v7/widget/Da;

    invoke-direct {p3, p0}, Landroid/support/v7/widget/Da;-><init>(Landroid/support/v7/widget/SearchView;)V
    ...
    .line 78
    new-instance p2, Landroid/support/v7/widget/Ea;

    invoke-direct {p2, p0}, Landroid/support/v7/widget/Ea;-><init>(Landroid/support/v7/widget/SearchView;)V
...
.method private createIntentFromSuggestion(Landroid/database/Cursor;ILjava/lang/String;)Landroid/content/Intent;
    ...
    .line 5
    invoke-static {p1, v3}, Landroid/support/v7/widget/Ra;->a(Landroid/database/Cursor;Ljava/lang/String;)Ljava/lang/String;
...
.method private updateSearchAutoComplete()V
    ...
    invoke-direct {v0, v1, p0, v3, v4}, Landroid/support/v7/widget/Ra;-><init>(Landroid/content/Context;Landroid/support/v7/widget/SearchView;Landroid/app/SearchableInfo;Ljava/util/WeakHashMap;)V
    ...
    check-cast v0, Landroid/support/v7/widget/Ra;
    ...
    :cond_2
    invoke-virtual {v0, v2}, Landroid/support/v7/widget/Ra;->a(I)V
...
.method protected onLayout(ZIIII)V
    ...
    .line 4
    iget-object p1, p0, Landroid/support/v7/widget/SearchView;->mTouchDelegate:Landroid/support/v7/widget/SearchView$c;

    if-nez p1, :cond_0

    .line 5
    new-instance p1, Landroid/support/v7/widget/SearchView$c;
    ...
    invoke-direct {p1, p2, p3, p4}, Landroid/support/v7/widget/SearchView$c;-><init>(Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/view/View;)V

    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->mTouchDelegate:Landroid/support/v7/widget/SearchView$c;
    ...
    invoke-virtual {p1, p2, p3}, Landroid/support/v7/widget/SearchView$c;->a(Landroid/graphics/Rect;Landroid/graphics/Rect;)V
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    .line 1
    instance-of v0, p1, Landroid/support/v7/widget/SearchView$b;
    ...
    .line 3
    :cond_0
    check-cast p1, Landroid/support/v7/widget/SearchView$b;
    ...
    .line 5
    iget-boolean p1, p1, Landroid/support/v7/widget/SearchView$b;->b:Z
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-direct {v1, v0}, Landroid/support/v7/widget/SearchView$b;-><init>(Landroid/os/Parcelable;)V
    ...
    iput-boolean v0, v1, Landroid/support/v7/widget/SearchView$b;->b:Z
...
.method onSuggestionsKey(Landroid/view/View;ILandroid/view/KeyEvent;)Z
    ...
    .line 10
    sget-object p1, Landroid/support/v7/widget/SearchView;->HIDDEN_METHOD_INVOKER:Landroid/support/v7/widget/SearchView$a;
...
.method public setQueryRefinementEnabled(Z)V
    ...
    instance-of v1, v0, Landroid/support/v7/widget/Ra;
    ...
    :goto_0
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/Ra;->a(I)V
