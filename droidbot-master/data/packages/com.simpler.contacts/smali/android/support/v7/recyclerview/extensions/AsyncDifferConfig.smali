...
.field private final c:Landroid/support/v7/util/DiffUtil$ItemCallback;
    .annotation build Landroid/support/annotation/NonNull;
    .end annotation
...
.method constructor <init>(Ljava/util/concurrent/Executor;Ljava/util/concurrent/Executor;Landroid/support/v7/util/DiffUtil$ItemCallback;)V
    ...
    .line 2
    iput-object p1, p0, Landroid/support/v7/recyclerview/extensions/AsyncDifferConfig;->a:Ljava/util/concurrent/Executor;

    .line 3
    iput-object p2, p0, Landroid/support/v7/recyclerview/extensions/AsyncDifferConfig;->b:Ljava/util/concurrent/Executor;

    .line 4
    iput-object p3, p0, Landroid/support/v7/recyclerview/extensions/AsyncDifferConfig;->c:Landroid/support/v7/util/DiffUtil$ItemCallback;
...
.method public getBackgroundThreadExecutor()Ljava/util/concurrent/Executor;
    ...
    .line 1
    iget-object v0, p0, Landroid/support/v7/recyclerview/extensions/AsyncDifferConfig;->b:Ljava/util/concurrent/Executor;
...
.method public getDiffCallback()Landroid/support/v7/util/DiffUtil$ItemCallback;
    ...
    .line 1
    iget-object v0, p0, Landroid/support/v7/recyclerview/extensions/AsyncDifferConfig;->c:Landroid/support/v7/util/DiffUtil$ItemCallback;
