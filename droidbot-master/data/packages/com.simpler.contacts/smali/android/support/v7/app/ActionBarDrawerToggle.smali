...
.method constructor <init>(Landroid/app/Activity;Landroid/support/v7/widget/Toolbar;Landroid/support/v4/widget/DrawerLayout;Landroid/support/v7/graphics/drawable/DrawerArrowDrawable;II)V
    ...
    .line 4
    iput-boolean v0, p0, Landroid/support/v7/app/ActionBarDrawerToggle;->d:Z
    ...
    .line 7
    new-instance p1, Landroid/support/v7/app/ActionBarDrawerToggle$b;

    invoke-direct {p1, p2}, Landroid/support/v7/app/ActionBarDrawerToggle$b;-><init>(Landroid/support/v7/widget/Toolbar;)V

    iput-object p1, p0, Landroid/support/v7/app/ActionBarDrawerToggle;->a:Landroid/support/v7/app/ActionBarDrawerToggle$Delegate;

    .line 8
    new-instance p1, Landroid/support/v7/app/a;

    invoke-direct {p1, p0}, Landroid/support/v7/app/a;-><init>(Landroid/support/v7/app/ActionBarDrawerToggle;)V
    ...
    .line 11
    :cond_1
    new-instance p2, Landroid/support/v7/app/ActionBarDrawerToggle$a;

    invoke-direct {p2, p1}, Landroid/support/v7/app/ActionBarDrawerToggle$a;-><init>(Landroid/app/Activity;)V

    iput-object p2, p0, Landroid/support/v7/app/ActionBarDrawerToggle;->a:Landroid/support/v7/app/ActionBarDrawerToggle$Delegate;
    ...
    .line 13
    iput p5, p0, Landroid/support/v7/app/ActionBarDrawerToggle;->h:I

    .line 14
    iput p6, p0, Landroid/support/v7/app/ActionBarDrawerToggle;->i:I
    ...
    iget-object p2, p0, Landroid/support/v7/app/ActionBarDrawerToggle;->a:Landroid/support/v7/app/ActionBarDrawerToggle$Delegate;
    ...
    iput-object p1, p0, Landroid/support/v7/app/ActionBarDrawerToggle;->c:Landroid/support/v7/graphics/drawable/DrawerArrowDrawable;

    goto :goto_1

    .line 16
    :cond_2
    iput-object p4, p0, Landroid/support/v7/app/ActionBarDrawerToggle;->c:Landroid/support/v7/graphics/drawable/DrawerArrowDrawable;
    ...
    iput-object p1, p0, Landroid/support/v7/app/ActionBarDrawerToggle;->e:Landroid/graphics/drawable/Drawable;
...
.method public getToolbarNavigationClickListener()Landroid/view/View$OnClickListener;
    ...
    .line 1
    iget-object v0, p0, Landroid/support/v7/app/ActionBarDrawerToggle;->j:Landroid/view/View$OnClickListener;
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    .line 1
    iget-boolean p1, p0, Landroid/support/v7/app/ActionBarDrawerToggle;->g:Z
...
.method public onDrawerClosed(Landroid/view/View;)V
    ...
    .line 3
    iget p1, p0, Landroid/support/v7/app/ActionBarDrawerToggle;->h:I
...
.method public setDrawerIndicatorEnabled(Z)V
    ...
    .line 5
    :cond_1
    iget-object v0, p0, Landroid/support/v7/app/ActionBarDrawerToggle;->e:Landroid/graphics/drawable/Drawable;
...
.method public setDrawerSlideAnimationEnabled(Z)V
    ...
    .line 1
    iput-boolean p1, p0, Landroid/support/v7/app/ActionBarDrawerToggle;->d:Z
...
.method public setHomeAsUpIndicator(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 4
    iput-boolean p1, p0, Landroid/support/v7/app/ActionBarDrawerToggle;->g:Z
    ...
    .line 6
    iget-object p1, p0, Landroid/support/v7/app/ActionBarDrawerToggle;->e:Landroid/graphics/drawable/Drawable;
...
.method public setToolbarNavigationClickListener(Landroid/view/View$OnClickListener;)V
    ...
    .line 1
    iput-object p1, p0, Landroid/support/v7/app/ActionBarDrawerToggle;->j:Landroid/view/View$OnClickListener;
