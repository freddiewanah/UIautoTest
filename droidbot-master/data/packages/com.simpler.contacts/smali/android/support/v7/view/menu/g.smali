...
.field c:Landroid/support/v7/view/menu/ListMenuPresenter;
...
.method public constructor <init>(Landroid/support/v7/view/menu/MenuBuilder;)V
    ...
    .line 2
    iput-object p1, p0, Landroid/support/v7/view/menu/g;->a:Landroid/support/v7/view/menu/MenuBuilder;
...
.method public a()V
    ...
    .line 18
    iget-object v0, p0, Landroid/support/v7/view/menu/g;->b:Landroid/support/v7/app/AlertDialog;
...
.method public a(Landroid/os/IBinder;)V
    ...
    .line 1
    iget-object v0, p0, Landroid/support/v7/view/menu/g;->a:Landroid/support/v7/view/menu/MenuBuilder;
    ...
    iput-object v2, p0, Landroid/support/v7/view/menu/g;->c:Landroid/support/v7/view/menu/ListMenuPresenter;

    .line 4
    iget-object v2, p0, Landroid/support/v7/view/menu/g;->c:Landroid/support/v7/view/menu/ListMenuPresenter;
    ...
    .line 5
    iget-object v2, p0, Landroid/support/v7/view/menu/g;->a:Landroid/support/v7/view/menu/MenuBuilder;

    iget-object v3, p0, Landroid/support/v7/view/menu/g;->c:Landroid/support/v7/view/menu/ListMenuPresenter;
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/g;->b:Landroid/support/v7/app/AlertDialog;
    ...
    .line 17
    iget-object p1, p0, Landroid/support/v7/view/menu/g;->b:Landroid/support/v7/app/AlertDialog;
...
.method public onClick(Landroid/content/DialogInterface;I)V
    ...
    .line 1
    iget-object p1, p0, Landroid/support/v7/view/menu/g;->a:Landroid/support/v7/view/menu/MenuBuilder;

    iget-object v0, p0, Landroid/support/v7/view/menu/g;->c:Landroid/support/v7/view/menu/ListMenuPresenter;
...
.method public onCloseMenu(Landroid/support/v7/view/menu/MenuBuilder;Z)V
    ...
    .line 3
    :cond_1
    iget-object v0, p0, Landroid/support/v7/view/menu/g;->d:Landroid/support/v7/view/menu/MenuPresenter$Callback;
...
.method public onDismiss(Landroid/content/DialogInterface;)V
    ...
    .line 1
    iget-object p1, p0, Landroid/support/v7/view/menu/g;->c:Landroid/support/v7/view/menu/ListMenuPresenter;
...
.method public onKey(Landroid/content/DialogInterface;ILandroid/view/KeyEvent;)Z
    ...
    .line 12
    iget-object p2, p0, Landroid/support/v7/view/menu/g;->a:Landroid/support/v7/view/menu/MenuBuilder;
