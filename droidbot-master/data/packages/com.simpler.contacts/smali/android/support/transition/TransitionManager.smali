...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroid/support/transition/TransitionManager;->d:Landroid/support/v4/util/ArrayMap;
    ...
    iput-object v0, p0, Landroid/support/transition/TransitionManager;->e:Landroid/support/v4/util/ArrayMap;

    return-void
.end method

.method private a(Landroid/support/transition/Scene;)Landroid/support/transition/Transition;
    .locals 2
    ...
    .line 3
    iget-object v1, p0, Landroid/support/transition/TransitionManager;->e:Landroid/support/v4/util/ArrayMap;
    ...
    .line 6
    :cond_0
    iget-object v0, p0, Landroid/support/transition/TransitionManager;->d:Landroid/support/v4/util/ArrayMap;
...
.method static a()Landroid/support/v4/util/ArrayMap;
    ...
    .line 25
    sget-object v2, Landroid/support/transition/TransitionManager;->b:Ljava/lang/ThreadLocal;
...
.method private static a(Landroid/support/transition/Scene;Landroid/support/transition/Transition;)V
    .locals 2
    ...
    .line 9
    sget-object v1, Landroid/support/transition/TransitionManager;->c:Ljava/util/ArrayList;
    ...
    .line 15
    invoke-virtual {v1}, Landroid/support/transition/Scene;->a()Z
    ...
    .line 17
    :cond_1
    invoke-static {v0, p1}, Landroid/support/transition/TransitionManager;->b(Landroid/view/ViewGroup;Landroid/support/transition/Transition;)V

    .line 18
    invoke-virtual {p0}, Landroid/support/transition/Scene;->enter()V

    .line 19
    invoke-static {v0, p1}, Landroid/support/transition/TransitionManager;->a(Landroid/view/ViewGroup;Landroid/support/transition/Transition;)V
...
.method private static b(Landroid/view/ViewGroup;Landroid/support/transition/Transition;)V
    ...
    .line 1
    invoke-static {}, Landroid/support/transition/TransitionManager;->a()Landroid/support/v4/util/ArrayMap;
...
.method public static beginDelayedTransition(Landroid/view/ViewGroup;Landroid/support/transition/Transition;)V
    ...
    .line 8
    invoke-static {p0, p1}, Landroid/support/transition/TransitionManager;->a(Landroid/view/ViewGroup;Landroid/support/transition/Transition;)V
...
.method public static go(Landroid/support/transition/Scene;)V
    ...
    .line 1
    sget-object v0, Landroid/support/transition/TransitionManager;->a:Landroid/support/transition/Transition;

    invoke-static {p0, v0}, Landroid/support/transition/TransitionManager;->a(Landroid/support/transition/Scene;Landroid/support/transition/Transition;)V
...
.method public static go(Landroid/support/transition/Scene;Landroid/support/transition/Transition;)V
    ...
    .line 2
    invoke-static {p0, p1}, Landroid/support/transition/TransitionManager;->a(Landroid/support/transition/Scene;Landroid/support/transition/Transition;)V
...
.method public setTransition(Landroid/support/transition/Scene;Landroid/support/transition/Scene;Landroid/support/transition/Transition;)V
    ...
    .line 2
    iget-object v0, p0, Landroid/support/transition/TransitionManager;->e:Landroid/support/v4/util/ArrayMap;
...
.method public transitionTo(Landroid/support/transition/Scene;)V
    ...
    .line 1
    invoke-direct {p0, p1}, Landroid/support/transition/TransitionManager;->a(Landroid/support/transition/Scene;)Landroid/support/transition/Transition;

    move-result-object v0

    invoke-static {p1, v0}, Landroid/support/transition/TransitionManager;->a(Landroid/support/transition/Scene;Landroid/support/transition/Transition;)V
