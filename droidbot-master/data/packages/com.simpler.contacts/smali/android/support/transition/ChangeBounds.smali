...
.field private static R:Landroid/support/transition/K;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/transition/ChangeBounds;->R:Landroid/support/transition/K;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 9
    sget-object v1, Landroid/support/transition/S;->d:[I
...
.method public captureEndValues(Landroid/support/transition/TransitionValues;)V
    ...
    .line 1
    invoke-direct {p0, p1}, Landroid/support/transition/ChangeBounds;->b(Landroid/support/transition/TransitionValues;)V
...
.method public createAnimator(Landroid/view/ViewGroup;Landroid/support/transition/TransitionValues;Landroid/support/transition/TransitionValues;)Landroid/animation/Animator;
    ...
    .line 21
    invoke-static {v9, v6, v11, v13, v3}, Landroid/support/transition/na;->a(Landroid/view/View;IIII)V
    ...
    invoke-static {v9, v1, v0}, Landroid/support/transition/H;->a(Ljava/lang/Object;Landroid/util/Property;Landroid/graphics/Path;)Landroid/animation/ObjectAnimator;
    ...
    .line 27
    invoke-static {v1, v4, v2}, Landroid/support/transition/H;->a(Ljava/lang/Object;Landroid/util/Property;Landroid/graphics/Path;)Landroid/animation/ObjectAnimator;
    ...
    invoke-static {v1, v4, v3}, Landroid/support/transition/H;->a(Ljava/lang/Object;Landroid/util/Property;Landroid/graphics/Path;)Landroid/animation/ObjectAnimator;
    ...
    .line 39
    invoke-static {v9, v6, v11, v1, v3}, Landroid/support/transition/na;->a(Landroid/view/View;IIII)V
    ...
    invoke-static {v9, v3, v1}, Landroid/support/transition/H;->a(Ljava/lang/Object;Landroid/util/Property;Landroid/graphics/Path;)Landroid/animation/ObjectAnimator;
    ...
    .line 46
    sget-object v4, Landroid/support/transition/ChangeBounds;->R:Landroid/support/transition/K;
    ...
    .line 48
    :goto_8
    invoke-static {v11, v10}, Landroid/support/transition/Y;->a(Landroid/animation/Animator;Landroid/animation/Animator;)Landroid/animation/Animator;
    ...
    .line 51
    invoke-static {v1, v2}, Landroid/support/transition/ea;->a(Landroid/view/ViewGroup;Z)V
    ...
    .line 63
    invoke-static {v9}, Landroid/support/transition/na;->c(Landroid/view/View;)F
    ...
    .line 64
    invoke-static {v9, v4}, Landroid/support/transition/na;->a(Landroid/view/View;F)V

    .line 65
    invoke-static/range {p1 .. p1}, Landroid/support/transition/na;->b(Landroid/view/View;)Landroid/support/transition/ka;

    move-result-object v4

    invoke-interface {v4, v6}, Landroid/support/transition/ka;->a(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-static {v1, v0}, Landroid/support/transition/J;->a(Landroid/util/Property;Landroid/graphics/Path;)Landroid/animation/PropertyValuesHolder;
...
.method public getResizeClip()Z
    ...
    .line 1
    iget-boolean v0, p0, Landroid/support/transition/ChangeBounds;->T:Z
