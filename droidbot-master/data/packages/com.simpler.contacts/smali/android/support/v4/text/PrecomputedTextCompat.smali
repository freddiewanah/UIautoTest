...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroid/support/v4/text/PrecomputedTextCompat$a;,
...
.field private final d:Landroid/support/v4/text/PrecomputedTextCompat$Params;
    .annotation build Landroid/support/annotation/NonNull;
    .end annotation
.end field
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/text/PrecomputedTextCompat;->a:Ljava/lang/Object;

    const/4 v0, 0x0

    .line 2
    sput-object v0, Landroid/support/v4/text/PrecomputedTextCompat;->b:Ljava/util/concurrent/Executor;
...
.method private constructor <init>(Landroid/text/PrecomputedText;Landroid/support/v4/text/PrecomputedTextCompat$Params;)V
    ...
    .line 7
    iput-object p1, p0, Landroid/support/v4/text/PrecomputedTextCompat;->c:Landroid/text/Spannable;

    .line 8
    iput-object p2, p0, Landroid/support/v4/text/PrecomputedTextCompat;->d:Landroid/support/v4/text/PrecomputedTextCompat$Params;

    const/4 p2, 0x0

    .line 9
    iput-object p2, p0, Landroid/support/v4/text/PrecomputedTextCompat;->e:[I

    .line 10
    iput-object p1, p0, Landroid/support/v4/text/PrecomputedTextCompat;->f:Landroid/text/PrecomputedText;
...
.method private constructor <init>(Ljava/lang/CharSequence;Landroid/support/v4/text/PrecomputedTextCompat$Params;[I)V
    ...
    iput-object v0, p0, Landroid/support/v4/text/PrecomputedTextCompat;->c:Landroid/text/Spannable;

    .line 3
    iput-object p2, p0, Landroid/support/v4/text/PrecomputedTextCompat;->d:Landroid/support/v4/text/PrecomputedTextCompat$Params;

    .line 4
    iput-object p3, p0, Landroid/support/v4/text/PrecomputedTextCompat;->e:[I
...
.method public static create(Ljava/lang/CharSequence;Landroid/support/v4/text/PrecomputedTextCompat$Params;)Landroid/support/v4/text/PrecomputedTextCompat;
    ...
    iget-object v0, p1, Landroid/support/v4/text/PrecomputedTextCompat$Params;->e:Landroid/text/PrecomputedText$Params;
    ...
    iget-object v1, p1, Landroid/support/v4/text/PrecomputedTextCompat$Params;->e:Landroid/text/PrecomputedText$Params;
...
.method public static getTextFuture(Ljava/lang/CharSequence;Landroid/support/v4/text/PrecomputedTextCompat$Params;Ljava/util/concurrent/Executor;)Ljava/util/concurrent/Future;
    ...
    .line 1
    new-instance v0, Landroid/support/v4/text/PrecomputedTextCompat$a;

    invoke-direct {v0, p1, p0}, Landroid/support/v4/text/PrecomputedTextCompat$a;-><init>(Landroid/support/v4/text/PrecomputedTextCompat$Params;Ljava/lang/CharSequence;)V

    if-nez p2, :cond_1

    .line 2
    sget-object p0, Landroid/support/v4/text/PrecomputedTextCompat;->a:Ljava/lang/Object;

    monitor-enter p0

    .line 3
    :try_start_0
    sget-object p1, Landroid/support/v4/text/PrecomputedTextCompat;->b:Ljava/util/concurrent/Executor;
    ...
    sput-object p1, Landroid/support/v4/text/PrecomputedTextCompat;->b:Ljava/util/concurrent/Executor;

    .line 5
    :cond_0
    sget-object p2, Landroid/support/v4/text/PrecomputedTextCompat;->b:Ljava/util/concurrent/Executor;
...
.method public charAt(I)C
    ...
    .line 1
    iget-object v0, p0, Landroid/support/v4/text/PrecomputedTextCompat;->c:Landroid/text/Spannable;
...
.method public getParagraphCount()I
    ...
    .line 2
    iget-object v0, p0, Landroid/support/v4/text/PrecomputedTextCompat;->f:Landroid/text/PrecomputedText;
    ...
    .line 3
    :cond_0
    iget-object v0, p0, Landroid/support/v4/text/PrecomputedTextCompat;->e:[I
...
.method public getParams()Landroid/support/v4/text/PrecomputedTextCompat$Params;
    ...
    .line 1
    iget-object v0, p0, Landroid/support/v4/text/PrecomputedTextCompat;->d:Landroid/support/v4/text/PrecomputedTextCompat$Params;
