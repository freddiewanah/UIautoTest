...
# instance fields
.field private b:Landroid/support/v4/media/MediaBrowserServiceCompat$b;

.field final c:Landroid/support/v4/util/ArrayMap;
...
.field final e:Landroid/support/v4/media/MediaBrowserServiceCompat$k;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroid/support/v4/media/MediaBrowserServiceCompat;->e:Landroid/support/v4/media/MediaBrowserServiceCompat$k;
...
.method a(Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/media/MediaBrowserServiceCompat$a;Landroid/support/v4/os/ResultReceiver;)V
    .locals 1

    .line 53
    new-instance v0, Landroid/support/v4/media/z;

    invoke-direct {v0, p0, p1, p4}, Landroid/support/v4/media/z;-><init>(Landroid/support/v4/media/MediaBrowserServiceCompat;Ljava/lang/Object;Landroid/support/v4/os/ResultReceiver;)V

    .line 54
    iput-object p3, p0, Landroid/support/v4/media/MediaBrowserServiceCompat;->d:Landroid/support/v4/media/MediaBrowserServiceCompat$a;
    ...
    .line 57
    invoke-virtual {v0}, Landroid/support/v4/media/MediaBrowserServiceCompat$Result;->b()Z
...
.method a(Ljava/lang/String;Landroid/support/v4/media/MediaBrowserServiceCompat$a;Landroid/os/Bundle;Landroid/os/Bundle;)V
    .locals 8
    ...
    invoke-direct/range {v0 .. v6}, Landroid/support/v4/media/w;-><init>(Landroid/support/v4/media/MediaBrowserServiceCompat;Ljava/lang/Object;Landroid/support/v4/media/MediaBrowserServiceCompat$a;Ljava/lang/String;Landroid/os/Bundle;Landroid/os/Bundle;)V

    .line 34
    iput-object p2, p0, Landroid/support/v4/media/MediaBrowserServiceCompat;->d:Landroid/support/v4/media/MediaBrowserServiceCompat$a;
    ...
    .line 38
    invoke-virtual {v7}, Landroid/support/v4/media/MediaBrowserServiceCompat$Result;->b()Z
    ...
    iget-object p2, p2, Landroid/support/v4/media/MediaBrowserServiceCompat$a;->a:Ljava/lang/String;
...
.method a(Ljava/lang/String;Landroid/support/v4/media/MediaBrowserServiceCompat$a;Landroid/os/IBinder;Landroid/os/Bundle;)V
    .locals 4

    .line 5
    iget-object v0, p2, Landroid/support/v4/media/MediaBrowserServiceCompat$a;->g:Ljava/util/HashMap;
    ...
    .line 11
    iget-object p3, p2, Landroid/support/v4/media/MediaBrowserServiceCompat$a;->g:Ljava/util/HashMap;
    ...
    .line 12
    invoke-virtual {p0, p1, p2, p4, p3}, Landroid/support/v4/media/MediaBrowserServiceCompat;->a(Ljava/lang/String;Landroid/support/v4/media/MediaBrowserServiceCompat$a;Landroid/os/Bundle;Landroid/os/Bundle;)V
...
.method a(Ljava/lang/String;Landroid/support/v4/media/MediaBrowserServiceCompat$a;Landroid/support/v4/os/ResultReceiver;)V
    .locals 1

    .line 47
    new-instance v0, Landroid/support/v4/media/x;

    invoke-direct {v0, p0, p1, p3}, Landroid/support/v4/media/x;-><init>(Landroid/support/v4/media/MediaBrowserServiceCompat;Ljava/lang/Object;Landroid/support/v4/os/ResultReceiver;)V
...
.method a(Ljava/lang/String;Landroid/support/v4/media/MediaBrowserServiceCompat$a;Landroid/os/IBinder;)Z
    .locals 6
    ...
    .line 19
    iput-object v2, p0, Landroid/support/v4/media/MediaBrowserServiceCompat;->d:Landroid/support/v4/media/MediaBrowserServiceCompat$a;
    ...
    :cond_1
    :try_start_1
    iget-object v3, p2, Landroid/support/v4/media/MediaBrowserServiceCompat$a;->g:Ljava/util/HashMap;
...
.method b(Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/media/MediaBrowserServiceCompat$a;Landroid/support/v4/os/ResultReceiver;)V
    .locals 1

    .line 1
    new-instance v0, Landroid/support/v4/media/y;

    invoke-direct {v0, p0, p1, p4}, Landroid/support/v4/media/y;-><init>(Landroid/support/v4/media/MediaBrowserServiceCompat;Ljava/lang/Object;Landroid/support/v4/os/ResultReceiver;)V
...
.method public final getBrowserRootHints()Landroid/os/Bundle;
    ...
    .line 1
    iget-object v0, p0, Landroid/support/v4/media/MediaBrowserServiceCompat;->b:Landroid/support/v4/media/MediaBrowserServiceCompat$b;
...
.method public final getCurrentBrowserInfo()Landroid/support/v4/media/MediaSessionManager$RemoteUserInfo;
    ...
    invoke-interface {v0}, Landroid/support/v4/media/MediaBrowserServiceCompat$b;->a()Landroid/support/v4/media/MediaSessionManager$RemoteUserInfo;
...
.method public getSessionToken()Landroid/support/v4/media/session/MediaSessionCompat$Token;
    ...
    .line 1
    iget-object v0, p0, Landroid/support/v4/media/MediaBrowserServiceCompat;->f:Landroid/support/v4/media/session/MediaSessionCompat$Token;
...
.method public notifyChildrenChanged(Landroid/support/v4/media/MediaSessionManager$RemoteUserInfo;Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    invoke-interface {v0, p1, p2, p3}, Landroid/support/v4/media/MediaBrowserServiceCompat$b;->a(Landroid/support/v4/media/MediaSessionManager$RemoteUserInfo;Ljava/lang/String;Landroid/os/Bundle;)V
...
.method public onCreate()V
    ...
    iput-object v0, p0, Landroid/support/v4/media/MediaBrowserServiceCompat;->b:Landroid/support/v4/media/MediaBrowserServiceCompat$b;
    ...
    invoke-interface {v0}, Landroid/support/v4/media/MediaBrowserServiceCompat$b;->onCreate()V
...
.method public onLoadItem(Ljava/lang/String;Landroid/support/v4/media/MediaBrowserServiceCompat$Result;)V
    ...
    .line 1
    invoke-virtual {p2, p1}, Landroid/support/v4/media/MediaBrowserServiceCompat$Result;->a(I)V
...
.method public onSearch(Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/media/MediaBrowserServiceCompat$Result;)V
    ...
    .line 1
    invoke-virtual {p3, p1}, Landroid/support/v4/media/MediaBrowserServiceCompat$Result;->a(I)V
...
.method public setSessionToken(Landroid/support/v4/media/session/MediaSessionCompat$Token;)V
    ...
    .line 2
    iput-object p1, p0, Landroid/support/v4/media/MediaBrowserServiceCompat;->f:Landroid/support/v4/media/session/MediaSessionCompat$Token;
