...
.method private constructor <init>(Landroid/app/Activity;)V
    ...
    iput-object v0, p0, Landroid/support/v4/app/ShareCompat$IntentBuilder;->b:Landroid/content/Intent;
    ...
    .line 6
    iget-object p1, p0, Landroid/support/v4/app/ShareCompat$IntentBuilder;->b:Landroid/content/Intent;
...
.method private a(Ljava/lang/String;Ljava/util/ArrayList;)V
    ...
    .line 7
    :cond_1
    iget-object p2, p0, Landroid/support/v4/app/ShareCompat$IntentBuilder;->b:Landroid/content/Intent;
...
.method public addEmailBcc(Ljava/lang/String;)Landroid/support/v4/app/ShareCompat$IntentBuilder;
    ...
    .line 1
    iget-object v0, p0, Landroid/support/v4/app/ShareCompat$IntentBuilder;->f:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Landroid/support/v4/app/ShareCompat$IntentBuilder;->f:Ljava/util/ArrayList;
...
.method public addEmailCc(Ljava/lang/String;)Landroid/support/v4/app/ShareCompat$IntentBuilder;
    ...
    .line 1
    iget-object v0, p0, Landroid/support/v4/app/ShareCompat$IntentBuilder;->e:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Landroid/support/v4/app/ShareCompat$IntentBuilder;->e:Ljava/util/ArrayList;
...
.method public addStream(Landroid/net/Uri;)Landroid/support/v4/app/ShareCompat$IntentBuilder;
    ...
    .line 2
    iget-object v2, p0, Landroid/support/v4/app/ShareCompat$IntentBuilder;->g:Ljava/util/ArrayList;
    ...
    iput-object v2, p0, Landroid/support/v4/app/ShareCompat$IntentBuilder;->g:Ljava/util/ArrayList;

    :cond_1
    if-eqz v0, :cond_2

    .line 6
    iget-object v2, p0, Landroid/support/v4/app/ShareCompat$IntentBuilder;->b:Landroid/content/Intent;

    invoke-virtual {v2, v1}, Landroid/content/Intent;->removeExtra(Ljava/lang/String;)V

    .line 7
    iget-object v1, p0, Landroid/support/v4/app/ShareCompat$IntentBuilder;->g:Ljava/util/ArrayList;

    invoke-virtual {v1, v0}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 8
    :cond_2
    iget-object v0, p0, Landroid/support/v4/app/ShareCompat$IntentBuilder;->g:Ljava/util/ArrayList;
...
.method public createChooserIntent()Landroid/content/Intent;
    ...
    iget-object v1, p0, Landroid/support/v4/app/ShareCompat$IntentBuilder;->c:Ljava/lang/CharSequence;
...
.method public getIntent()Landroid/content/Intent;
    ...
    .line 2
    invoke-direct {p0, v2, v0}, Landroid/support/v4/app/ShareCompat$IntentBuilder;->a(Ljava/lang/String;Ljava/util/ArrayList;)V
    ...
    .line 6
    iput-object v1, p0, Landroid/support/v4/app/ShareCompat$IntentBuilder;->e:Ljava/util/ArrayList;
    ...
    .line 9
    iput-object v1, p0, Landroid/support/v4/app/ShareCompat$IntentBuilder;->f:Ljava/util/ArrayList;
    ...
    .line 12
    iget-object v6, p0, Landroid/support/v4/app/ShareCompat$IntentBuilder;->b:Landroid/content/Intent;
    ...
    .line 13
    iget-object v6, p0, Landroid/support/v4/app/ShareCompat$IntentBuilder;->g:Ljava/util/ArrayList;
    ...
    iget-object v7, p0, Landroid/support/v4/app/ShareCompat$IntentBuilder;->g:Ljava/util/ArrayList;
    ...
    .line 15
    :cond_4
    iget-object v3, p0, Landroid/support/v4/app/ShareCompat$IntentBuilder;->b:Landroid/content/Intent;

    invoke-virtual {v3, v5}, Landroid/content/Intent;->removeExtra(Ljava/lang/String;)V

    .line 16
    :goto_1
    iput-object v1, p0, Landroid/support/v4/app/ShareCompat$IntentBuilder;->g:Ljava/util/ArrayList;
...
.method public setChooserTitle(Ljava/lang/CharSequence;)Landroid/support/v4/app/ShareCompat$IntentBuilder;
    ...
    .line 1
    iput-object p1, p0, Landroid/support/v4/app/ShareCompat$IntentBuilder;->c:Ljava/lang/CharSequence;
...
.method public setStream(Landroid/net/Uri;)Landroid/support/v4/app/ShareCompat$IntentBuilder;
    ...
    .line 3
    iput-object v0, p0, Landroid/support/v4/app/ShareCompat$IntentBuilder;->g:Ljava/util/ArrayList;
