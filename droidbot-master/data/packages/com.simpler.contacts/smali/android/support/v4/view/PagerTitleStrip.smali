...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v0, p0, Landroid/support/v4/view/PagerTitleStrip;->m:Landroid/support/v4/view/PagerTitleStrip$a;
    ...
    iput-object v0, p0, Landroid/support/v4/view/PagerTitleStrip;->e:Landroid/widget/TextView;
    ...
    iput-object v0, p0, Landroid/support/v4/view/PagerTitleStrip;->f:Landroid/widget/TextView;
    ...
    .line 12
    iget-object v2, p0, Landroid/support/v4/view/PagerTitleStrip;->e:Landroid/widget/TextView;

    invoke-static {v2, v1}, Landroid/support/v4/widget/TextViewCompat;->setTextAppearance(Landroid/widget/TextView;I)V

    .line 13
    iget-object v2, p0, Landroid/support/v4/view/PagerTitleStrip;->f:Landroid/widget/TextView;
    ...
    .line 19
    iget-object v3, p0, Landroid/support/v4/view/PagerTitleStrip;->e:Landroid/widget/TextView;

    invoke-virtual {v3, v2}, Landroid/widget/TextView;->setTextColor(I)V

    .line 20
    iget-object v3, p0, Landroid/support/v4/view/PagerTitleStrip;->f:Landroid/widget/TextView;
    ...
    iput v2, p0, Landroid/support/v4/view/PagerTitleStrip;->j:I

    .line 22
    invoke-virtual {p2}, Landroid/content/res/TypedArray;->recycle()V

    .line 23
    iget-object p2, p0, Landroid/support/v4/view/PagerTitleStrip;->e:Landroid/widget/TextView;
    ...
    iput p2, p0, Landroid/support/v4/view/PagerTitleStrip;->p:I
    ...
    .line 25
    iget-object p2, p0, Landroid/support/v4/view/PagerTitleStrip;->d:Landroid/widget/TextView;
    ...
    .line 27
    iget-object p2, p0, Landroid/support/v4/view/PagerTitleStrip;->f:Landroid/widget/TextView;
...
.method a(IFZ)V
    ...
    .line 32
    iget v3, v0, Landroid/support/v4/view/PagerTitleStrip;->g:I

    if-eq v1, v3, :cond_0

    .line 33
    iget-object v3, v0, Landroid/support/v4/view/PagerTitleStrip;->c:Landroid/support/v4/view/ViewPager;

    invoke-virtual {v3}, Landroid/support/v4/view/ViewPager;->getAdapter()Landroid/support/v4/view/PagerAdapter;

    move-result-object v3

    invoke-virtual {v0, v1, v3}, Landroid/support/v4/view/PagerTitleStrip;->a(ILandroid/support/v4/view/PagerAdapter;)V
    ...
    .line 34
    iget v1, v0, Landroid/support/v4/view/PagerTitleStrip;->h:F
    ...
    .line 35
    iput-boolean v1, v0, Landroid/support/v4/view/PagerTitleStrip;->l:Z

    .line 36
    iget-object v1, v0, Landroid/support/v4/view/PagerTitleStrip;->d:Landroid/widget/TextView;
    ...
    .line 37
    iget-object v3, v0, Landroid/support/v4/view/PagerTitleStrip;->e:Landroid/widget/TextView;
    ...
    .line 38
    iget-object v4, v0, Landroid/support/v4/view/PagerTitleStrip;->f:Landroid/widget/TextView;
    ...
    .line 46
    iget-object v5, v0, Landroid/support/v4/view/PagerTitleStrip;->d:Landroid/widget/TextView;
    ...
    .line 47
    iget-object v12, v0, Landroid/support/v4/view/PagerTitleStrip;->e:Landroid/widget/TextView;
    ...
    .line 48
    iget-object v14, v0, Landroid/support/v4/view/PagerTitleStrip;->f:Landroid/widget/TextView;
    ...
    .line 51
    iget-object v2, v0, Landroid/support/v4/view/PagerTitleStrip;->e:Landroid/widget/TextView;
    ...
    .line 54
    iget v4, v0, Landroid/support/v4/view/PagerTitleStrip;->j:I
    ...
    .line 59
    iget v2, v0, Landroid/support/v4/view/PagerTitleStrip;->i:I
    ...
    .line 63
    iget v1, v0, Landroid/support/v4/view/PagerTitleStrip;->i:I
    ...
    .line 64
    iget-object v2, v0, Landroid/support/v4/view/PagerTitleStrip;->f:Landroid/widget/TextView;
    ...
    .line 67
    iput v1, v0, Landroid/support/v4/view/PagerTitleStrip;->h:F
...
.method a(ILandroid/support/v4/view/PagerAdapter;)V
    ...
    .line 20
    iget-boolean p2, p0, Landroid/support/v4/view/PagerTitleStrip;->l:Z

    if-nez p2, :cond_4

    .line 21
    iget p2, p0, Landroid/support/v4/view/PagerTitleStrip;->h:F

    invoke-virtual {p0, p1, p2, v0}, Landroid/support/v4/view/PagerTitleStrip;->a(IFZ)V

    .line 22
    :cond_4
    iput-boolean v0, p0, Landroid/support/v4/view/PagerTitleStrip;->k:Z
...
.method a(Landroid/support/v4/view/PagerAdapter;Landroid/support/v4/view/PagerAdapter;)V
    ...
    .line 24
    iput-object p1, p0, Landroid/support/v4/view/PagerTitleStrip;->n:Ljava/lang/ref/WeakReference;

    :cond_0
    if-eqz p2, :cond_1

    .line 25
    iget-object p1, p0, Landroid/support/v4/view/PagerTitleStrip;->m:Landroid/support/v4/view/PagerTitleStrip$a;
    ...
    .line 27
    :cond_1
    iget-object p1, p0, Landroid/support/v4/view/PagerTitleStrip;->c:Landroid/support/v4/view/ViewPager;
    ...
    invoke-virtual {p0, p1, p2}, Landroid/support/v4/view/PagerTitleStrip;->a(ILandroid/support/v4/view/PagerAdapter;)V
...
.method protected onAttachedToWindow()V
    ...
    .line 8
    iput-object v0, p0, Landroid/support/v4/view/PagerTitleStrip;->c:Landroid/support/v4/view/ViewPager;
...
.method protected onDetachedFromWindow()V
    ...
    .line 2
    iget-object v0, p0, Landroid/support/v4/view/PagerTitleStrip;->c:Landroid/support/v4/view/ViewPager;
    ...
    .line 6
    iput-object v1, p0, Landroid/support/v4/view/PagerTitleStrip;->c:Landroid/support/v4/view/ViewPager;
...
.method protected onLayout(ZIIII)V
    ...
    .line 2
    iget p1, p0, Landroid/support/v4/view/PagerTitleStrip;->h:F
    ...
    .line 3
    :goto_0
    iget p2, p0, Landroid/support/v4/view/PagerTitleStrip;->g:I
...
.method protected onMeasure(II)V
    ...
    .line 11
    :cond_0
    iget-object p1, p0, Landroid/support/v4/view/PagerTitleStrip;->e:Landroid/widget/TextView;
    ...
    .line 14
    :goto_0
    iget-object v0, p0, Landroid/support/v4/view/PagerTitleStrip;->e:Landroid/widget/TextView;
...
.method public setNonPrimaryAlpha(F)V
    ...
    .line 1
    iput p1, p0, Landroid/support/v4/view/PagerTitleStrip;->o:I

    .line 2
    iget p1, p0, Landroid/support/v4/view/PagerTitleStrip;->o:I
    ...
    .line 4
    iget-object v0, p0, Landroid/support/v4/view/PagerTitleStrip;->f:Landroid/widget/TextView;
...
.method public setTextColor(I)V
    ...
    .line 1
    iput p1, p0, Landroid/support/v4/view/PagerTitleStrip;->p:I
