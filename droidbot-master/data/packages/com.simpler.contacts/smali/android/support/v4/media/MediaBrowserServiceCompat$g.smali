...
.method constructor <init>(Landroid/support/v4/media/MediaBrowserServiceCompat;)V
    ...
    .line 1
    iput-object p1, p0, Landroid/support/v4/media/MediaBrowserServiceCompat$g;->b:Landroid/support/v4/media/MediaBrowserServiceCompat;
...
.method public a(Landroid/content/Intent;)Landroid/os/IBinder;
    ...
    .line 2
    iget-object p1, p0, Landroid/support/v4/media/MediaBrowserServiceCompat$g;->a:Landroid/os/Messenger;
...
.method public a()Landroid/support/v4/media/MediaSessionManager$RemoteUserInfo;
    ...
    .line 10
    iget-object v0, p0, Landroid/support/v4/media/MediaBrowserServiceCompat$g;->b:Landroid/support/v4/media/MediaBrowserServiceCompat;
...
.method a(Landroid/support/v4/media/MediaBrowserServiceCompat$a;Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    .line 9
    iget-object v2, p0, Landroid/support/v4/media/MediaBrowserServiceCompat$g;->b:Landroid/support/v4/media/MediaBrowserServiceCompat;
...
.method public a(Landroid/support/v4/media/MediaSessionManager$RemoteUserInfo;Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    invoke-direct {v1, p0, p1, p2, p3}, Landroid/support/v4/media/J;-><init>(Landroid/support/v4/media/MediaBrowserServiceCompat$g;Landroid/support/v4/media/MediaSessionManager$RemoteUserInfo;Ljava/lang/String;Landroid/os/Bundle;)V
...
.method public a(Landroid/support/v4/media/session/MediaSessionCompat$Token;)V
    ...
    invoke-direct {v1, p0, p1}, Landroid/support/v4/media/H;-><init>(Landroid/support/v4/media/MediaBrowserServiceCompat$g;Landroid/support/v4/media/session/MediaSessionCompat$Token;)V
...
.method public a(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    invoke-direct {v1, p0, p1, p2}, Landroid/support/v4/media/I;-><init>(Landroid/support/v4/media/MediaBrowserServiceCompat$g;Ljava/lang/String;Landroid/os/Bundle;)V
...
.method public onCreate()V
    ...
    iget-object v1, p0, Landroid/support/v4/media/MediaBrowserServiceCompat$g;->b:Landroid/support/v4/media/MediaBrowserServiceCompat;

    iget-object v1, v1, Landroid/support/v4/media/MediaBrowserServiceCompat;->e:Landroid/support/v4/media/MediaBrowserServiceCompat$k;

    invoke-direct {v0, v1}, Landroid/os/Messenger;-><init>(Landroid/os/Handler;)V

    iput-object v0, p0, Landroid/support/v4/media/MediaBrowserServiceCompat$g;->a:Landroid/os/Messenger;
