...
.method constructor <init>(Landroid/support/v4/media/MediaBrowserServiceCompat$h;Landroid/support/v4/media/MediaBrowserServiceCompat$i;Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/os/ResultReceiver;)V
    ...
    .line 1
    iput-object p1, p0, Landroid/support/v4/media/S;->e:Landroid/support/v4/media/MediaBrowserServiceCompat$h;

    iput-object p2, p0, Landroid/support/v4/media/S;->a:Landroid/support/v4/media/MediaBrowserServiceCompat$i;

    iput-object p3, p0, Landroid/support/v4/media/S;->b:Ljava/lang/String;

    iput-object p4, p0, Landroid/support/v4/media/S;->c:Landroid/os/Bundle;

    iput-object p5, p0, Landroid/support/v4/media/S;->d:Landroid/support/v4/os/ResultReceiver;
...
.method public run()V
    ...
    .line 1
    iget-object v0, p0, Landroid/support/v4/media/S;->a:Landroid/support/v4/media/MediaBrowserServiceCompat$i;
    ...
    .line 2
    iget-object v1, p0, Landroid/support/v4/media/S;->e:Landroid/support/v4/media/MediaBrowserServiceCompat$h;
    ...
    iget-object v1, p0, Landroid/support/v4/media/S;->b:Ljava/lang/String;
    ...
    iget-object v2, p0, Landroid/support/v4/media/S;->b:Ljava/lang/String;

    iget-object v3, p0, Landroid/support/v4/media/S;->c:Landroid/os/Bundle;

    iget-object v4, p0, Landroid/support/v4/media/S;->d:Landroid/support/v4/os/ResultReceiver;

    invoke-virtual {v1, v2, v3, v0, v4}, Landroid/support/v4/media/MediaBrowserServiceCompat;->b(Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/media/MediaBrowserServiceCompat$a;Landroid/support/v4/os/ResultReceiver;)V
