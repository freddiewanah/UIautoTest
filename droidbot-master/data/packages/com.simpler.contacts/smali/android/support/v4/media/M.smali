...
.method constructor <init>(Landroid/support/v4/media/MediaBrowserServiceCompat$h;Landroid/support/v4/media/MediaBrowserServiceCompat$i;Ljava/lang/String;Landroid/os/IBinder;Landroid/os/Bundle;)V
    ...
    .line 1
    iput-object p1, p0, Landroid/support/v4/media/M;->e:Landroid/support/v4/media/MediaBrowserServiceCompat$h;

    iput-object p2, p0, Landroid/support/v4/media/M;->a:Landroid/support/v4/media/MediaBrowserServiceCompat$i;

    iput-object p3, p0, Landroid/support/v4/media/M;->b:Ljava/lang/String;

    iput-object p4, p0, Landroid/support/v4/media/M;->c:Landroid/os/IBinder;

    iput-object p5, p0, Landroid/support/v4/media/M;->d:Landroid/os/Bundle;
...
.method public run()V
    ...
    .line 1
    iget-object v0, p0, Landroid/support/v4/media/M;->a:Landroid/support/v4/media/MediaBrowserServiceCompat$i;
    ...
    .line 2
    iget-object v1, p0, Landroid/support/v4/media/M;->e:Landroid/support/v4/media/MediaBrowserServiceCompat$h;
    ...
    iget-object v2, p0, Landroid/support/v4/media/M;->b:Ljava/lang/String;

    iget-object v3, p0, Landroid/support/v4/media/M;->c:Landroid/os/IBinder;

    iget-object v4, p0, Landroid/support/v4/media/M;->d:Landroid/os/Bundle;
