...
.field private e:Landroid/support/v4/widget/SimpleCursorAdapter$CursorToStringConverter;

.field private f:Landroid/support/v4/widget/SimpleCursorAdapter$ViewBinder;
...
.method public constructor <init>(Landroid/content/Context;ILandroid/database/Cursor;[Ljava/lang/String;[I)V
    ...
    .line 2
    iput p1, p0, Landroid/support/v4/widget/SimpleCursorAdapter;->d:I

    .line 3
    iput-object p5, p0, Landroid/support/v4/widget/SimpleCursorAdapter;->mTo:[I

    .line 4
    iput-object p4, p0, Landroid/support/v4/widget/SimpleCursorAdapter;->g:[Ljava/lang/String;

    .line 5
    invoke-direct {p0, p3, p4}, Landroid/support/v4/widget/SimpleCursorAdapter;->a(Landroid/database/Cursor;[Ljava/lang/String;)V
...
.method public bindView(Landroid/view/View;Landroid/content/Context;Landroid/database/Cursor;)V
    ...
    .line 1
    iget-object p2, p0, Landroid/support/v4/widget/SimpleCursorAdapter;->f:Landroid/support/v4/widget/SimpleCursorAdapter$ViewBinder;
...
.method public changeCursorAndColumns(Landroid/database/Cursor;[Ljava/lang/String;[I)V
    ...
    .line 1
    iput-object p2, p0, Landroid/support/v4/widget/SimpleCursorAdapter;->g:[Ljava/lang/String;

    .line 2
    iput-object p3, p0, Landroid/support/v4/widget/SimpleCursorAdapter;->mTo:[I

    .line 3
    iget-object p2, p0, Landroid/support/v4/widget/SimpleCursorAdapter;->g:[Ljava/lang/String;

    invoke-direct {p0, p1, p2}, Landroid/support/v4/widget/SimpleCursorAdapter;->a(Landroid/database/Cursor;[Ljava/lang/String;)V
...
.method public convertToString(Landroid/database/Cursor;)Ljava/lang/CharSequence;
    ...
    .line 1
    iget-object v0, p0, Landroid/support/v4/widget/SimpleCursorAdapter;->e:Landroid/support/v4/widget/SimpleCursorAdapter$CursorToStringConverter;
    ...
    .line 3
    :cond_0
    iget v0, p0, Landroid/support/v4/widget/SimpleCursorAdapter;->d:I
...
.method public getViewBinder()Landroid/support/v4/widget/SimpleCursorAdapter$ViewBinder;
    ...
    .line 1
    iget-object v0, p0, Landroid/support/v4/widget/SimpleCursorAdapter;->f:Landroid/support/v4/widget/SimpleCursorAdapter$ViewBinder;
...
.method public setCursorToStringConverter(Landroid/support/v4/widget/SimpleCursorAdapter$CursorToStringConverter;)V
    ...
    .line 1
    iput-object p1, p0, Landroid/support/v4/widget/SimpleCursorAdapter;->e:Landroid/support/v4/widget/SimpleCursorAdapter$CursorToStringConverter;
...
.method public setViewBinder(Landroid/support/v4/widget/SimpleCursorAdapter$ViewBinder;)V
    ...
    .line 1
    iput-object p1, p0, Landroid/support/v4/widget/SimpleCursorAdapter;->f:Landroid/support/v4/widget/SimpleCursorAdapter$ViewBinder;
...
.method public swapCursor(Landroid/database/Cursor;)Landroid/database/Cursor;
    ...
    .line 1
    iget-object v0, p0, Landroid/support/v4/widget/SimpleCursorAdapter;->g:[Ljava/lang/String;
