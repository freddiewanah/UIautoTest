.class Landroid/support/v4/provider/v;
...
.method constructor <init>(Landroid/support/v4/provider/DocumentFile;Landroid/content/Context;Landroid/net/Uri;)V
    ...
    .line 2
    iput-object p2, p0, Landroid/support/v4/provider/v;->b:Landroid/content/Context;

    .line 3
    iput-object p3, p0, Landroid/support/v4/provider/v;->c:Landroid/net/Uri;
...
.method public canRead()Z
    ...
    .line 1
    iget-object v0, p0, Landroid/support/v4/provider/v;->b:Landroid/content/Context;

    iget-object v1, p0, Landroid/support/v4/provider/v;->c:Landroid/net/Uri;
...
.method public createDirectory(Ljava/lang/String;)Landroid/support/v4/provider/DocumentFile;
    ...
    invoke-static {v0, v1, v2, p1}, Landroid/support/v4/provider/v;->a(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;)Landroid/net/Uri;
    ...
    .line 2
    new-instance v0, Landroid/support/v4/provider/v;

    iget-object v1, p0, Landroid/support/v4/provider/v;->b:Landroid/content/Context;

    invoke-direct {v0, p0, v1, p1}, Landroid/support/v4/provider/v;-><init>(Landroid/support/v4/provider/DocumentFile;Landroid/content/Context;Landroid/net/Uri;)V
...
.method public createFile(Ljava/lang/String;Ljava/lang/String;)Landroid/support/v4/provider/DocumentFile;
    ...
    invoke-static {v0, v1, p1, p2}, Landroid/support/v4/provider/v;->a(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;)Landroid/net/Uri;
    ...
    .line 2
    new-instance p2, Landroid/support/v4/provider/v;

    iget-object v0, p0, Landroid/support/v4/provider/v;->b:Landroid/content/Context;

    invoke-direct {p2, p0, v0, p1}, Landroid/support/v4/provider/v;-><init>(Landroid/support/v4/provider/DocumentFile;Landroid/content/Context;Landroid/net/Uri;)V
...
.method public getUri()Landroid/net/Uri;
    ...
    .line 1
    iget-object v0, p0, Landroid/support/v4/provider/v;->c:Landroid/net/Uri;
...
.method public listFiles()[Landroid/support/v4/provider/DocumentFile;
    ...
    .line 9
    iget-object v2, p0, Landroid/support/v4/provider/v;->c:Landroid/net/Uri;
    ...
    :cond_0
    :goto_1
    invoke-static {v8}, Landroid/support/v4/provider/v;->a(Ljava/lang/AutoCloseable;)V
    ...
    .line 16
    new-instance v2, Landroid/support/v4/provider/v;

    iget-object v3, p0, Landroid/support/v4/provider/v;->b:Landroid/content/Context;

    aget-object v4, v0, v7

    invoke-direct {v2, p0, v3, v4}, Landroid/support/v4/provider/v;-><init>(Landroid/support/v4/provider/DocumentFile;Landroid/content/Context;Landroid/net/Uri;)V
...
.method public renameTo(Ljava/lang/String;)Z
    ...
    .line 4
    iput-object p1, p0, Landroid/support/v4/provider/v;->c:Landroid/net/Uri;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
