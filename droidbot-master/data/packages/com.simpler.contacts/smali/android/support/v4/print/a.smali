.class Landroid/support/v4/print/a;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Landroid/support/v4/print/PrintHelper;->a(Landroid/print/PrintAttributes;ILandroid/graphics/Bitmap;Landroid/os/ParcelFileDescriptor;Landroid/os/CancellationSignal;Landroid/print/PrintDocumentAdapter$WriteResultCallback;)V
.end annotation
...
.method constructor <init>(Landroid/support/v4/print/PrintHelper;Landroid/os/CancellationSignal;Landroid/print/PrintAttributes;Landroid/graphics/Bitmap;Landroid/print/PrintAttributes;ILandroid/os/ParcelFileDescriptor;Landroid/print/PrintDocumentAdapter$WriteResultCallback;)V
    ...
    .line 1
    iput-object p1, p0, Landroid/support/v4/print/a;->h:Landroid/support/v4/print/PrintHelper;

    iput-object p2, p0, Landroid/support/v4/print/a;->a:Landroid/os/CancellationSignal;

    iput-object p3, p0, Landroid/support/v4/print/a;->b:Landroid/print/PrintAttributes;

    iput-object p4, p0, Landroid/support/v4/print/a;->c:Landroid/graphics/Bitmap;

    iput-object p5, p0, Landroid/support/v4/print/a;->d:Landroid/print/PrintAttributes;

    iput p6, p0, Landroid/support/v4/print/a;->e:I

    iput-object p7, p0, Landroid/support/v4/print/a;->f:Landroid/os/ParcelFileDescriptor;

    iput-object p8, p0, Landroid/support/v4/print/a;->g:Landroid/print/PrintDocumentAdapter$WriteResultCallback;
...
.method protected varargs a([Ljava/lang/Void;)Ljava/lang/Throwable;
    ...
    .line 1
    :try_start_0
    iget-object p1, p0, Landroid/support/v4/print/a;->a:Landroid/os/CancellationSignal;
    ...
    iget-object v1, p0, Landroid/support/v4/print/a;->h:Landroid/support/v4/print/PrintHelper;

    iget-object v1, v1, Landroid/support/v4/print/PrintHelper;->c:Landroid/content/Context;

    iget-object v2, p0, Landroid/support/v4/print/a;->b:Landroid/print/PrintAttributes;
    ...
    .line 3
    iget-object v1, p0, Landroid/support/v4/print/a;->c:Landroid/graphics/Bitmap;
    ...
    .line 5
    invoke-static {v1, v2}, Landroid/support/v4/print/PrintHelper;->a(Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;

    move-result-object v1

    .line 6
    iget-object v2, p0, Landroid/support/v4/print/a;->a:Landroid/os/CancellationSignal;
    ...
    .line 8
    sget-boolean v4, Landroid/support/v4/print/PrintHelper;->b:Z
    ...
    iget-object v5, p0, Landroid/support/v4/print/a;->h:Landroid/support/v4/print/PrintHelper;

    iget-object v5, v5, Landroid/support/v4/print/PrintHelper;->c:Landroid/content/Context;

    iget-object v6, p0, Landroid/support/v4/print/a;->d:Landroid/print/PrintAttributes;
    ...
    iget v6, p0, Landroid/support/v4/print/a;->e:I

    .line 16
    invoke-static {v4, v5, v2, v6}, Landroid/support/v4/print/PrintHelper;->a(IILandroid/graphics/RectF;I)Landroid/graphics/Matrix;

    move-result-object v4

    .line 17
    sget-boolean v5, Landroid/support/v4/print/PrintHelper;->b:Z
    ...
    .line 24
    iget-object p1, p0, Landroid/support/v4/print/a;->f:Landroid/os/ParcelFileDescriptor;
    :try_end_2
    ...
    :cond_4
    :try_start_4
    iget-object p1, p0, Landroid/support/v4/print/a;->c:Landroid/graphics/Bitmap;
    ...
    iget-object v3, p0, Landroid/support/v4/print/a;->f:Landroid/os/ParcelFileDescriptor;
...
.method protected a(Ljava/lang/Throwable;)V
    ...
    .line 41
    iget-object v0, p0, Landroid/support/v4/print/a;->a:Landroid/os/CancellationSignal;
    ...
    .line 42
    iget-object p1, p0, Landroid/support/v4/print/a;->g:Landroid/print/PrintDocumentAdapter$WriteResultCallback;
...
.method protected bridge synthetic doInBackground([Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Landroid/support/v4/print/a;->a([Ljava/lang/Void;)Ljava/lang/Throwable;
...
.method protected bridge synthetic onPostExecute(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Landroid/support/v4/print/a;->a(Ljava/lang/Throwable;)V
