...
.method constructor <init>(Landroid/support/v4/app/NotificationCompat$Builder;)V
    ...
    iput-object v0, p0, Landroid/support/v4/app/N;->e:Ljava/util/List;
    ...
    iput-object v0, p0, Landroid/support/v4/app/N;->f:Landroid/os/Bundle;

    .line 4
    iput-object p1, p0, Landroid/support/v4/app/N;->b:Landroid/support/v4/app/NotificationCompat$Builder;
    ...
    iget-object v3, p1, Landroid/support/v4/app/NotificationCompat$Builder;->G:Ljava/lang/String;

    invoke-direct {v0, v2, v3}, Landroid/app/Notification$Builder;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    iput-object v0, p0, Landroid/support/v4/app/N;->a:Landroid/app/Notification$Builder;
    ...
    .line 8
    :goto_0
    iget-object v0, p1, Landroid/support/v4/app/NotificationCompat$Builder;->L:Landroid/app/Notification;

    .line 9
    iget-object v2, p0, Landroid/support/v4/app/N;->a:Landroid/app/Notification$Builder;
    ...
    iget-object v4, p1, Landroid/support/v4/app/NotificationCompat$Builder;->f:Landroid/widget/RemoteViews;
    ...
    iget-object v3, p1, Landroid/support/v4/app/NotificationCompat$Builder;->h:Ljava/lang/CharSequence;
    ...
    iget-object v3, p1, Landroid/support/v4/app/NotificationCompat$Builder;->e:Landroid/app/PendingIntent;
    ...
    iget-object v3, p1, Landroid/support/v4/app/NotificationCompat$Builder;->g:Landroid/graphics/Bitmap;
    ...
    iget v3, p1, Landroid/support/v4/app/NotificationCompat$Builder;->i:I
    ...
    iget v3, p1, Landroid/support/v4/app/NotificationCompat$Builder;->p:I

    iget v7, p1, Landroid/support/v4/app/NotificationCompat$Builder;->q:I

    iget-boolean v8, p1, Landroid/support/v4/app/NotificationCompat$Builder;->r:Z
    ...
    iget-object v6, p1, Landroid/support/v4/app/NotificationCompat$Builder;->n:Ljava/lang/CharSequence;
    ...
    iget-boolean v6, p1, Landroid/support/v4/app/NotificationCompat$Builder;->l:Z
    ...
    iget v6, p1, Landroid/support/v4/app/NotificationCompat$Builder;->j:I
    ...
    .line 35
    invoke-direct {p0, v6}, Landroid/support/v4/app/N;->a(Landroid/support/v4/app/NotificationCompat$Action;)V

    goto :goto_5

    .line 36
    :cond_6
    iget-object v2, p1, Landroid/support/v4/app/NotificationCompat$Builder;->z:Landroid/os/Bundle;

    if-eqz v2, :cond_7

    .line 37
    iget-object v6, p0, Landroid/support/v4/app/N;->f:Landroid/os/Bundle;
    ...
    .line 39
    iget-boolean v2, p1, Landroid/support/v4/app/NotificationCompat$Builder;->v:Z

    if-eqz v2, :cond_8

    .line 40
    iget-object v2, p0, Landroid/support/v4/app/N;->f:Landroid/os/Bundle;
    ...
    .line 41
    :cond_8
    iget-object v2, p1, Landroid/support/v4/app/NotificationCompat$Builder;->s:Ljava/lang/String;
    ...
    .line 43
    iget-boolean v2, p1, Landroid/support/v4/app/NotificationCompat$Builder;->t:Z
    ...
    :cond_a
    :goto_6
    iget-object v2, p1, Landroid/support/v4/app/NotificationCompat$Builder;->u:Ljava/lang/String;

    if-eqz v2, :cond_b

    .line 47
    iget-object v4, p0, Landroid/support/v4/app/N;->f:Landroid/os/Bundle;
    ...
    .line 48
    :cond_b
    iget-object v2, p1, Landroid/support/v4/app/NotificationCompat$Builder;->D:Landroid/widget/RemoteViews;

    iput-object v2, p0, Landroid/support/v4/app/N;->c:Landroid/widget/RemoteViews;

    .line 49
    iget-object v2, p1, Landroid/support/v4/app/NotificationCompat$Builder;->E:Landroid/widget/RemoteViews;

    iput-object v2, p0, Landroid/support/v4/app/N;->d:Landroid/widget/RemoteViews;
    ...
    iget-boolean v4, p1, Landroid/support/v4/app/NotificationCompat$Builder;->k:Z
    ...
    iget-boolean v4, p1, Landroid/support/v4/app/NotificationCompat$Builder;->v:Z

    invoke-virtual {v2, v4}, Landroid/app/Notification$Builder;->setLocalOnly(Z)Landroid/app/Notification$Builder;

    move-result-object v2

    iget-object v4, p1, Landroid/support/v4/app/NotificationCompat$Builder;->s:Ljava/lang/String;
    ...
    iget-boolean v4, p1, Landroid/support/v4/app/NotificationCompat$Builder;->t:Z
    ...
    iget-object v4, p1, Landroid/support/v4/app/NotificationCompat$Builder;->u:Ljava/lang/String;

    .line 61
    invoke-virtual {v2, v4}, Landroid/app/Notification$Builder;->setSortKey(Ljava/lang/String;)Landroid/app/Notification$Builder;

    .line 62
    iget v2, p1, Landroid/support/v4/app/NotificationCompat$Builder;->K:I

    iput v2, p0, Landroid/support/v4/app/N;->g:I
    ...
    iget-object v3, p1, Landroid/support/v4/app/NotificationCompat$Builder;->y:Ljava/lang/String;

    invoke-virtual {v2, v3}, Landroid/app/Notification$Builder;->setCategory(Ljava/lang/String;)Landroid/app/Notification$Builder;

    move-result-object v2

    iget v3, p1, Landroid/support/v4/app/NotificationCompat$Builder;->A:I
    ...
    iget v3, p1, Landroid/support/v4/app/NotificationCompat$Builder;->B:I
    ...
    iget-object v3, p1, Landroid/support/v4/app/NotificationCompat$Builder;->C:Landroid/app/Notification;
    ...
    .line 70
    iget-object v3, p0, Landroid/support/v4/app/N;->a:Landroid/app/Notification$Builder;
    ...
    .line 71
    :cond_f
    iget-object v0, p1, Landroid/support/v4/app/NotificationCompat$Builder;->F:Landroid/widget/RemoteViews;

    iput-object v0, p0, Landroid/support/v4/app/N;->h:Landroid/widget/RemoteViews;

    .line 72
    iget-object v0, p1, Landroid/support/v4/app/NotificationCompat$Builder;->a:Ljava/util/ArrayList;
    ...
    .line 76
    :goto_8
    iget-object v6, p1, Landroid/support/v4/app/NotificationCompat$Builder;->a:Ljava/util/ArrayList;
    ...
    iget-object v7, p1, Landroid/support/v4/app/NotificationCompat$Builder;->a:Ljava/util/ArrayList;
    ...
    .line 79
    invoke-static {v7}, Landroid/support/v4/app/O;->a(Landroid/support/v4/app/NotificationCompat$Action;)Landroid/os/Bundle;
    ...
    .line 83
    iget-object v3, p0, Landroid/support/v4/app/N;->f:Landroid/os/Bundle;
    ...
    .line 85
    iget-object v0, p0, Landroid/support/v4/app/N;->a:Landroid/app/Notification$Builder;
    ...
    iget-object v2, p1, Landroid/support/v4/app/NotificationCompat$Builder;->o:[Ljava/lang/CharSequence;
    ...
    .line 87
    iget-object v0, p1, Landroid/support/v4/app/NotificationCompat$Builder;->D:Landroid/widget/RemoteViews;
    ...
    .line 89
    :cond_13
    iget-object v0, p1, Landroid/support/v4/app/NotificationCompat$Builder;->E:Landroid/widget/RemoteViews;
    ...
    iget v1, p1, Landroid/support/v4/app/NotificationCompat$Builder;->H:I

    invoke-virtual {v0, v1}, Landroid/app/Notification$Builder;->setBadgeIconType(I)Landroid/app/Notification$Builder;

    move-result-object v0

    iget-object v1, p1, Landroid/support/v4/app/NotificationCompat$Builder;->I:Ljava/lang/String;
    ...
    iget-wide v1, p1, Landroid/support/v4/app/NotificationCompat$Builder;->J:J
    ...
    iget v1, p1, Landroid/support/v4/app/NotificationCompat$Builder;->K:I

    .line 97
    invoke-virtual {v0, v1}, Landroid/app/Notification$Builder;->setGroupAlertBehavior(I)Landroid/app/Notification$Builder;

    .line 98
    iget-boolean v0, p1, Landroid/support/v4/app/NotificationCompat$Builder;->x:Z
    ...
    iget-boolean v1, p1, Landroid/support/v4/app/NotificationCompat$Builder;->w:Z

    invoke-virtual {v0, v1}, Landroid/app/Notification$Builder;->setColorized(Z)Landroid/app/Notification$Builder;

    .line 100
    :cond_16
    iget-object p1, p1, Landroid/support/v4/app/NotificationCompat$Builder;->G:Ljava/lang/String;
    ...
    .line 101
    iget-object p1, p0, Landroid/support/v4/app/N;->a:Landroid/app/Notification$Builder;
...
.method private a(Landroid/support/v4/app/NotificationCompat$Action;)V
    .locals 5
    ...
    .line 40
    iget-object v0, p0, Landroid/support/v4/app/N;->e:Ljava/util/List;

    iget-object v1, p0, Landroid/support/v4/app/N;->a:Landroid/app/Notification$Builder;

    .line 41
    invoke-static {v1, p1}, Landroid/support/v4/app/O;->a(Landroid/app/Notification$Builder;Landroid/support/v4/app/NotificationCompat$Action;)Landroid/os/Bundle;
...
.method public a()Landroid/app/Notification;
    ...
    .line 1
    iget-object v0, p0, Landroid/support/v4/app/N;->b:Landroid/support/v4/app/NotificationCompat$Builder;
    ...
    .line 4
    :goto_0
    invoke-virtual {p0}, Landroid/support/v4/app/N;->b()Landroid/app/Notification;
    ...
    .line 6
    :cond_2
    iget-object v1, p0, Landroid/support/v4/app/N;->b:Landroid/support/v4/app/NotificationCompat$Builder;

    iget-object v1, v1, Landroid/support/v4/app/NotificationCompat$Builder;->D:Landroid/widget/RemoteViews;
    ...
    iget-object v1, v1, Landroid/support/v4/app/NotificationCompat$Builder;->m:Landroid/support/v4/app/NotificationCompat$Style;
...
.method protected b()Landroid/app/Notification;
    ...
    .line 4
    iget v1, p0, Landroid/support/v4/app/N;->g:I
    ...
    .line 6
    invoke-direct {p0, v0}, Landroid/support/v4/app/N;->a(Landroid/app/Notification;)V
    ...
    iget-object v1, p0, Landroid/support/v4/app/N;->f:Landroid/os/Bundle;
    ...
    .line 11
    iget-object v1, p0, Landroid/support/v4/app/N;->c:Landroid/widget/RemoteViews;
    ...
    .line 13
    :cond_4
    iget-object v1, p0, Landroid/support/v4/app/N;->d:Landroid/widget/RemoteViews;
    ...
    .line 15
    :cond_5
    iget-object v1, p0, Landroid/support/v4/app/N;->h:Landroid/widget/RemoteViews;
    ...
    .line 34
    invoke-static {v0}, Landroid/support/v4/app/O;->a(Ljava/util/List;)Landroid/util/SparseArray;
    ...
    .line 49
    iget-object v1, p0, Landroid/support/v4/app/N;->e:Ljava/util/List;

    .line 50
    invoke-static {v1}, Landroid/support/v4/app/O;->a(Ljava/util/List;)Landroid/util/SparseArray;
