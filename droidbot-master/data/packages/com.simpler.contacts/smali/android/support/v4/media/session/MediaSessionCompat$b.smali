...
.method a(Landroid/app/PendingIntent;Landroid/content/ComponentName;)V
    ...
    .line 6
    sget-boolean v0, Landroid/support/v4/media/session/MediaSessionCompat$b;->H:Z
    ...
    .line 9
    sput-boolean v0, Landroid/support/v4/media/session/MediaSessionCompat$b;->H:Z
...
.method public a(Landroid/support/v4/media/session/MediaSessionCompat$Callback;Landroid/os/Handler;)V
    ...
    .line 1
    invoke-super {p0, p1, p2}, Landroid/support/v4/media/session/MediaSessionCompat$f;->a(Landroid/support/v4/media/session/MediaSessionCompat$Callback;Landroid/os/Handler;)V
    ...
    invoke-direct {p1, p0}, Landroid/support/v4/media/session/d;-><init>(Landroid/support/v4/media/session/MediaSessionCompat$b;)V
...
.method b(Landroid/app/PendingIntent;Landroid/content/ComponentName;)V
    ...
    .line 8
    iget-object p2, p0, Landroid/support/v4/media/session/MediaSessionCompat$f;->h:Landroid/media/AudioManager;
...
.method b(Landroid/support/v4/media/session/PlaybackStateCompat;)V
    ...
    .line 6
    :cond_1
    iget-object v3, p0, Landroid/support/v4/media/session/MediaSessionCompat$f;->i:Landroid/media/RemoteControlClient;
