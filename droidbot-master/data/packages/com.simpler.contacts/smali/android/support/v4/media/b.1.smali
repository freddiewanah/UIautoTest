...
# instance fields
.field b:Landroid/media/AudioAttributes;
...
.method constructor <init>()V
    ...
    .line 2
    iput v0, p0, Landroid/support/v4/media/b;->c:I
...
.method constructor <init>(Landroid/media/AudioAttributes;)V
    ...
    .line 3
    invoke-direct {p0, p1, v0}, Landroid/support/v4/media/b;-><init>(Landroid/media/AudioAttributes;I)V
...
.method constructor <init>(Landroid/media/AudioAttributes;I)V
    ...
    .line 6
    iput-object p1, p0, Landroid/support/v4/media/b;->b:Landroid/media/AudioAttributes;

    .line 7
    iput p2, p0, Landroid/support/v4/media/b;->c:I
...
.method public static a(Landroid/os/Bundle;)Landroid/support/v4/media/a;
    ...
    invoke-direct {v0, v1, p0}, Landroid/support/v4/media/b;-><init>(Landroid/media/AudioAttributes;I)V
...
.method static c()Ljava/lang/reflect/Method;
    ...
    .line 1
    :try_start_0
    sget-object v0, Landroid/support/v4/media/b;->a:Ljava/lang/reflect/Method;
    ...
    sput-object v0, Landroid/support/v4/media/b;->a:Ljava/lang/reflect/Method;
    :try_end_0
...
.method public a()I
    ...
    .line 1
    iget v0, p0, Landroid/support/v4/media/b;->c:I
...
.method public equals(Ljava/lang/Object;)Z
    ...
    .line 1
    instance-of v0, p1, Landroid/support/v4/media/b;
    ...
    iget-object p1, p1, Landroid/support/v4/media/b;->b:Landroid/media/AudioAttributes;
...
.method public getLegacyStreamType()I
    ...
    .line 2
    :cond_0
    invoke-static {}, Landroid/support/v4/media/b;->c()Ljava/lang/reflect/Method;
    ...
    iget-object v6, p0, Landroid/support/v4/media/b;->b:Landroid/media/AudioAttributes;
...
.method public getVolumeControlStream()I
    ...
    .line 3
    invoke-virtual {p0}, Landroid/support/v4/media/b;->getFlags()I

    move-result v1

    invoke-virtual {p0}, Landroid/support/v4/media/b;->getUsage()I
...
.method public toBundle()Landroid/os/Bundle;
    ...
    .line 2
    iget-object v1, p0, Landroid/support/v4/media/b;->b:Landroid/media/AudioAttributes;
    ...
    .line 3
    iget v1, p0, Landroid/support/v4/media/b;->c:I
