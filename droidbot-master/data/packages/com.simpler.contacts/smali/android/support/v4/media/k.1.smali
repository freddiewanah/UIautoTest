...
.method constructor <init>(Landroid/support/v4/media/MediaBrowserCompat$f;)V
    ...
    .line 1
    iput-object p1, p0, Landroid/support/v4/media/k;->a:Landroid/support/v4/media/MediaBrowserCompat$f;
...
.method public run()V
    ...
    .line 1
    iget-object v1, p0, Landroid/support/v4/media/k;->a:Landroid/support/v4/media/MediaBrowserCompat$f;
    ...
    iget-object v2, p0, Landroid/support/v4/media/k;->a:Landroid/support/v4/media/MediaBrowserCompat$f;

    iget-object v2, v2, Landroid/support/v4/media/MediaBrowserCompat$f;->h:Landroid/support/v4/media/MediaBrowserCompat$f$a;
    ...
    new-instance v3, Landroid/support/v4/media/MediaBrowserCompat$f$a;

    invoke-direct {v3, v2}, Landroid/support/v4/media/MediaBrowserCompat$f$a;-><init>(Landroid/support/v4/media/MediaBrowserCompat$f;)V

    iput-object v3, v2, Landroid/support/v4/media/MediaBrowserCompat$f;->h:Landroid/support/v4/media/MediaBrowserCompat$f$a;

    const/4 v2, 0x0

    .line 11
    :try_start_0
    iget-object v3, p0, Landroid/support/v4/media/k;->a:Landroid/support/v4/media/MediaBrowserCompat$f;

    iget-object v3, v3, Landroid/support/v4/media/MediaBrowserCompat$f;->a:Landroid/content/Context;

    iget-object v4, p0, Landroid/support/v4/media/k;->a:Landroid/support/v4/media/MediaBrowserCompat$f;

    iget-object v4, v4, Landroid/support/v4/media/MediaBrowserCompat$f;->h:Landroid/support/v4/media/MediaBrowserCompat$f$a;
    ...
    .line 17
    iget-object v0, p0, Landroid/support/v4/media/k;->a:Landroid/support/v4/media/MediaBrowserCompat$f;
