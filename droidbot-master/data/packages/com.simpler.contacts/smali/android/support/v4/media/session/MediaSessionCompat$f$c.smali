...
.method private a(Landroid/view/KeyEvent;Landroid/support/v4/media/session/MediaSessionCompat$Callback;)V
    ...
    iget-object v0, v0, Landroid/support/v4/media/session/MediaSessionCompat$f;->u:Landroid/support/v4/media/session/PlaybackStateCompat;
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    iget-object v0, v0, Landroid/support/v4/media/session/MediaSessionCompat$f;->q:Landroid/support/v4/media/session/MediaSessionCompat$Callback;
    ...
    .line 6
    invoke-virtual {v2, v3}, Landroid/support/v4/media/session/MediaSessionCompat$f;->a(Landroid/support/v4/media/MediaSessionManager$RemoteUserInfo;)V
    ...
    iget-object v3, p0, Landroid/support/v4/media/session/MediaSessionCompat$f$c;->a:Landroid/support/v4/media/session/MediaSessionCompat$f;

    iget-object v3, v3, Landroid/support/v4/media/session/MediaSessionCompat$f;->w:Ljava/util/List;
    ...
    invoke-virtual {v0, p1, v4}, Landroid/support/v4/media/session/MediaSessionCompat$f;->b(II)V
    ...
    .line 26
    invoke-direct {p0, p1, v0}, Landroid/support/v4/media/session/MediaSessionCompat$f$c;->a(Landroid/view/KeyEvent;Landroid/support/v4/media/session/MediaSessionCompat$Callback;)V
    ...
    invoke-virtual {v0, p1, v4}, Landroid/support/v4/media/session/MediaSessionCompat$f;->a(II)V
    ...
    iget-object v3, p1, Landroid/support/v4/media/session/MediaSessionCompat$f$a;->b:Landroid/os/Bundle;
    ...
    :cond_2
    :goto_1
    iget-object p1, p0, Landroid/support/v4/media/session/MediaSessionCompat$f$c;->a:Landroid/support/v4/media/session/MediaSessionCompat$f;

    invoke-virtual {p1, v2}, Landroid/support/v4/media/session/MediaSessionCompat$f;->a(Landroid/support/v4/media/MediaSessionManager$RemoteUserInfo;)V
    ...
    invoke-virtual {v0, v2}, Landroid/support/v4/media/session/MediaSessionCompat$f;->a(Landroid/support/v4/media/MediaSessionManager$RemoteUserInfo;)V
