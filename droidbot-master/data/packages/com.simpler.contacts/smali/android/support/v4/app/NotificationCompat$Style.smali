...
.method public constructor <init>()V
    ...
    .line 2
    iput-boolean v0, p0, Landroid/support/v4/app/NotificationCompat$Style;->c:Z
...
.method private a()I
    ...
    .line 24
    invoke-static {v0, v3, v4}, Landroid/support/v4/app/NotificationCompat$Style;->a(FFF)F
...
.method private a(IIII)Landroid/graphics/Bitmap;
    ...
    :cond_0
    invoke-direct {p0, v0, p4, p2}, Landroid/support/v4/app/NotificationCompat$Style;->a(III)Landroid/graphics/Bitmap;
...
.method public applyStandardTemplate(ZIZ)Landroid/widget/RemoteViews;
    ...
    iget-object v2, p2, Landroid/support/v4/app/NotificationCompat$Builder;->g:Landroid/graphics/Bitmap;
    ...
    iget-object v2, v2, Landroid/support/v4/app/NotificationCompat$Builder;->g:Landroid/graphics/Bitmap;
    ...
    iget-object p1, p1, Landroid/support/v4/app/NotificationCompat$Builder;->L:Landroid/app/Notification;
    ...
    iget-object v2, v1, Landroid/support/v4/app/NotificationCompat$Builder;->L:Landroid/app/Notification;
    ...
    .line 20
    invoke-direct {p0, v2, p1, p2, v1}, Landroid/support/v4/app/NotificationCompat$Style;->a(IIII)Landroid/graphics/Bitmap;
    ...
    iget-object p2, p2, Landroid/support/v4/app/NotificationCompat$Builder;->L:Landroid/app/Notification;
    ...
    .line 24
    iget-object p1, p2, Landroid/support/v4/app/NotificationCompat$Builder;->L:Landroid/app/Notification;
    ...
    iget-object p1, p1, Landroid/support/v4/app/NotificationCompat$Builder;->b:Ljava/lang/CharSequence;
    ...
    iget-object p1, p1, Landroid/support/v4/app/NotificationCompat$Builder;->c:Ljava/lang/CharSequence;
    ...
    iget-object p2, p2, Landroid/support/v4/app/NotificationCompat$Builder;->g:Landroid/graphics/Bitmap;
    ...
    iget-object v2, v1, Landroid/support/v4/app/NotificationCompat$Builder;->h:Ljava/lang/CharSequence;
    ...
    .line 43
    :cond_b
    iget v1, v1, Landroid/support/v4/app/NotificationCompat$Builder;->i:I
    ...
    iget p2, p2, Landroid/support/v4/app/NotificationCompat$Builder;->i:I
    ...
    iget-object v1, v1, Landroid/support/v4/app/NotificationCompat$Builder;->n:Ljava/lang/CharSequence;
    ...
    iget-object v1, v1, Landroid/support/v4/app/NotificationCompat$Builder;->c:Ljava/lang/CharSequence;
    ...
    iget-boolean p2, p2, Landroid/support/v4/app/NotificationCompat$Builder;->l:Z
...
.method public buildIntoRemoteViews(Landroid/widget/RemoteViews;Landroid/widget/RemoteViews;)V
    ...
    .line 1
    invoke-direct {p0, p1}, Landroid/support/v4/app/NotificationCompat$Style;->a(Landroid/widget/RemoteViews;)V
    ...
    .line 7
    invoke-direct {p0}, Landroid/support/v4/app/NotificationCompat$Style;->a()I
...
.method public createColoredBitmap(II)Landroid/graphics/Bitmap;
    ...
    .line 1
    invoke-direct {p0, p1, p2, v0}, Landroid/support/v4/app/NotificationCompat$Style;->a(III)Landroid/graphics/Bitmap;
