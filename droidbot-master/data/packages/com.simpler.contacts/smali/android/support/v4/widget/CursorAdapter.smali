...
.field protected mCursorFilter:Landroid/support/v4/widget/f;
    .annotation build Landroid/support/annotation/RestrictTo;
        value = {
            .enum Landroid/support/annotation/RestrictTo$Scope;->LIBRARY_GROUP:Landroid/support/annotation/RestrictTo$Scope;
        }
...
.method a(Landroid/content/Context;Landroid/database/Cursor;I)V
    ...
    .line 7
    new-instance p1, Landroid/support/v4/widget/CursorAdapter$a;

    invoke-direct {p1, p0}, Landroid/support/v4/widget/CursorAdapter$a;-><init>(Landroid/support/v4/widget/CursorAdapter;)V

    iput-object p1, p0, Landroid/support/v4/widget/CursorAdapter;->mChangeObserver:Landroid/support/v4/widget/CursorAdapter$a;

    .line 8
    new-instance p1, Landroid/support/v4/widget/CursorAdapter$b;

    invoke-direct {p1, p0}, Landroid/support/v4/widget/CursorAdapter$b;-><init>(Landroid/support/v4/widget/CursorAdapter;)V
    ...
    .line 11
    iget-object p1, p0, Landroid/support/v4/widget/CursorAdapter;->mChangeObserver:Landroid/support/v4/widget/CursorAdapter$a;
...
.method public getFilter()Landroid/widget/Filter;
    ...
    .line 1
    iget-object v0, p0, Landroid/support/v4/widget/CursorAdapter;->mCursorFilter:Landroid/support/v4/widget/f;
    ...
    iput-object v0, p0, Landroid/support/v4/widget/CursorAdapter;->mCursorFilter:Landroid/support/v4/widget/f;
