...
.field private c:Landroid/support/v4/media/session/MediaSessionCompat$Callback$a;
...
.method public constructor <init>()V
    ...
    .line 2
    iput-object v0, p0, Landroid/support/v4/media/session/MediaSessionCompat$Callback;->c:Landroid/support/v4/media/session/MediaSessionCompat$Callback$a;
...
# virtual methods
.method a(Landroid/support/v4/media/MediaSessionManager$RemoteUserInfo;)V
    .locals 11
    ...
    .line 7
    iget-object v1, p0, Landroid/support/v4/media/session/MediaSessionCompat$Callback;->c:Landroid/support/v4/media/session/MediaSessionCompat$Callback$a;
    ...
    .line 9
    :cond_1
    invoke-interface {v1}, Landroid/support/v4/media/session/MediaSessionCompat$a;->getPlaybackState()Landroid/support/v4/media/session/PlaybackStateCompat;
    ...
    .line 12
    :cond_5
    invoke-interface {v1, p1}, Landroid/support/v4/media/session/MediaSessionCompat$a;->a(Landroid/support/v4/media/MediaSessionManager$RemoteUserInfo;)V
...
.method a(Landroid/support/v4/media/session/MediaSessionCompat$a;Landroid/os/Handler;)V
    .locals 1
    ...
    .line 2
    iget-object p1, p0, Landroid/support/v4/media/session/MediaSessionCompat$Callback;->c:Landroid/support/v4/media/session/MediaSessionCompat$Callback$a;
    ...
    iput-object p1, p0, Landroid/support/v4/media/session/MediaSessionCompat$Callback;->c:Landroid/support/v4/media/session/MediaSessionCompat$Callback$a;
...
.method public onMediaButtonEvent(Landroid/content/Intent;)Z
    ...
    check-cast v0, Landroid/support/v4/media/session/MediaSessionCompat$a;

    if-eqz v0, :cond_8

    .line 3
    iget-object v2, p0, Landroid/support/v4/media/session/MediaSessionCompat$Callback;->c:Landroid/support/v4/media/session/MediaSessionCompat$Callback$a;
    ...
    .line 8
    invoke-virtual {p0, v2}, Landroid/support/v4/media/session/MediaSessionCompat$Callback;->a(Landroid/support/v4/media/MediaSessionManager$RemoteUserInfo;)V
    ...
    .line 13
    iput-boolean v1, p0, Landroid/support/v4/media/session/MediaSessionCompat$Callback;->d:Z

    .line 14
    invoke-interface {v0}, Landroid/support/v4/media/session/MediaSessionCompat$a;->getPlaybackState()Landroid/support/v4/media/session/PlaybackStateCompat;
