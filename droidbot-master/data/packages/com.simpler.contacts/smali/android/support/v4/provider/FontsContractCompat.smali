...
.field private static final b:Landroid/support/v4/provider/SelfDestructiveThread;

.field static final c:Ljava/lang/Object;

.field static final d:Landroid/support/v4/util/SimpleArrayMap;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/provider/FontsContractCompat;->a:Landroid/support/v4/util/LruCache;
    ...
    sput-object v0, Landroid/support/v4/provider/FontsContractCompat;->b:Landroid/support/v4/provider/SelfDestructiveThread;
    ...
    sput-object v0, Landroid/support/v4/provider/FontsContractCompat;->d:Landroid/support/v4/util/SimpleArrayMap;

    .line 5
    new-instance v0, Landroid/support/v4/provider/o;

    invoke-direct {v0}, Landroid/support/v4/provider/o;-><init>()V
...
.method static a(Landroid/content/Context;Landroid/support/v4/provider/FontRequest;I)Landroid/support/v4/provider/FontsContractCompat$a;
    .locals 3
    ...
    .line 5
    new-instance p1, Landroid/support/v4/provider/FontsContractCompat$a;
    ...
    :cond_0
    invoke-direct {p1, p0, v2}, Landroid/support/v4/provider/FontsContractCompat$a;-><init>(Landroid/graphics/Typeface;I)V
    ...
    .line 7
    :cond_2
    new-instance p0, Landroid/support/v4/provider/FontsContractCompat$a;

    invoke-direct {p0, v0, v2}, Landroid/support/v4/provider/FontsContractCompat$a;-><init>(Landroid/graphics/Typeface;I)V
    ...
    invoke-direct {p0, v0, p1}, Landroid/support/v4/provider/FontsContractCompat$a;-><init>(Landroid/graphics/Typeface;I)V

    return-object p0
.end method

.method private static a(Landroid/support/v4/provider/FontRequest;Landroid/content/res/Resources;)Ljava/util/List;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method static a(Landroid/content/Context;Landroid/support/v4/provider/FontRequest;Ljava/lang/String;Landroid/os/CancellationSignal;)[Landroid/support/v4/provider/FontsContractCompat$FontInfo;
    .locals 20
    .annotation build Landroid/support/annotation/NonNull;
    .end annotation
...
.method public static fetchFonts(Landroid/content/Context;Landroid/os/CancellationSignal;Landroid/support/v4/provider/FontRequest;)Landroid/support/v4/provider/FontsContractCompat$FontFamilyResult;
    ...
    invoke-static {p0, p2, v0, p1}, Landroid/support/v4/provider/FontsContractCompat;->a(Landroid/content/Context;Landroid/support/v4/provider/FontRequest;Ljava/lang/String;Landroid/os/CancellationSignal;)[Landroid/support/v4/provider/FontsContractCompat$FontInfo;
...
.method public static getFontSync(Landroid/content/Context;Landroid/support/v4/provider/FontRequest;Landroid/support/v4/content/res/ResourcesCompat$FontCallback;Landroid/os/Handler;ZII)Landroid/graphics/Typeface;
    ...
    .line 2
    sget-object v1, Landroid/support/v4/provider/FontsContractCompat;->a:Landroid/support/v4/util/LruCache;
    ...
    .line 4
    invoke-static {p0, p1, p6}, Landroid/support/v4/provider/FontsContractCompat;->a(Landroid/content/Context;Landroid/support/v4/provider/FontRequest;I)Landroid/support/v4/provider/FontsContractCompat$a;
    ...
    .line 5
    iget p1, p0, Landroid/support/v4/provider/FontsContractCompat$a;->b:I

    if-nez p1, :cond_2

    .line 6
    iget-object p1, p0, Landroid/support/v4/provider/FontsContractCompat$a;->a:Landroid/graphics/Typeface;
    ...
    :cond_3
    :goto_0
    iget-object p0, p0, Landroid/support/v4/provider/FontsContractCompat$a;->a:Landroid/graphics/Typeface;

    return-object p0

    .line 9
    :cond_4
    new-instance v1, Landroid/support/v4/provider/b;

    invoke-direct {v1, p0, p1, p6, v0}, Landroid/support/v4/provider/b;-><init>(Landroid/content/Context;Landroid/support/v4/provider/FontRequest;ILjava/lang/String;)V
    ...
    .line 10
    :try_start_0
    sget-object p1, Landroid/support/v4/provider/FontsContractCompat;->b:Landroid/support/v4/provider/SelfDestructiveThread;
    ...
    iget-object p0, p1, Landroid/support/v4/provider/FontsContractCompat$a;->a:Landroid/graphics/Typeface;
    :try_end_0
    ...
    .line 11
    :cond_6
    new-instance p1, Landroid/support/v4/provider/c;

    invoke-direct {p1, p2, p3}, Landroid/support/v4/provider/c;-><init>(Landroid/support/v4/content/res/ResourcesCompat$FontCallback;Landroid/os/Handler;)V

    .line 12
    :goto_1
    sget-object p2, Landroid/support/v4/provider/FontsContractCompat;->c:Ljava/lang/Object;

    monitor-enter p2

    .line 13
    :try_start_1
    sget-object p3, Landroid/support/v4/provider/FontsContractCompat;->d:Landroid/support/v4/util/SimpleArrayMap;
    ...
    .line 18
    sget-object p1, Landroid/support/v4/provider/FontsContractCompat;->d:Landroid/support/v4/util/SimpleArrayMap;
    ...
    new-instance p2, Landroid/support/v4/provider/d;

    invoke-direct {p2, v0}, Landroid/support/v4/provider/d;-><init>(Ljava/lang/String;)V
...
.method public static getProvider(Landroid/content/pm/PackageManager;Landroid/support/v4/provider/FontRequest;Landroid/content/res/Resources;)Landroid/content/pm/ProviderInfo;
    ...
    invoke-static {p0}, Landroid/support/v4/provider/FontsContractCompat;->a([Landroid/content/pm/Signature;)Ljava/util/List;

    move-result-object p0

    .line 6
    sget-object v0, Landroid/support/v4/provider/FontsContractCompat;->e:Ljava/util/Comparator;

    invoke-static {p0, v0}, Ljava/util/Collections;->sort(Ljava/util/List;Ljava/util/Comparator;)V

    .line 7
    invoke-static {p1, p2}, Landroid/support/v4/provider/FontsContractCompat;->a(Landroid/support/v4/provider/FontRequest;Landroid/content/res/Resources;)Ljava/util/List;
    ...
    .line 11
    invoke-static {p0, p2}, Landroid/support/v4/provider/FontsContractCompat;->a(Ljava/util/List;Ljava/util/List;)Z
...
.method public static requestFont(Landroid/content/Context;Landroid/support/v4/provider/FontRequest;Landroid/support/v4/provider/FontsContractCompat$FontRequestCallback;Landroid/os/Handler;)V
    ...
    .line 2
    new-instance v1, Landroid/support/v4/provider/n;

    invoke-direct {v1, p0, p1, v0, p2}, Landroid/support/v4/provider/n;-><init>(Landroid/content/Context;Landroid/support/v4/provider/FontRequest;Landroid/os/Handler;Landroid/support/v4/provider/FontsContractCompat$FontRequestCallback;)V
...
.method public static resetCache()V
    ...
    .line 1
    sget-object v0, Landroid/support/v4/provider/FontsContractCompat;->a:Landroid/support/v4/util/LruCache;
