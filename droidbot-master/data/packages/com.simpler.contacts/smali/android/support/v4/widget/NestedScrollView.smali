...
.field private B:Landroid/support/v4/widget/NestedScrollView$OnScrollChangeListener;
...
.field private x:Landroid/support/v4/widget/NestedScrollView$b;
...
.method private b(III)Z
    ...
    .line 4
    :goto_1
    invoke-direct {p0, p2}, Landroid/support/v4/widget/NestedScrollView;->a(I)V
...
.method private e()V
    ...
    iput-object v0, p0, Landroid/support/v4/widget/NestedScrollView;->e:Landroid/widget/OverScroller;
...
.method public arrowScroll(I)Z
    ...
    .line 8
    invoke-direct {p0, v2}, Landroid/support/v4/widget/NestedScrollView;->a(I)V
...
.method public fullScroll(I)Z
    ...
    invoke-direct {p0, p1, v1, v0}, Landroid/support/v4/widget/NestedScrollView;->b(III)Z
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-direct {p0, v4, v0}, Landroid/support/v4/widget/NestedScrollView;->a(II)Z
...
.method protected onLayout(ZIIII)V
    ...
    .line 7
    iget-object p4, p0, Landroid/support/v4/widget/NestedScrollView;->x:Landroid/support/v4/widget/NestedScrollView$b;
    ...
    iget-object v0, p0, Landroid/support/v4/widget/NestedScrollView;->x:Landroid/support/v4/widget/NestedScrollView$b;
    ...
    .line 9
    iput-object p2, p0, Landroid/support/v4/widget/NestedScrollView;->x:Landroid/support/v4/widget/NestedScrollView$b;
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    .line 1
    instance-of v0, p1, Landroid/support/v4/widget/NestedScrollView$b;
    ...
    .line 3
    :cond_0
    check-cast p1, Landroid/support/v4/widget/NestedScrollView$b;
    ...
    .line 5
    iput-object p1, p0, Landroid/support/v4/widget/NestedScrollView;->x:Landroid/support/v4/widget/NestedScrollView$b;
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    .line 2
    new-instance v1, Landroid/support/v4/widget/NestedScrollView$b;

    invoke-direct {v1, v0}, Landroid/support/v4/widget/NestedScrollView$b;-><init>(Landroid/os/Parcelable;)V
    ...
    iput v0, v1, Landroid/support/v4/widget/NestedScrollView$b;->a:I
...
.method protected onScrollChanged(IIII)V
    ...
    .line 2
    iget-object v0, p0, Landroid/support/v4/widget/NestedScrollView;->B:Landroid/support/v4/widget/NestedScrollView$OnScrollChangeListener;
...
.method protected onSizeChanged(IIII)V
    ...
    .line 7
    invoke-direct {p0, p1}, Landroid/support/v4/widget/NestedScrollView;->a(I)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 29
    :cond_8
    iput-boolean v15, v10, Landroid/support/v4/widget/NestedScrollView;->l:Z
    ...
    iput v6, v10, Landroid/support/v4/widget/NestedScrollView;->h:I
    ...
    .line 64
    invoke-direct {v10, v0}, Landroid/support/v4/widget/NestedScrollView;->b(I)V
...
.method public setOnScrollChangeListener(Landroid/support/v4/widget/NestedScrollView$OnScrollChangeListener;)V
    ...
    .line 1
    iput-object p1, p0, Landroid/support/v4/widget/NestedScrollView;->B:Landroid/support/v4/widget/NestedScrollView$OnScrollChangeListener;
