...
.field c:Landroid/graphics/PorterDuff$Mode;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroid/support/v4/graphics/drawable/IconCompat;->c:Landroid/graphics/PorterDuff$Mode;
...
.method private a(Landroid/content/Context;)Landroid/graphics/drawable/Drawable;
    ...
    .line 3
    invoke-static {v1, v2}, Landroid/support/v4/graphics/drawable/IconCompat;->a(Landroid/graphics/Bitmap;Z)Landroid/graphics/Bitmap;
    ...
    iget-object v4, p0, Landroid/support/v4/graphics/drawable/IconCompat;->b:Ljava/lang/Object;
    ...
    .line 19
    :cond_6
    invoke-static {p1, v0}, Landroid/support/v4/graphics/drawable/IconCompat;->a(Landroid/content/Context;Ljava/lang/String;)Landroid/content/res/Resources;
...
.method public static createFromBundle(Landroid/os/Bundle;)Landroid/support/v4/graphics/drawable/IconCompat;
    ...
    iput-object v2, v1, Landroid/support/v4/graphics/drawable/IconCompat;->c:Landroid/graphics/PorterDuff$Mode;
    ...
    iput-object p0, v1, Landroid/support/v4/graphics/drawable/IconCompat;->b:Ljava/lang/Object;
...
.method public static createFromIcon(Landroid/content/Context;Landroid/graphics/drawable/Icon;)Landroid/support/v4/graphics/drawable/IconCompat;
    ...
    .line 2
    invoke-static {p1}, Landroid/support/v4/graphics/drawable/IconCompat;->c(Landroid/graphics/drawable/Icon;)I
    ...
    .line 4
    iput-object p1, p0, Landroid/support/v4/graphics/drawable/IconCompat;->b:Ljava/lang/Object;

    return-object p0

    .line 5
    :cond_0
    invoke-static {p1}, Landroid/support/v4/graphics/drawable/IconCompat;->d(Landroid/graphics/drawable/Icon;)Landroid/net/Uri;
    ...
    .line 6
    :cond_1
    invoke-static {p1}, Landroid/support/v4/graphics/drawable/IconCompat;->b(Landroid/graphics/drawable/Icon;)Ljava/lang/String;

    move-result-object v0

    .line 7
    :try_start_0
    invoke-static {p0, v0}, Landroid/support/v4/graphics/drawable/IconCompat;->a(Landroid/content/Context;Ljava/lang/String;)Landroid/content/res/Resources;

    move-result-object p0

    .line 8
    invoke-static {p1}, Landroid/support/v4/graphics/drawable/IconCompat;->a(Landroid/graphics/drawable/Icon;)I
...
.method public static createFromIcon(Landroid/graphics/drawable/Icon;)Landroid/support/v4/graphics/drawable/IconCompat;
    ...
    .line 12
    invoke-static {p0}, Landroid/support/v4/graphics/drawable/IconCompat;->c(Landroid/graphics/drawable/Icon;)I
    ...
    .line 15
    :cond_0
    invoke-static {p0}, Landroid/support/v4/graphics/drawable/IconCompat;->d(Landroid/graphics/drawable/Icon;)Landroid/net/Uri;
    ...
    .line 16
    invoke-static {p0}, Landroid/support/v4/graphics/drawable/IconCompat;->b(Landroid/graphics/drawable/Icon;)Ljava/lang/String;

    move-result-object v1

    invoke-static {p0}, Landroid/support/v4/graphics/drawable/IconCompat;->a(Landroid/graphics/drawable/Icon;)I
...
.method public static createWithResource(Landroid/content/res/Resources;Ljava/lang/String;I)Landroid/support/v4/graphics/drawable/IconCompat;
    ...
    .line 7
    :cond_0
    iput-object p1, v0, Landroid/support/v4/graphics/drawable/IconCompat;->b:Ljava/lang/Object;
...
.method public addToShortcutIntent(Landroid/content/Intent;Landroid/graphics/drawable/Drawable;Landroid/content/Context;)V
    ...
    .line 3
    iget-object p3, p0, Landroid/support/v4/graphics/drawable/IconCompat;->b:Ljava/lang/Object;

    check-cast p3, Landroid/graphics/Bitmap;

    invoke-static {p3, v1}, Landroid/support/v4/graphics/drawable/IconCompat;->a(Landroid/graphics/Bitmap;Z)Landroid/graphics/Bitmap;
...
.method public getType()I
    ...
    invoke-static {v0}, Landroid/support/v4/graphics/drawable/IconCompat;->c(Landroid/graphics/drawable/Icon;)I
...
.method public getUri()Landroid/net/Uri;
    ...
    invoke-static {v0}, Landroid/support/v4/graphics/drawable/IconCompat;->d(Landroid/graphics/drawable/Icon;)Landroid/net/Uri;
...
.method public loadDrawable(Landroid/content/Context;)Landroid/graphics/drawable/Drawable;
    ...
    .line 4
    :cond_0
    invoke-direct {p0, p1}, Landroid/support/v4/graphics/drawable/IconCompat;->a(Landroid/content/Context;)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Landroid/support/v4/graphics/drawable/IconCompat;->c:Landroid/graphics/PorterDuff$Mode;
...
.method public setTintMode(Landroid/graphics/PorterDuff$Mode;)Landroid/support/v4/graphics/drawable/IconCompat;
    ...
    .line 1
    iput-object p1, p0, Landroid/support/v4/graphics/drawable/IconCompat;->c:Landroid/graphics/PorterDuff$Mode;
...
.method public toBundle()Landroid/os/Bundle;
    ...
    .line 13
    :cond_5
    iget-object v1, p0, Landroid/support/v4/graphics/drawable/IconCompat;->c:Landroid/graphics/PorterDuff$Mode;
...
.method public toIcon()Landroid/graphics/drawable/Icon;
    ...
    .line 5
    invoke-static {v0, v1}, Landroid/support/v4/graphics/drawable/IconCompat;->a(Landroid/graphics/Bitmap;Z)Landroid/graphics/Bitmap;
