...
.method private static a(Lorg/xmlpull/v1/XmlPullParser;Landroid/content/res/Resources;)Landroid/support/v4/content/res/FontResourcesParserCompat$FamilyResourceEntry;
    .locals 3
    ...
    .line 4
    invoke-static {p0, p1}, Landroid/support/v4/content/res/FontResourcesParserCompat;->b(Lorg/xmlpull/v1/XmlPullParser;Landroid/content/res/Resources;)Landroid/support/v4/content/res/FontResourcesParserCompat$FamilyResourceEntry;
...
.method private static b(Lorg/xmlpull/v1/XmlPullParser;Landroid/content/res/Resources;)Landroid/support/v4/content/res/FontResourcesParserCompat$FamilyResourceEntry;
    .locals 8
    .annotation build Landroid/support/annotation/Nullable;
    .end annotation
    ...
    .line 19
    invoke-static {p0, p1}, Landroid/support/v4/content/res/FontResourcesParserCompat;->c(Lorg/xmlpull/v1/XmlPullParser;Landroid/content/res/Resources;)Landroid/support/v4/content/res/FontResourcesParserCompat$FontFileResourceEntry;
...
.method private static c(Lorg/xmlpull/v1/XmlPullParser;Landroid/content/res/Resources;)Landroid/support/v4/content/res/FontResourcesParserCompat$FontFileResourceEntry;
    .locals 9
...
.method public static parse(Lorg/xmlpull/v1/XmlPullParser;Landroid/content/res/Resources;)Landroid/support/v4/content/res/FontResourcesParserCompat$FamilyResourceEntry;
    ...
    .line 2
    invoke-static {p0, p1}, Landroid/support/v4/content/res/FontResourcesParserCompat;->a(Lorg/xmlpull/v1/XmlPullParser;Landroid/content/res/Resources;)Landroid/support/v4/content/res/FontResourcesParserCompat$FamilyResourceEntry;
...
.method public static readCerts(Landroid/content/res/Resources;I)Ljava/util/List;
    ...
    .line 7
    invoke-static {v0, v2}, Landroid/support/v4/content/res/FontResourcesParserCompat;->a(Landroid/content/res/TypedArray;I)I
    ...
    invoke-static {v3}, Landroid/support/v4/content/res/FontResourcesParserCompat;->a([Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-static {p0}, Landroid/support/v4/content/res/FontResourcesParserCompat;->a([Ljava/lang/String;)Ljava/util/List;
