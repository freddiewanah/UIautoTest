...
.method constructor <init>(Landroid/content/Context;Ljava/lang/String;Landroid/content/ComponentName;Landroid/app/PendingIntent;)V
    ...
    .line 1
    invoke-direct {p0, p1, p2, p3, p4}, Landroid/support/v4/media/session/MediaSessionCompat$b;-><init>(Landroid/content/Context;Ljava/lang/String;Landroid/content/ComponentName;Landroid/app/PendingIntent;)V
...
.method a(J)I
    ...
    .line 5
    invoke-super {p0, p1, p2}, Landroid/support/v4/media/session/MediaSessionCompat$b;->a(J)I
...
.method a(Landroid/os/Bundle;)Landroid/media/RemoteControlClient$MetadataEditor;
    ...
    .line 6
    invoke-super {p0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$f;->a(Landroid/os/Bundle;)Landroid/media/RemoteControlClient$MetadataEditor;
...
.method public a(Landroid/support/v4/media/session/MediaSessionCompat$Callback;Landroid/os/Handler;)V
    ...
    .line 1
    invoke-super {p0, p1, p2}, Landroid/support/v4/media/session/MediaSessionCompat$b;->a(Landroid/support/v4/media/session/MediaSessionCompat$Callback;Landroid/os/Handler;)V
    ...
    invoke-direct {p1, p0}, Landroid/support/v4/media/session/e;-><init>(Landroid/support/v4/media/session/MediaSessionCompat$c;)V

    .line 4
    iget-object p2, p0, Landroid/support/v4/media/session/MediaSessionCompat$f;->i:Landroid/media/RemoteControlClient;
