...
.method private constructor <init>(Landroid/content/Context;Landroid/support/v4/media/session/MediaSessionCompat$a;)V
    ...
    .line 32
    invoke-interface {p2}, Landroid/support/v4/media/session/MediaSessionCompat$a;->e()Ljava/lang/Object;

    move-result-object p2

    invoke-static {p2}, Landroid/support/v4/media/session/j;->b(Ljava/lang/Object;)Z
    ...
    .line 33
    new-instance p2, Landroid/support/v4/media/session/c;

    invoke-direct {p2, p0}, Landroid/support/v4/media/session/c;-><init>(Landroid/support/v4/media/session/MediaSessionCompat;)V
...
.method private constructor <init>(Landroid/content/Context;Ljava/lang/String;Landroid/content/ComponentName;Landroid/app/PendingIntent;Landroid/os/Bundle;)V
    ...
    iput-object p3, p0, Landroid/support/v4/media/session/MediaSessionCompat;->b:Landroid/support/v4/media/session/MediaSessionCompat$a;

    .line 14
    new-instance p2, Landroid/support/v4/media/session/a;

    invoke-direct {p2, p0}, Landroid/support/v4/media/session/a;-><init>(Landroid/support/v4/media/session/MediaSessionCompat;)V

    invoke-virtual {p0, p2}, Landroid/support/v4/media/session/MediaSessionCompat;->setCallback(Landroid/support/v4/media/session/MediaSessionCompat$Callback;)V

    .line 15
    iget-object p2, p0, Landroid/support/v4/media/session/MediaSessionCompat;->b:Landroid/support/v4/media/session/MediaSessionCompat$a;

    invoke-interface {p2, p4}, Landroid/support/v4/media/session/MediaSessionCompat$a;->b(Landroid/app/PendingIntent;)V
    ...
    invoke-direct {p3, p1, p2, p5}, Landroid/support/v4/media/session/MediaSessionCompat$d;-><init>(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;)V

    iput-object p3, p0, Landroid/support/v4/media/session/MediaSessionCompat;->b:Landroid/support/v4/media/session/MediaSessionCompat$a;

    .line 17
    new-instance p2, Landroid/support/v4/media/session/b;

    invoke-direct {p2, p0}, Landroid/support/v4/media/session/b;-><init>(Landroid/support/v4/media/session/MediaSessionCompat;)V
    ...
    iput-object p5, p0, Landroid/support/v4/media/session/MediaSessionCompat;->b:Landroid/support/v4/media/session/MediaSessionCompat$a;
    ...
    .line 20
    new-instance p5, Landroid/support/v4/media/session/MediaSessionCompat$b;

    invoke-direct {p5, p1, p2, p3, p4}, Landroid/support/v4/media/session/MediaSessionCompat$b;-><init>(Landroid/content/Context;Ljava/lang/String;Landroid/content/ComponentName;Landroid/app/PendingIntent;)V
...
.method public static fromMediaSession(Landroid/content/Context;Ljava/lang/Object;)Landroid/support/v4/media/session/MediaSessionCompat;
    ...
    invoke-direct {v1, p1}, Landroid/support/v4/media/session/MediaSessionCompat$d;-><init>(Ljava/lang/Object;)V
...
.method public getCallingPackage()Ljava/lang/String;
    ...
    invoke-interface {v0}, Landroid/support/v4/media/session/MediaSessionCompat$a;->b()Ljava/lang/String;
...
.method public final getCurrentControllerInfo()Landroid/support/v4/media/MediaSessionManager$RemoteUserInfo;
    ...
    invoke-interface {v0}, Landroid/support/v4/media/session/MediaSessionCompat$a;->f()Landroid/support/v4/media/MediaSessionManager$RemoteUserInfo;
...
.method public isActive()Z
    ...
    invoke-interface {v0}, Landroid/support/v4/media/session/MediaSessionCompat$a;->d()Z
...
.method public release()V
    ...
    invoke-interface {v0}, Landroid/support/v4/media/session/MediaSessionCompat$a;->release()V
...
.method public setCallback(Landroid/support/v4/media/session/MediaSessionCompat$Callback;Landroid/os/Handler;)V
    ...
    .line 2
    iget-object p1, p0, Landroid/support/v4/media/session/MediaSessionCompat;->b:Landroid/support/v4/media/session/MediaSessionCompat$a;

    const/4 p2, 0x0

    invoke-interface {p1, p2, p2}, Landroid/support/v4/media/session/MediaSessionCompat$a;->a(Landroid/support/v4/media/session/MediaSessionCompat$Callback;Landroid/os/Handler;)V
...
.method public setCaptioningEnabled(Z)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$a;->setCaptioningEnabled(Z)V
...
.method public setExtras(Landroid/os/Bundle;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$a;->setExtras(Landroid/os/Bundle;)V
...
.method public setRepeatMode(I)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$a;->setRepeatMode(I)V
...
.method public setShuffleMode(I)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$a;->setShuffleMode(I)V
