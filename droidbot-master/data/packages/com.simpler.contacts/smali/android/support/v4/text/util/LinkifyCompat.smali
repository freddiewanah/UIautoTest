...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/text/util/LinkifyCompat;->a:[Ljava/lang/String;

    .line 2
    new-instance v0, Landroid/support/v4/text/util/b;

    invoke-direct {v0}, Landroid/support/v4/text/util/b;-><init>()V

    sput-object v0, Landroid/support/v4/text/util/LinkifyCompat;->b:Ljava/util/Comparator;
...
.method private static a(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 39
    :cond_0
    invoke-static {p0}, Landroid/support/v4/text/util/a;->a(Ljava/lang/String;)Ljava/lang/String;
...
.method private static a(Ljava/util/ArrayList;Landroid/text/Spannable;)V
    ...
    :goto_0
    :try_start_0
    invoke-static {p1}, Landroid/support/v4/text/util/LinkifyCompat;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 29
    :cond_0
    new-instance v3, Landroid/support/v4/text/util/LinkifyCompat$a;

    invoke-direct {v3}, Landroid/support/v4/text/util/LinkifyCompat$a;-><init>()V
    ...
    .line 31
    iput v2, v3, Landroid/support/v4/text/util/LinkifyCompat$a;->c:I

    add-int/2addr v0, v4

    .line 32
    iput v0, v3, Landroid/support/v4/text/util/LinkifyCompat$a;->d:I
    ...
    iput-object v1, v3, Landroid/support/v4/text/util/LinkifyCompat$a;->b:Ljava/lang/String;
...
.method private static a(Ljava/util/ArrayList;Landroid/text/Spannable;Ljava/util/regex/Pattern;[Ljava/lang/String;Landroid/text/util/Linkify$MatchFilter;Landroid/text/util/Linkify$TransformFilter;)V
    ...
    .line 18
    :cond_1
    new-instance v2, Landroid/support/v4/text/util/LinkifyCompat$a;

    invoke-direct {v2}, Landroid/support/v4/text/util/LinkifyCompat$a;-><init>()V
    ...
    invoke-static {v3, p3, p2, p5}, Landroid/support/v4/text/util/LinkifyCompat;->a(Ljava/lang/String;[Ljava/lang/String;Ljava/util/regex/Matcher;Landroid/text/util/Linkify$TransformFilter;)Ljava/lang/String;

    move-result-object v3

    .line 20
    iput-object v3, v2, Landroid/support/v4/text/util/LinkifyCompat$a;->b:Ljava/lang/String;

    .line 21
    iput v0, v2, Landroid/support/v4/text/util/LinkifyCompat$a;->c:I

    .line 22
    iput v1, v2, Landroid/support/v4/text/util/LinkifyCompat$a;->d:I
...
.method public static addLinks(Landroid/widget/TextView;Ljava/util/regex/Pattern;Ljava/lang/String;)V
    ...
    .line 26
    invoke-static {}, Landroid/support/v4/text/util/LinkifyCompat;->a()Z
...
.method public static addLinks(Landroid/widget/TextView;Ljava/util/regex/Pattern;Ljava/lang/String;[Ljava/lang/String;Landroid/text/util/Linkify$MatchFilter;Landroid/text/util/Linkify$TransformFilter;)V
    ...
    .line 37
    invoke-static {p0}, Landroid/support/v4/text/util/LinkifyCompat;->a(Landroid/widget/TextView;)V
...
.method public static addLinks(Landroid/text/Spannable;I)Z
    ...
    invoke-static/range {v4 .. v9}, Landroid/support/v4/text/util/LinkifyCompat;->a(Ljava/util/ArrayList;Landroid/text/Spannable;Ljava/util/regex/Pattern;[Ljava/lang/String;Landroid/text/util/Linkify$MatchFilter;Landroid/text/util/Linkify$TransformFilter;)V
    ...
    .line 10
    invoke-static {v1, p0}, Landroid/support/v4/text/util/LinkifyCompat;->a(Ljava/util/ArrayList;Landroid/text/Spannable;)V

    .line 11
    :cond_6
    invoke-static {v1, p0}, Landroid/support/v4/text/util/LinkifyCompat;->b(Ljava/util/ArrayList;Landroid/text/Spannable;)V
    ...
    check-cast v0, Landroid/support/v4/text/util/LinkifyCompat$a;

    .line 14
    iget-object v1, v0, Landroid/support/v4/text/util/LinkifyCompat$a;->a:Landroid/text/style/URLSpan;

    if-nez v1, :cond_8

    .line 15
    iget-object v1, v0, Landroid/support/v4/text/util/LinkifyCompat$a;->b:Ljava/lang/String;

    iget v2, v0, Landroid/support/v4/text/util/LinkifyCompat$a;->c:I

    iget v0, v0, Landroid/support/v4/text/util/LinkifyCompat$a;->d:I

    invoke-static {v1, v2, v0, p0}, Landroid/support/v4/text/util/LinkifyCompat;->a(Ljava/lang/String;IILandroid/text/Spannable;)V
...
.method public static addLinks(Landroid/text/Spannable;Ljava/util/regex/Pattern;Ljava/lang/String;[Ljava/lang/String;Landroid/text/util/Linkify$MatchFilter;Landroid/text/util/Linkify$TransformFilter;)Z
    ...
    .line 47
    :cond_2
    sget-object p3, Landroid/support/v4/text/util/LinkifyCompat;->a:[Ljava/lang/String;
    ...
    invoke-static {p2, v2, p1, p5}, Landroid/support/v4/text/util/LinkifyCompat;->a(Ljava/lang/String;[Ljava/lang/String;Ljava/util/regex/Matcher;Landroid/text/util/Linkify$TransformFilter;)Ljava/lang/String;

    move-result-object p2

    .line 59
    invoke-static {p2, p3, v0, p0}, Landroid/support/v4/text/util/LinkifyCompat;->a(Ljava/lang/String;IILandroid/text/Spannable;)V
...
.method private static b(Ljava/util/ArrayList;Landroid/text/Spannable;)V
    .locals 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object v4, v3, Landroid/support/v4/text/util/LinkifyCompat$a;->a:Landroid/text/style/URLSpan;
    ...
    iput v4, v3, Landroid/support/v4/text/util/LinkifyCompat$a;->c:I
    ...
    iput v4, v3, Landroid/support/v4/text/util/LinkifyCompat$a;->d:I
    ...
    .line 8
    :cond_0
    sget-object v0, Landroid/support/v4/text/util/LinkifyCompat;->b:Ljava/util/Comparator;
    ...
    check-cast v1, Landroid/support/v4/text/util/LinkifyCompat$a;
    ...
    check-cast v4, Landroid/support/v4/text/util/LinkifyCompat$a;

    .line 12
    iget v5, v1, Landroid/support/v4/text/util/LinkifyCompat$a;->c:I

    iget v6, v4, Landroid/support/v4/text/util/LinkifyCompat$a;->c:I

    if-gt v5, v6, :cond_5

    iget v1, v1, Landroid/support/v4/text/util/LinkifyCompat$a;->d:I

    if-le v1, v6, :cond_5

    .line 13
    iget v4, v4, Landroid/support/v4/text/util/LinkifyCompat$a;->d:I
    ...
    check-cast v3, Landroid/support/v4/text/util/LinkifyCompat$a;

    iget-object v3, v3, Landroid/support/v4/text/util/LinkifyCompat$a;->a:Landroid/text/style/URLSpan;
