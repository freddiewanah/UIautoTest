...
.method constructor <init>(Landroid/support/v4/widget/DrawerLayout;I)V
    ...
    .line 1
    iput-object p1, p0, Landroid/support/v4/widget/DrawerLayout$c;->d:Landroid/support/v4/widget/DrawerLayout;
    ...
    invoke-direct {p1, p0}, Landroid/support/v4/widget/i;-><init>(Landroid/support/v4/widget/DrawerLayout$c;)V

    iput-object p1, p0, Landroid/support/v4/widget/DrawerLayout$c;->c:Ljava/lang/Runnable;
...
.method private c()V
    ...
    .line 1
    iget v0, p0, Landroid/support/v4/widget/DrawerLayout$c;->a:I
    ...
    .line 2
    :cond_0
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout$c;->d:Landroid/support/v4/widget/DrawerLayout;
    ...
    .line 3
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout$c;->d:Landroid/support/v4/widget/DrawerLayout;
...
.method a()V
    ...
    .line 2
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout$c;->b:Landroid/support/v4/widget/ViewDragHelper;
    ...
    .line 3
    iget v1, p0, Landroid/support/v4/widget/DrawerLayout$c;->a:I
    ...
    .line 4
    iget-object v5, p0, Landroid/support/v4/widget/DrawerLayout$c;->d:Landroid/support/v4/widget/DrawerLayout;

    invoke-virtual {v5, v4}, Landroid/support/v4/widget/DrawerLayout;->a(I)Landroid/view/View;
    ...
    .line 6
    :cond_2
    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout$c;->d:Landroid/support/v4/widget/DrawerLayout;

    const/4 v4, 0x5

    invoke-virtual {v3, v4}, Landroid/support/v4/widget/DrawerLayout;->a(I)Landroid/view/View;
    ...
    .line 12
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout$c;->b:Landroid/support/v4/widget/ViewDragHelper;
    ...
    .line 13
    iput-boolean v2, v0, Landroid/support/v4/widget/DrawerLayout$LayoutParams;->b:Z
...
.method public a(Landroid/support/v4/widget/ViewDragHelper;)V
    ...
    .line 1
    iput-object p1, p0, Landroid/support/v4/widget/DrawerLayout$c;->b:Landroid/support/v4/widget/ViewDragHelper;
...
.method public b()V
    ...
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout$c;->c:Ljava/lang/Runnable;
...
.method public clampViewPositionHorizontal(Landroid/view/View;II)I
    ...
    .line 1
    iget-object p3, p0, Landroid/support/v4/widget/DrawerLayout$c;->d:Landroid/support/v4/widget/DrawerLayout;
...
.method public onEdgeDragStarted(II)V
    ...
    .line 1
    iget-object p1, p0, Landroid/support/v4/widget/DrawerLayout$c;->d:Landroid/support/v4/widget/DrawerLayout;
...
.method public onEdgeTouched(II)V
    ...
    iget-object p2, p0, Landroid/support/v4/widget/DrawerLayout$c;->c:Ljava/lang/Runnable;
...
.method public onViewCaptured(Landroid/view/View;I)V
    ...
    .line 2
    iput-boolean p2, p1, Landroid/support/v4/widget/DrawerLayout$LayoutParams;->b:Z
...
.method public onViewDragStateChanged(I)V
    ...
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout$c;->b:Landroid/support/v4/widget/ViewDragHelper;
...
.method public onViewPositionChanged(Landroid/view/View;IIII)V
    ...
    .line 2
    iget-object p4, p0, Landroid/support/v4/widget/DrawerLayout$c;->d:Landroid/support/v4/widget/DrawerLayout;
    ...
    invoke-virtual {p3, p1, p2}, Landroid/support/v4/widget/DrawerLayout;->c(Landroid/view/View;F)V
...
.method public onViewReleased(Landroid/view/View;FF)V
    ...
    .line 5
    :goto_1
    iget-object p3, p0, Landroid/support/v4/widget/DrawerLayout$c;->b:Landroid/support/v4/widget/ViewDragHelper;
...
.method public tryCaptureView(Landroid/view/View;I)Z
    ...
    .line 1
    iget-object p2, p0, Landroid/support/v4/widget/DrawerLayout$c;->d:Landroid/support/v4/widget/DrawerLayout;
