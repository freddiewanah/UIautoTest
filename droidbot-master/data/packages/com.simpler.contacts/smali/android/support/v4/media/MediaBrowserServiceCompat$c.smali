...
.method public a(Landroid/support/v4/media/session/MediaSessionCompat$Token;)V
    ...
    invoke-direct {v1, p0, p1}, Landroid/support/v4/media/B;-><init>(Landroid/support/v4/media/MediaBrowserServiceCompat$c;Landroid/support/v4/media/session/MediaSessionCompat$Token;)V
...
.method b(Landroid/support/v4/media/MediaSessionManager$RemoteUserInfo;Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    invoke-direct {v1, p0, p1, p2, p3}, Landroid/support/v4/media/E;-><init>(Landroid/support/v4/media/MediaBrowserServiceCompat$c;Landroid/support/v4/media/MediaSessionManager$RemoteUserInfo;Ljava/lang/String;Landroid/os/Bundle;)V
...
.method b(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    invoke-direct {v1, p0, p1, p2}, Landroid/support/v4/media/D;-><init>(Landroid/support/v4/media/MediaBrowserServiceCompat$c;Ljava/lang/String;Landroid/os/Bundle;)V
...
.method public onGetRoot(Ljava/lang/String;ILandroid/os/Bundle;)Landroid/support/v4/media/MediaBrowserServiceCompatApi21$a;
    ...
    iget-object v2, v2, Landroid/support/v4/media/MediaBrowserServiceCompat;->e:Landroid/support/v4/media/MediaBrowserServiceCompat$k;
    ...
    .line 6
    iget-object v2, p0, Landroid/support/v4/media/MediaBrowserServiceCompat$c;->c:Landroid/os/Messenger;
    ...
    .line 12
    :goto_1
    iget-object v9, p0, Landroid/support/v4/media/MediaBrowserServiceCompat$c;->d:Landroid/support/v4/media/MediaBrowserServiceCompat;
    ...
    iput-object v10, v9, Landroid/support/v4/media/MediaBrowserServiceCompat;->d:Landroid/support/v4/media/MediaBrowserServiceCompat$a;
    ...
    iput-object v0, p2, Landroid/support/v4/media/MediaBrowserServiceCompat;->d:Landroid/support/v4/media/MediaBrowserServiceCompat$a;
...
.method public onLoadChildren(Ljava/lang/String;Landroid/support/v4/media/MediaBrowserServiceCompatApi21$c;)V
    ...
    invoke-direct {v0, p0, p1, p2}, Landroid/support/v4/media/C;-><init>(Landroid/support/v4/media/MediaBrowserServiceCompat$c;Ljava/lang/Object;Landroid/support/v4/media/MediaBrowserServiceCompatApi21$c;)V
