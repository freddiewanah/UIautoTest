...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Landroid/support/v4/graphics/PathParser$a;
    }
.end annotation
...
.method private static a(Ljava/lang/String;ILandroid/support/v4/graphics/PathParser$a;)V
    .locals 8

    const/4 v0, 0x0

    .line 22
    iput-boolean v0, p2, Landroid/support/v4/graphics/PathParser$a;->b:Z
    ...
    .line 25
    :cond_0
    iput-boolean v7, p2, Landroid/support/v4/graphics/PathParser$a;->b:Z
    ...
    :cond_5
    :goto_4
    iput v1, p2, Landroid/support/v4/graphics/PathParser$a;->a:I
...
.method private static a(Ljava/lang/String;)[F
    ...
    .line 12
    new-instance v2, Landroid/support/v4/graphics/PathParser$a;

    invoke-direct {v2}, Landroid/support/v4/graphics/PathParser$a;-><init>()V
    ...
    .line 14
    invoke-static {p0, v4, v2}, Landroid/support/v4/graphics/PathParser;->a(Ljava/lang/String;ILandroid/support/v4/graphics/PathParser$a;)V

    .line 15
    iget v6, v2, Landroid/support/v4/graphics/PathParser$a;->a:I
    ...
    .line 18
    :cond_1
    iget-boolean v4, v2, Landroid/support/v4/graphics/PathParser$a;->b:Z
    ...
    .line 19
    :cond_3
    invoke-static {v1, v0, v5}, Landroid/support/v4/graphics/PathParser;->a([FII)[F
...
.method public static createNodesFromPathData(Ljava/lang/String;)[Landroid/support/v4/graphics/PathParser$PathDataNode;
    ...
    .line 3
    invoke-static {p0, v3}, Landroid/support/v4/graphics/PathParser;->a(Ljava/lang/String;I)I
    ...
    .line 6
    invoke-static {v4}, Landroid/support/v4/graphics/PathParser;->a(Ljava/lang/String;)[F
    ...
    invoke-static {v0, v4, v5}, Landroid/support/v4/graphics/PathParser;->a(Ljava/util/ArrayList;C[F)V
    ...
    invoke-static {v0, p0, v1}, Landroid/support/v4/graphics/PathParser;->a(Ljava/util/ArrayList;C[F)V
