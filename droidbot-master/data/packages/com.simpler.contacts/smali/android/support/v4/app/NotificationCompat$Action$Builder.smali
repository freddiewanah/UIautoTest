...
.method private constructor <init>(ILjava/lang/CharSequence;Landroid/app/PendingIntent;Landroid/os/Bundle;[Landroid/support/v4/app/RemoteInput;ZIZ)V
    ...
    .line 7
    iput-boolean v0, p0, Landroid/support/v4/app/NotificationCompat$Action$Builder;->d:Z

    .line 8
    iput-boolean v0, p0, Landroid/support/v4/app/NotificationCompat$Action$Builder;->h:Z

    .line 9
    iput p1, p0, Landroid/support/v4/app/NotificationCompat$Action$Builder;->a:I
    ...
    iput-object p1, p0, Landroid/support/v4/app/NotificationCompat$Action$Builder;->b:Ljava/lang/CharSequence;

    .line 11
    iput-object p3, p0, Landroid/support/v4/app/NotificationCompat$Action$Builder;->c:Landroid/app/PendingIntent;

    .line 12
    iput-object p4, p0, Landroid/support/v4/app/NotificationCompat$Action$Builder;->e:Landroid/os/Bundle;
    ...
    :goto_0
    iput-object p1, p0, Landroid/support/v4/app/NotificationCompat$Action$Builder;->f:Ljava/util/ArrayList;

    .line 15
    iput-boolean p6, p0, Landroid/support/v4/app/NotificationCompat$Action$Builder;->d:Z

    .line 16
    iput p7, p0, Landroid/support/v4/app/NotificationCompat$Action$Builder;->g:I

    .line 17
    iput-boolean p8, p0, Landroid/support/v4/app/NotificationCompat$Action$Builder;->h:Z
...
.method public constructor <init>(Landroid/support/v4/app/NotificationCompat$Action;)V
    ...
    iget-object v0, p1, Landroid/support/v4/app/NotificationCompat$Action;->a:Landroid/os/Bundle;
    ...
    iget-boolean v8, p1, Landroid/support/v4/app/NotificationCompat$Action;->e:Z
...
.method public addExtras(Landroid/os/Bundle;)Landroid/support/v4/app/NotificationCompat$Action$Builder;
    ...
    .line 1
    iget-object v0, p0, Landroid/support/v4/app/NotificationCompat$Action$Builder;->e:Landroid/os/Bundle;
...
.method public addRemoteInput(Landroid/support/v4/app/RemoteInput;)Landroid/support/v4/app/NotificationCompat$Action$Builder;
    ...
    .line 1
    iget-object v0, p0, Landroid/support/v4/app/NotificationCompat$Action$Builder;->f:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Landroid/support/v4/app/NotificationCompat$Action$Builder;->f:Ljava/util/ArrayList;
...
.method public build()Landroid/support/v4/app/NotificationCompat$Action;
    ...
    .line 3
    iget-object v2, p0, Landroid/support/v4/app/NotificationCompat$Action$Builder;->f:Ljava/util/ArrayList;
    ...
    iget v5, p0, Landroid/support/v4/app/NotificationCompat$Action$Builder;->a:I

    iget-object v6, p0, Landroid/support/v4/app/NotificationCompat$Action$Builder;->b:Ljava/lang/CharSequence;

    iget-object v7, p0, Landroid/support/v4/app/NotificationCompat$Action$Builder;->c:Landroid/app/PendingIntent;

    iget-object v8, p0, Landroid/support/v4/app/NotificationCompat$Action$Builder;->e:Landroid/os/Bundle;

    iget-boolean v11, p0, Landroid/support/v4/app/NotificationCompat$Action$Builder;->d:Z

    iget v12, p0, Landroid/support/v4/app/NotificationCompat$Action$Builder;->g:I

    iget-boolean v13, p0, Landroid/support/v4/app/NotificationCompat$Action$Builder;->h:Z
...
.method public setAllowGeneratedReplies(Z)Landroid/support/v4/app/NotificationCompat$Action$Builder;
    ...
    .line 1
    iput-boolean p1, p0, Landroid/support/v4/app/NotificationCompat$Action$Builder;->d:Z
...
.method public setSemanticAction(I)Landroid/support/v4/app/NotificationCompat$Action$Builder;
    ...
    .line 1
    iput p1, p0, Landroid/support/v4/app/NotificationCompat$Action$Builder;->g:I
...
.method public setShowsUserInterface(Z)Landroid/support/v4/app/NotificationCompat$Action$Builder;
    ...
    .line 1
    iput-boolean p1, p0, Landroid/support/v4/app/NotificationCompat$Action$Builder;->h:Z
