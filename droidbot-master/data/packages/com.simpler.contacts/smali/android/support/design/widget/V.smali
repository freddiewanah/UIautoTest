...
.method constructor <init>(Landroid/support/design/widget/SwipeDismissBehavior;)V
    ...
    .line 1
    iput-object p1, p0, Landroid/support/design/widget/V;->c:Landroid/support/design/widget/SwipeDismissBehavior;
...
.method private a(Landroid/view/View;F)Z
    ...
    .line 2
    :goto_0
    iget-object v3, p0, Landroid/support/design/widget/V;->c:Landroid/support/design/widget/SwipeDismissBehavior;
    ...
    iget-object v0, p0, Landroid/support/design/widget/V;->c:Landroid/support/design/widget/SwipeDismissBehavior;
...
.method public clampViewPositionHorizontal(Landroid/view/View;II)I
    ...
    .line 2
    :goto_0
    iget-object v1, p0, Landroid/support/design/widget/V;->c:Landroid/support/design/widget/SwipeDismissBehavior;
    ...
    .line 3
    iget p3, p0, Landroid/support/design/widget/V;->a:I
    ...
    .line 4
    iget p1, p0, Landroid/support/design/widget/V;->a:I
...
.method public onViewCaptured(Landroid/view/View;I)V
    ...
    .line 1
    iput p2, p0, Landroid/support/design/widget/V;->b:I
    ...
    iput p2, p0, Landroid/support/design/widget/V;->a:I
...
.method public onViewPositionChanged(Landroid/view/View;IIII)V
    ...
    iget-object p5, p0, Landroid/support/design/widget/V;->c:Landroid/support/design/widget/SwipeDismissBehavior;
    ...
    .line 3
    iget p4, p0, Landroid/support/design/widget/V;->a:I
...
.method public onViewReleased(Landroid/view/View;FF)V
    ...
    .line 1
    iput p3, p0, Landroid/support/design/widget/V;->b:I
    ...
    .line 3
    invoke-direct {p0, p1, p2}, Landroid/support/design/widget/V;->a(Landroid/view/View;F)Z
    ...
    .line 6
    :goto_1
    iget-object p3, p0, Landroid/support/design/widget/V;->c:Landroid/support/design/widget/SwipeDismissBehavior;
    ...
    .line 7
    new-instance p3, Landroid/support/design/widget/SwipeDismissBehavior$a;

    iget-object v0, p0, Landroid/support/design/widget/V;->c:Landroid/support/design/widget/SwipeDismissBehavior;

    invoke-direct {p3, v0, p1, p2}, Landroid/support/design/widget/SwipeDismissBehavior$a;-><init>(Landroid/support/design/widget/SwipeDismissBehavior;Landroid/view/View;Z)V
    ...
    .line 8
    iget-object p2, p0, Landroid/support/design/widget/V;->c:Landroid/support/design/widget/SwipeDismissBehavior;

    iget-object p2, p2, Landroid/support/design/widget/SwipeDismissBehavior;->b:Landroid/support/design/widget/SwipeDismissBehavior$OnDismissListener;
...
.method public tryCaptureView(Landroid/view/View;I)Z
    ...
    .line 1
    iget p2, p0, Landroid/support/design/widget/V;->b:I
