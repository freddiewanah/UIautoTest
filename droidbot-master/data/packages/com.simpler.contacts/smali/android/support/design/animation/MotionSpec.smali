...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroid/support/design/animation/MotionSpec;->a:Landroid/support/v4/util/SimpleArrayMap;

    return-void
.end method

.method private static a(Ljava/util/List;)Landroid/support/design/animation/MotionSpec;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v0, v3}, Landroid/support/design/animation/MotionSpec;->a(Landroid/support/design/animation/MotionSpec;Landroid/animation/Animator;)V
...
.method private static a(Landroid/support/design/animation/MotionSpec;Landroid/animation/Animator;)V
    .locals 2
    ...
    invoke-static {p1}, Landroid/support/design/animation/MotionTiming;->a(Landroid/animation/ValueAnimator;)Landroid/support/design/animation/MotionTiming;
...
.method public static createFromResource(Landroid/content/Context;I)Landroid/support/design/animation/MotionSpec;
    ...
    invoke-static {p0}, Landroid/support/design/animation/MotionSpec;->a(Ljava/util/List;)Landroid/support/design/animation/MotionSpec;
    ...
    .line 7
    invoke-static {v1}, Landroid/support/design/animation/MotionSpec;->a(Ljava/util/List;)Landroid/support/design/animation/MotionSpec;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    .line 3
    iget-object v0, p0, Landroid/support/design/animation/MotionSpec;->a:Landroid/support/v4/util/SimpleArrayMap;

    iget-object p1, p1, Landroid/support/design/animation/MotionSpec;->a:Landroid/support/v4/util/SimpleArrayMap;
...
.method public getTotalDuration()J
    ...
    .line 2
    iget-object v4, p0, Landroid/support/design/animation/MotionSpec;->a:Landroid/support/v4/util/SimpleArrayMap;
...
.method public toString()Ljava/lang/String;
    ...
    .line 7
    iget-object v1, p0, Landroid/support/design/animation/MotionSpec;->a:Landroid/support/v4/util/SimpleArrayMap;
