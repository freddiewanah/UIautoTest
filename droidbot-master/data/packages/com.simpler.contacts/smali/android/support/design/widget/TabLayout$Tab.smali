...
.field public view:Landroid/support/design/widget/TabLayout$d;
...
.method public constructor <init>()V
    ...
    .line 2
    iput v0, p0, Landroid/support/design/widget/TabLayout$Tab;->e:I

    return-void
.end method

.method static synthetic a(Landroid/support/design/widget/TabLayout$Tab;)Ljava/lang/CharSequence;
    .locals 0

    .line 1
    iget-object p0, p0, Landroid/support/design/widget/TabLayout$Tab;->d:Ljava/lang/CharSequence;

    return-object p0
.end method

.method static synthetic b(Landroid/support/design/widget/TabLayout$Tab;)Ljava/lang/CharSequence;
    .locals 0

    .line 1
    iget-object p0, p0, Landroid/support/design/widget/TabLayout$Tab;->c:Ljava/lang/CharSequence;
...
.method a()V
    ...
    .line 4
    iput-object v0, p0, Landroid/support/design/widget/TabLayout$Tab;->view:Landroid/support/design/widget/TabLayout$d;

    .line 5
    iput-object v0, p0, Landroid/support/design/widget/TabLayout$Tab;->a:Ljava/lang/Object;

    .line 6
    iput-object v0, p0, Landroid/support/design/widget/TabLayout$Tab;->b:Landroid/graphics/drawable/Drawable;

    .line 7
    iput-object v0, p0, Landroid/support/design/widget/TabLayout$Tab;->c:Ljava/lang/CharSequence;

    .line 8
    iput-object v0, p0, Landroid/support/design/widget/TabLayout$Tab;->d:Ljava/lang/CharSequence;

    const/4 v1, -0x1

    .line 9
    iput v1, p0, Landroid/support/design/widget/TabLayout$Tab;->e:I

    .line 10
    iput-object v0, p0, Landroid/support/design/widget/TabLayout$Tab;->f:Landroid/view/View;
...
.method a(I)V
    ...
    .line 2
    iput p1, p0, Landroid/support/design/widget/TabLayout$Tab;->e:I
...
.method b()V
    ...
    .line 2
    iget-object v0, p0, Landroid/support/design/widget/TabLayout$Tab;->view:Landroid/support/design/widget/TabLayout$d;
...
.method public getCustomView()Landroid/view/View;
    ...
    .line 1
    iget-object v0, p0, Landroid/support/design/widget/TabLayout$Tab;->f:Landroid/view/View;
...
.method public getIcon()Landroid/graphics/drawable/Drawable;
    ...
    .line 1
    iget-object v0, p0, Landroid/support/design/widget/TabLayout$Tab;->b:Landroid/graphics/drawable/Drawable;
...
.method public getPosition()I
    ...
    .line 1
    iget v0, p0, Landroid/support/design/widget/TabLayout$Tab;->e:I
...
.method public getText()Ljava/lang/CharSequence;
    ...
    .line 1
    iget-object v0, p0, Landroid/support/design/widget/TabLayout$Tab;->c:Ljava/lang/CharSequence;
...
.method public isSelected()Z
    ...
    iget v1, p0, Landroid/support/design/widget/TabLayout$Tab;->e:I
...
.method public setContentDescription(Ljava/lang/CharSequence;)Landroid/support/design/widget/TabLayout$Tab;
    ...
    .line 4
    iput-object p1, p0, Landroid/support/design/widget/TabLayout$Tab;->d:Ljava/lang/CharSequence;

    .line 5
    invoke-virtual {p0}, Landroid/support/design/widget/TabLayout$Tab;->b()V
...
.method public setCustomView(I)Landroid/support/design/widget/TabLayout$Tab;
    ...
    .line 4
    iget-object v1, p0, Landroid/support/design/widget/TabLayout$Tab;->view:Landroid/support/design/widget/TabLayout$d;
...
.method public setCustomView(Landroid/view/View;)Landroid/support/design/widget/TabLayout$Tab;
    ...
    .line 1
    iput-object p1, p0, Landroid/support/design/widget/TabLayout$Tab;->f:Landroid/view/View;
...
.method public setIcon(Landroid/graphics/drawable/Drawable;)Landroid/support/design/widget/TabLayout$Tab;
    ...
    .line 1
    iput-object p1, p0, Landroid/support/design/widget/TabLayout$Tab;->b:Landroid/graphics/drawable/Drawable;
...
.method public setText(Ljava/lang/CharSequence;)Landroid/support/design/widget/TabLayout$Tab;
    ...
    .line 1
    iget-object v0, p0, Landroid/support/design/widget/TabLayout$Tab;->d:Ljava/lang/CharSequence;
    ...
    .line 3
    :cond_0
    iput-object p1, p0, Landroid/support/design/widget/TabLayout$Tab;->c:Ljava/lang/CharSequence;
