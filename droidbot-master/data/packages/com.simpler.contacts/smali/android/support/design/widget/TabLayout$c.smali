...
.method constructor <init>(Landroid/support/design/widget/TabLayout;Landroid/content/Context;)V
    ...
    .line 1
    iput-object p1, p0, Landroid/support/design/widget/TabLayout$c;->j:Landroid/support/design/widget/TabLayout;
    ...
    .line 6
    iput p1, p0, Landroid/support/design/widget/TabLayout$c;->h:I
    ...
    iput-object p1, p0, Landroid/support/design/widget/TabLayout$c;->b:Landroid/graphics/Paint;
    ...
    iput-object p1, p0, Landroid/support/design/widget/TabLayout$c;->c:Landroid/graphics/drawable/GradientDrawable;

    return-void
.end method

.method private a(Landroid/support/design/widget/TabLayout$d;Landroid/graphics/RectF;)V
    .locals 3

    .line 31
    invoke-static {p1}, Landroid/support/design/widget/TabLayout$d;->a(Landroid/support/design/widget/TabLayout$d;)I

    move-result v0

    .line 32
    iget-object v1, p0, Landroid/support/design/widget/TabLayout$c;->j:Landroid/support/design/widget/TabLayout;
    ...
    .line 33
    iget-object v0, p0, Landroid/support/design/widget/TabLayout$c;->j:Landroid/support/design/widget/TabLayout;
...
.method private b()V
    ...
    .line 8
    iget-object v3, p0, Landroid/support/design/widget/TabLayout$c;->j:Landroid/support/design/widget/TabLayout;

    iget-boolean v4, v3, Landroid/support/design/widget/TabLayout;->C:Z

    if-nez v4, :cond_0

    instance-of v4, v0, Landroid/support/design/widget/TabLayout$d;
    ...
    invoke-direct {p0, v0, v1}, Landroid/support/design/widget/TabLayout$c;->a(Landroid/support/design/widget/TabLayout$d;Landroid/graphics/RectF;)V
    ...
    .line 12
    :cond_0
    iget v0, p0, Landroid/support/design/widget/TabLayout$c;->e:F
    ...
    .line 16
    iget-object v5, p0, Landroid/support/design/widget/TabLayout$c;->j:Landroid/support/design/widget/TabLayout;

    iget-boolean v6, v5, Landroid/support/design/widget/TabLayout;->C:Z

    if-nez v6, :cond_1

    instance-of v6, v0, Landroid/support/design/widget/TabLayout$d;
    ...
    invoke-direct {p0, v0, v3}, Landroid/support/design/widget/TabLayout$c;->a(Landroid/support/design/widget/TabLayout$d;Landroid/graphics/RectF;)V
    ...
    :cond_3
    :goto_0
    invoke-virtual {p0, v1, v2}, Landroid/support/design/widget/TabLayout$c;->b(II)V
...
.method a(I)V
    ...
    .line 1
    iget-object v0, p0, Landroid/support/design/widget/TabLayout$c;->b:Landroid/graphics/Paint;
...
.method a(IF)V
    ...
    .line 7
    iget-object v0, p0, Landroid/support/design/widget/TabLayout$c;->i:Landroid/animation/ValueAnimator;
    ...
    .line 11
    invoke-direct {p0}, Landroid/support/design/widget/TabLayout$c;->b()V
...
.method a(II)V
    ...
    .line 22
    iget v5, p0, Landroid/support/design/widget/TabLayout$c;->g:I

    .line 23
    iget v7, p0, Landroid/support/design/widget/TabLayout$c;->h:I
    ...
    iput-object v0, p0, Landroid/support/design/widget/TabLayout$c;->i:Landroid/animation/ValueAnimator;
    ...
    invoke-direct/range {v3 .. v8}, Landroid/support/design/widget/X;-><init>(Landroid/support/design/widget/TabLayout$c;IIII)V
    ...
    invoke-direct {p2, p0, p1}, Landroid/support/design/widget/Y;-><init>(Landroid/support/design/widget/TabLayout$c;I)V
...
.method b(I)V
    ...
    .line 2
    iput p1, p0, Landroid/support/design/widget/TabLayout$c;->a:I
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    .line 4
    :cond_1
    iget-object v2, p0, Landroid/support/design/widget/TabLayout$c;->j:Landroid/support/design/widget/TabLayout;
    ...
    iget v3, p0, Landroid/support/design/widget/TabLayout$c;->h:I
    ...
    :cond_6
    iget-object v2, p0, Landroid/support/design/widget/TabLayout$c;->c:Landroid/graphics/drawable/GradientDrawable;
    ...
    .line 13
    iget v3, p0, Landroid/support/design/widget/TabLayout$c;->g:I
...
.method protected onLayout(ZIIII)V
    ...
    .line 2
    iget-object p1, p0, Landroid/support/design/widget/TabLayout$c;->i:Landroid/animation/ValueAnimator;
    ...
    .line 5
    iget p3, p0, Landroid/support/design/widget/TabLayout$c;->d:I

    const/high16 p4, 0x3f800000    # 1.0f

    iget-object p5, p0, Landroid/support/design/widget/TabLayout$c;->i:Landroid/animation/ValueAnimator;
    ...
    .line 7
    invoke-virtual {p0, p3, p1}, Landroid/support/design/widget/TabLayout$c;->a(II)V
