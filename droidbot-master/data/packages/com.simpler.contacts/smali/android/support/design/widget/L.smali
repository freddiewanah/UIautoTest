...
.method constructor <init>(Landroid/support/design/widget/VisibilityAwareImageButton;Landroid/support/design/widget/ShadowViewDelegate;)V
    ...
    .line 1
    invoke-direct {p0, p1, p2}, Landroid/support/design/widget/K;-><init>(Landroid/support/design/widget/VisibilityAwareImageButton;Landroid/support/design/widget/ShadowViewDelegate;)V
...
.method private a(FF)Landroid/animation/Animator;
    ...
    .line 51
    sget-object p1, Landroid/support/design/widget/K;->a:Landroid/animation/TimeInterpolator;
...
.method a(FFF)V
    ...
    .line 15
    sget-object v1, Landroid/support/design/widget/K;->b:[I

    .line 16
    invoke-direct {p0, p1, p3}, Landroid/support/design/widget/L;->a(FF)Landroid/animation/Animator;
    ...
    .line 18
    sget-object p3, Landroid/support/design/widget/K;->c:[I

    .line 19
    invoke-direct {p0, p1, p2}, Landroid/support/design/widget/L;->a(FF)Landroid/animation/Animator;
    ...
    .line 21
    sget-object p3, Landroid/support/design/widget/K;->d:[I
    ...
    .line 24
    sget-object p3, Landroid/support/design/widget/K;->e:[I
    ...
    .line 41
    sget-object p1, Landroid/support/design/widget/K;->f:[I

    invoke-virtual {v0, p1, p2}, Landroid/animation/StateListAnimator;->addState([ILandroid/animation/Animator;)V

    .line 42
    sget-object p1, Landroid/support/design/widget/K;->g:[I

    invoke-direct {p0, v3, v3}, Landroid/support/design/widget/L;->a(FF)Landroid/animation/Animator;
...
.method a(Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;Landroid/content/res/ColorStateList;I)V
    ...
    iget-object v1, p0, Landroid/support/design/widget/K;->s:Landroid/support/design/widget/CircularBorderDrawable;

    aput-object v1, p4, v0

    const/4 v0, 0x1

    iget-object v1, p0, Landroid/support/design/widget/K;->q:Landroid/graphics/drawable/Drawable;
    ...
    .line 6
    :cond_1
    iput-object p2, p0, Landroid/support/design/widget/K;->s:Landroid/support/design/widget/CircularBorderDrawable;

    .line 7
    iget-object p1, p0, Landroid/support/design/widget/K;->q:Landroid/graphics/drawable/Drawable;
    ...
    iput-object p4, p0, Landroid/support/design/widget/K;->r:Landroid/graphics/drawable/Drawable;

    .line 10
    iget-object p1, p0, Landroid/support/design/widget/K;->r:Landroid/graphics/drawable/Drawable;

    iput-object p1, p0, Landroid/support/design/widget/K;->t:Landroid/graphics/drawable/Drawable;
...
.method a(Landroid/graphics/Rect;)V
    ...
    .line 62
    iget-object v0, p0, Landroid/support/design/widget/K;->C:Landroid/support/design/widget/ShadowViewDelegate;
    ...
    .line 64
    invoke-virtual {p0}, Landroid/support/design/widget/L;->c()F

    move-result v2

    iget v3, p0, Landroid/support/design/widget/K;->w:F
...
.method a([I)V
    ...
    iget v1, p0, Landroid/support/design/widget/K;->u:F
...
.method b(Landroid/content/res/ColorStateList;)V
    ...
    .line 4
    :cond_0
    invoke-super {p0, p1}, Landroid/support/design/widget/K;->b(Landroid/content/res/ColorStateList;)V
...
.method b(Landroid/graphics/Rect;)V
    ...
    iget-object v2, p0, Landroid/support/design/widget/K;->r:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v0, p0, Landroid/support/design/widget/L;->I:Landroid/graphics/drawable/InsetDrawable;

    .line 7
    iget-object p1, p0, Landroid/support/design/widget/K;->C:Landroid/support/design/widget/ShadowViewDelegate;

    iget-object v0, p0, Landroid/support/design/widget/L;->I:Landroid/graphics/drawable/InsetDrawable;
