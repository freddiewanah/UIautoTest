...
.field private static a:Landroidx/browser/browseractions/BrowserActionsIntent$a;
...
.method constructor <init>(Landroid/content/Intent;)V
    ...
    .line 2
    iput-object p1, p0, Landroidx/browser/browseractions/BrowserActionsIntent;->b:Landroid/content/Intent;
...
.method private static a(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    .line 21
    :goto_0
    invoke-static {p0, v0, v1, p1}, Landroidx/browser/browseractions/BrowserActionsIntent;->a(Landroid/content/Context;Landroid/net/Uri;ILjava/util/List;)V
...
.method static a(Landroid/content/Context;Landroid/content/Intent;Ljava/util/List;)V
    ...
    .line 11
    invoke-static {p0, p1, p2}, Landroid/support/v4/content/ContextCompat;->startActivity(Landroid/content/Context;Landroid/content/Intent;Landroid/os/Bundle;)V
    ...
    :cond_4
    :goto_2
    invoke-static {p0, p1}, Landroidx/browser/browseractions/BrowserActionsIntent;->a(Landroid/content/Context;Landroid/content/Intent;)V

    return-void
.end method

.method private static a(Landroid/content/Context;Landroid/net/Uri;ILjava/util/List;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 22
    new-instance p2, Landroidx/browser/browseractions/f;

    invoke-direct {p2, p0, p1, p3}, Landroidx/browser/browseractions/f;-><init>(Landroid/content/Context;Landroid/net/Uri;Ljava/util/List;)V

    .line 23
    invoke-virtual {p2}, Landroidx/browser/browseractions/f;->a()V

    .line 24
    sget-object p0, Landroidx/browser/browseractions/BrowserActionsIntent;->a:Landroidx/browser/browseractions/BrowserActionsIntent$a;

    if-eqz p0, :cond_0

    .line 25
    invoke-interface {p0}, Landroidx/browser/browseractions/BrowserActionsIntent$a;->a()V
...
.method public getIntent()Landroid/content/Intent;
    ...
    .line 1
    iget-object v0, p0, Landroidx/browser/browseractions/BrowserActionsIntent;->b:Landroid/content/Intent;
