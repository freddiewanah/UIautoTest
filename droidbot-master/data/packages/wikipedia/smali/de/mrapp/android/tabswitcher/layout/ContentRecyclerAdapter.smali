...
.method public final varargs onShowView(Landroid/content/Context;Landroid/view/View;Lde/mrapp/android/tabswitcher/Tab;Z[Ljava/lang/Void;)V
    ...
    .line 153
    sget-object p5, Lde/mrapp/android/tabswitcher/Tab;->WAS_SHOWN_PARAMETER:Ljava/lang/String;

    const/4 v0, 0x0

    invoke-virtual {p4, p5, v0}, Landroid/os/Bundle;->getBoolean(Ljava/lang/String;Z)Z
    ...
    .line 154
    iget-object p5, p0, Lde/mrapp/android/tabswitcher/layout/ContentRecyclerAdapter;->savedInstanceStates:Landroid/util/SparseArray;
    ...
    .line 157
    invoke-direct {p0, p4}, Lde/mrapp/android/tabswitcher/layout/ContentRecyclerAdapter;->setWasShownParameter(Landroid/os/Bundle;)Landroid/os/Bundle;

    move-result-object p4

    invoke-virtual {p3, p4}, Lde/mrapp/android/tabswitcher/Tab;->setParameters(Landroid/os/Bundle;)V
