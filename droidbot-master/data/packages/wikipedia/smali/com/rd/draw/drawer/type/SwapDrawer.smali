...
.method public draw(Landroid/graphics/Canvas;Lcom/rd/animation/data/Value;III)V
    ...
    .line 24
    instance-of v0, p2, Lcom/rd/animation/data/type/SwapAnimationValue;
    ...
    .line 28
    :cond_0
    check-cast p2, Lcom/rd/animation/data/type/SwapAnimationValue;
    ...
    .line 37
    invoke-virtual {p2}, Lcom/rd/animation/data/type/SwapAnimationValue;->getCoordinate()I

    move-result v6

    .line 40
    iget-object v7, p0, Lcom/rd/draw/drawer/type/BaseDrawer;->indicator:Lcom/rd/draw/data/Indicator;
    ...
    .line 46
    invoke-virtual {p2}, Lcom/rd/animation/data/type/SwapAnimationValue;->getCoordinateReverse()I
    ...
    .line 62
    iget-object p2, p0, Lcom/rd/draw/drawer/type/BaseDrawer;->indicator:Lcom/rd/draw/data/Indicator;

    invoke-virtual {p2}, Lcom/rd/draw/data/Indicator;->getOrientation()Lcom/rd/draw/data/Orientation;
    ...
    .line 63
    iget-object p5, p0, Lcom/rd/draw/drawer/type/BaseDrawer;->paint:Landroid/graphics/Paint;
