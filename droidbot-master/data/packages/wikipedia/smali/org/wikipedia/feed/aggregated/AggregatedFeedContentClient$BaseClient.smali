...
.method static synthetic lambda$requestAggregated$0(Lorg/wikipedia/feed/model/UtcDate;Ljava/lang/String;)Lio/reactivex/ObservableSource;
    .locals 2
    ...
    invoke-interface {p1, v0, v1, p0}, Lorg/wikipedia/dataclient/RestService;->getAggregatedFeed(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lio/reactivex/Observable;
...
.method private requestAggregated()V
    ...
    invoke-static {v1}, Lorg/wikipedia/feed/aggregated/AggregatedFeedContentClient;->access$200(Lorg/wikipedia/feed/aggregated/AggregatedFeedContentClient;)Lio/reactivex/disposables/CompositeDisposable;
    ...
    new-instance v3, Lorg/wikipedia/feed/aggregated/-$$Lambda$AggregatedFeedContentClient$BaseClient$d0Q_9np72Zzv_DfzFIS6QXN-sH8;

    invoke-direct {v3, v0}, Lorg/wikipedia/feed/aggregated/-$$Lambda$AggregatedFeedContentClient$BaseClient$d0Q_9np72Zzv_DfzFIS6QXN-sH8;-><init>(Lorg/wikipedia/feed/model/UtcDate;)V

    sget-object v0, Lorg/wikipedia/feed/aggregated/-$$Lambda$tGFDnu6xutWoS1Pc__Z7vq_LX0U;->INSTANCE:Lorg/wikipedia/feed/aggregated/-$$Lambda$tGFDnu6xutWoS1Pc__Z7vq_LX0U;

    .line 181
    invoke-virtual {v2, v3, v0}, Lio/reactivex/Observable;->flatMap(Lio/reactivex/functions/Function;Lio/reactivex/functions/BiFunction;)Lio/reactivex/Observable;
    ...
    new-instance v2, Lorg/wikipedia/feed/aggregated/-$$Lambda$AggregatedFeedContentClient$BaseClient$VV7_b_BXRlbll16l1aT5alEWlBk;

    invoke-direct {v2, p0}, Lorg/wikipedia/feed/aggregated/-$$Lambda$AggregatedFeedContentClient$BaseClient$VV7_b_BXRlbll16l1aT5alEWlBk;-><init>(Lorg/wikipedia/feed/aggregated/AggregatedFeedContentClient$BaseClient;)V

    new-instance v3, Lorg/wikipedia/feed/aggregated/-$$Lambda$AggregatedFeedContentClient$BaseClient$qDeu74daN-G7jcpV-7Nlk7G5DoI;

    invoke-direct {v3, p0}, Lorg/wikipedia/feed/aggregated/-$$Lambda$AggregatedFeedContentClient$BaseClient$qDeu74daN-G7jcpV-7Nlk7G5DoI;-><init>(Lorg/wikipedia/feed/aggregated/AggregatedFeedContentClient$BaseClient;)V
