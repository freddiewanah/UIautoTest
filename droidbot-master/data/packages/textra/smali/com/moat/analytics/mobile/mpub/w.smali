...
# static fields
.field private static h:Lcom/moat/analytics/mobile/mpub/w;
...
# instance fields
.field volatile a:Lcom/moat/analytics/mobile/mpub/w$d;
...
.method private constructor <init>()V
    ...
    iput-boolean v2, p0, Lcom/moat/analytics/mobile/mpub/w;->b:Z

    iput-boolean v2, p0, Lcom/moat/analytics/mobile/mpub/w;->c:Z

    const/16 v0, 0xc8

    iput v0, p0, Lcom/moat/analytics/mobile/mpub/w;->d:I

    const/16 v0, 0xa

    iput v0, p0, Lcom/moat/analytics/mobile/mpub/w;->e:I

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0, v2}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>(Z)V

    iput-object v0, p0, Lcom/moat/analytics/mobile/mpub/w;->k:Ljava/util/concurrent/atomic/AtomicBoolean;

    const-wide/16 v0, 0x0

    iput-wide v0, p0, Lcom/moat/analytics/mobile/mpub/w;->l:J

    new-instance v0, Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-direct {v0, v2}, Ljava/util/concurrent/atomic/AtomicInteger;-><init>(I)V

    iput-object v0, p0, Lcom/moat/analytics/mobile/mpub/w;->m:Ljava/util/concurrent/atomic/AtomicInteger;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0, v2}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>(Z)V

    iput-object v0, p0, Lcom/moat/analytics/mobile/mpub/w;->n:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method static synthetic a(Lcom/moat/analytics/mobile/mpub/w;J)J
    .locals 1
...
.method static declared-synchronized a()Lcom/moat/analytics/mobile/mpub/w;
    .locals 2

    const-class v1, Lcom/moat/analytics/mobile/mpub/w;

    monitor-enter v1

    :try_start_0
    sget-object v0, Lcom/moat/analytics/mobile/mpub/w;->h:Lcom/moat/analytics/mobile/mpub/w;

    if-nez v0, :cond_0

    new-instance v0, Lcom/moat/analytics/mobile/mpub/w;

    invoke-direct {v0}, Lcom/moat/analytics/mobile/mpub/w;-><init>()V

    sput-object v0, Lcom/moat/analytics/mobile/mpub/w;->h:Lcom/moat/analytics/mobile/mpub/w;
...
.method static synthetic a(Lcom/moat/analytics/mobile/mpub/w;)V
    .locals 0
...
.method static synthetic b(Lcom/moat/analytics/mobile/mpub/w;)Landroid/os/Handler;
    .locals 1

    iget-object v0, p0, Lcom/moat/analytics/mobile/mpub/w;->j:Landroid/os/Handler;

    return-object v0
.end method

.method static synthetic b(Lcom/moat/analytics/mobile/mpub/w;J)V
    .locals 1
...
.method static synthetic c(Lcom/moat/analytics/mobile/mpub/w;)Ljava/util/concurrent/atomic/AtomicBoolean;
    .locals 1
...
.method static synthetic d(Lcom/moat/analytics/mobile/mpub/w;)Ljava/util/concurrent/atomic/AtomicBoolean;
    .locals 1
...
.method private d()V
    ...
    check-cast v0, Lcom/moat/analytics/mobile/mpub/w$c;

    iget-object v0, v0, Lcom/moat/analytics/mobile/mpub/w$c;->a:Ljava/lang/Long;
...
.method static synthetic e(Lcom/moat/analytics/mobile/mpub/w;)Ljava/util/concurrent/atomic/AtomicInteger;
    .locals 1

    iget-object v0, p0, Lcom/moat/analytics/mobile/mpub/w;->m:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method static synthetic f(Lcom/moat/analytics/mobile/mpub/w;)J
    .locals 2
...
# virtual methods
.method a(Lcom/moat/analytics/mobile/mpub/w$b;)V
    .locals 4
    ...
    invoke-interface {p1}, Lcom/moat/analytics/mobile/mpub/w$b;->c()V
